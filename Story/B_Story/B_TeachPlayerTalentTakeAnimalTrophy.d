...
func int B_TeachPlayerTalentTakeAnimalTrophy (var C_NPC slf, var C_NPC oth, var int trophy)
{
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat zuby různých zvíâat.");};
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...stahovat kožešiny z ještęrů.");}; //ADDON
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...vyjmout jazyk ohnivým ještęrům.");};
	if (trophy == TROPHY_BFWing) 			{	PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_BFWing] 			= TRUE;	
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...oddęlit krvavým mouchám kâídla.");};
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat krunýâe důlních červů.");};
	if (trophy == TROPHY_DrgSnapperHorn)	{	PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_DrgSnapperHorn] 	= TRUE;	
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...vyjmout rohy dračím chŕapavcům.");};
	if (trophy == TROPHY_DragonScale) 		{	
												...
												B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat šupiny z tęl mrtvých draků.");	
											};
