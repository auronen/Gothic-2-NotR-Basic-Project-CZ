...
{	
	...
	{
		AI_Output (self, other, "DIA_OCVLK_6_PEOPLE_06_03"); //Pokud chceš nęjaké vybavení, męl bys zajít za Engorem. Najdeš ho v domku naproti Garondovi.
	};
};
...
{	
	...
	AI_Output (self, other, "DIA_OCVLK_6_LOCATION_06_04"); //Za tou zdí se rozprostírá moâe. Pokud ještę pâiplujou další lodę se skâety na palubę, nebudeme mít žádnou šanci.
};
...
{	
	...
	if (Kapitel >= 5)
	{
		...
		{
			AI_Output (self,other,"DIA_OCVLK_6_STANDARD_06_06"); //Tahle zpropadená ruda. Męli bysme ji všechnu shodit dolů z cimbuâí. Pak by nás skâeti možná nechali na pokoji.
		}
		else
		{
