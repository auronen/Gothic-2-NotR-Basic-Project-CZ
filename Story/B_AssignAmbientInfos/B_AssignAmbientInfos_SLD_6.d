...
{	
	...
	if (Kapitel == 3)
	{
		...
		{
			AI_Output (self,other,"DIA_SLD_6_STANDARD_06_08"); //Jestli brzy nepustí Benneta z vęzení, pâijdeme si pro nęj sami.
		};	
	};
	...
	if (Kapitel >= 5)
	{
		if (hero.guild == GIL_DJG)
		{
			AI_Output (self,other,"DIA_SLD_6_STANDARD_06_12"); //Hned, jak jsi pâišel, jsem vędęl, to tu obrátíš vzhůru nohama.
