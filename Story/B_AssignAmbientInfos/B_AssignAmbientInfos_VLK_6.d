...
{	
	...
	if (Kapitel == 3)
	{
		...
		{
			AI_Output (self,other,"DIA_VLK_6_STANDARD_06_04"); //Âíká se, že jeden z Onarových žoldáků zabil paladina. Toho chlápka chytili a uvrhli do žaláâe. Už brzo se bude houpat.
		};
	};
