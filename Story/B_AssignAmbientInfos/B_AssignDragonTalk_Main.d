...
{	
	...
	AI_Output			(self, other, "DIA_DragonTalk_Main_1_20_01"); //Nejvyšší zájmy našeho shromáždęní, človíčku, ti zůstanou utajeny.
...
{	
	...
	AI_Output			(other, self, "DIA_DragonTalk_Main_3_15_02"); //Neslyším o tom poprvé. Témęâ úplná nezranitelnost neznamená, že ho nemůžu zabít.
	AI_Output			(other, self, "DIA_DragonTalk_Main_3_15_03"); //No, skončeme to: Co musím udęlat?
	AI_Output			(self, other, "DIA_DragonTalk_Main_3_20_04"); //Aby ses mohl postavit mému Pánu, musíš získat pâedmęty, jež on není schopen jakkoli sehnat.
	...
	{	
		AI_Output (self, other, "DIA_Dragons_Add_20_00"); //Potâebuješ zbraŕ, jež vyrobili jen pro tvé použití.
	};
	...
	AI_Output			(self, other, "DIA_DragonTalk_Main_3_20_09"); //Jedinę tak se můžeš odvážit postavit Pánu.
...
{	
	...
	B_LogEntry (TOPIC_BuchHallenVonIrdorath,"Pán draků prý sídlí na mohutné skále v posvátných Irdoratských síních. Hmm. To je mi nęjak povędomé - kde jsem o tom jenom četl?"); 
