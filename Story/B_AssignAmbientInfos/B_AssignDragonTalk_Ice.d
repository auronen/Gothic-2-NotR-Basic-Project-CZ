...
{
	AI_Output			(self, other, "DIA_Dragon_Ice_Hello_20_00"); //Proč rušíš můj odpočinek? To se musím vęčnę zahrabávat na stále vzdálenęjších místech jen proto, aby mę taková protivná havęă jako ty nechala na pokoji?
	if (Mis_KilledDragons == 0)
	{	
		AI_Output			(other, self, "DIA_Dragon_Ice_Hello_15_01"); //Mluvící drak. Požehnáno buë Innosovo oko.
	};
	AI_Output			(self, other, "DIA_Dragon_Ice_Hello_20_02"); //Vy lidé jste podivná stvoâení. I když vás smete ledový vichr smrti, vždycky se najde nękdo, kdo povstane z popela a myslí si o sobę, že je mu dáno být hrdinou.
	AI_Output			(self, other, "DIA_Dragon_Ice_Hello_20_03"); //Ale to brzo skončí. Osobnę dohlédnu na to, aby nikdo z vás už nikdy z ničeho nepovstal.
	AI_Output			(other, self, "DIA_Dragon_Ice_Hello_15_04"); //Ticho. S mocí posvátného Oka, jež mi byla propůjčena, si můžu dovolit zeptat se tę na pár vęcí.
	AI_Output			(self, other, "DIA_Dragon_Ice_Hello_20_05"); //Ha ha ha. Jen se ptej. Tvé vędomosti ti nebudou k ničemu.
...
func void DIA_Dragon_Ice_WERBISTDU_Info ()
{
	...
	AI_Output			(self, other, "DIA_Dragon_Ice_WERBISTDU_20_01"); //Jsem Finkregh. Pán ledu a snęhu, strážce shromáždęní a konec konců i tvá smrt.
...
func void DIA_Dragon_Ice_BELIAR_Info ()
{
	...
	AI_Output			(other, self, "DIA_Dragon_Ice_BELIAR_15_01"); //Kterej zpropadenej bůh mohl kdy dovolit takový ohavný potvoâe jako ty chodit po téhle zemi?
	AI_Output			(self, other, "DIA_Dragon_Ice_BELIAR_20_02"); //Neobtęžuj se porozumęt smyslu našeho Shromáždęní, malý hrdino.
	AI_Output			(self, other, "DIA_Dragon_Ice_BELIAR_20_03"); //Beliar nám nejen dovolil, abychom tu byli - on nás dokonce vede.
	AI_Output			(self, other, "DIA_Dragon_Ice_BELIAR_20_04"); //Podníceni jeho svatými slovy si neodpočineme do té doby, než se jeho vůle promęní v skutky.
