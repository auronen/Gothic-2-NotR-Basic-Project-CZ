...
{	
	AI_Output (other, self, "DIA_NOV_3_Fegen_15_00"); //Potâebuju pomoci zamést pokoje noviců.
...
{	
	...
	AI_Output (self, other, "DIA_NOV_3_PEOPLE_03_02"); //Ale za vše, co se týká noviců, je zodpovędný otec Parlan. Veškerý svůj čas tráví na nádvoâí, kde kontroluje práci noviců.
};
...
{	
	...
	AI_Output (self, other, "DIA_NOV_3_LOCATION_03_01"); //Tady se staráme o to, abychom si zajistili své skromné zásoby. Chováme ovce a dęláme víno.
	AI_Output (self, other, "DIA_NOV_3_LOCATION_03_02"); //Tady je knihovna, ale mohou ji využívat pouze mágové a vyvolení novicové.
	AI_Output (self, other, "DIA_NOV_3_LOCATION_03_03"); //My novicové se do ní podíváme jen, když sem pro nęco zajdeme mágům Kruhu ohnę.
};
...
{	
	...
	if (Kapitel == 1)
	{
		if (hero.guild == GIL_KDF)
		{
			...
			AI_Output (self,other,"DIA_NOV_3_STANDARD_03_02"); //Jen málokdy se stane, že by se takový nováček jako ty stal vyvoleným pro Kruh ohnę.
		}
		else
		{
	...
	|| (Kapitel == 3)
	{
		...
		else //Kap 2 - 3a
		{
			...
			{
				AI_Output (self,other,"DIA_NOV_3_STANDARD_03_10"); //Âíká se, že od paladinů, kteâí se vydali ho Hornického údolí, zatím nedorazily žádné zprávy. Nejvyšší rada bude vędęt, co má být učinęno.
			};
		};	
	};
