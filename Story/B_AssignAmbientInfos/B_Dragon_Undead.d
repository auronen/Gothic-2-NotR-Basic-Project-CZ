...
{	
	...
	AI_Output (self, other, "DIA_Dragon_Undead_Hello_20_04"); //Nenechával jsem ti snad stopy o mé existenci tak na očích, žes je nemohl minout?
	...
	//ADDON
	AI_Output (self, other, "DIA_Addon_UndeadDragon_Add_20_01"); //Je pouze JEDNA vęc, jenž nebyla pâedem dána!
	AI_Output (self, other, "DIA_Addon_UndeadDragon_Add_20_02"); //Zabil jsi jednoho z mých služebníků. Byl vyvolen nosit dráp.
	AI_Output (self, other, "DIA_Addon_UndeadDragon_Add_20_03"); //A jak vidím, nyní ho neseš ty. Zato zemâeš!
...
func void DIA_Dragon_Undead_Hello_attack ()
{
	...
	|| (C_ScHasBeliarsRune())
	{
		AI_Output (self, other, "DIA_Addon_UndeadDragon_Add_20_04"); //Opravdu si myslíš, že mę můžeš zranit tímto drápem? (smích)
	};
	//ADDON ENDE
