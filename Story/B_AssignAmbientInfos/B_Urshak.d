...
instance DIA_Urshak_ZAUN		(C_INFO)
{
	...
	description	 = 	"Co je ukryto za tou dlouhou zdí na východę?";
};
...
func void DIA_Urshak_HOSHPAKDEAD_Info ()
{
	...
	AI_Output			(self, other, "DIA_Urshak_HOSHPAKDEAD_18_06"); //Ur-Shak âíct, když pâítel človęk umâít.
...
{
	AI_Output			(self, other, "DIA_Urshak_HOSHPAKRACHE_18_00"); //(agresivnę) KHROTOK ! Já zjistil, že ty tady, když Hosh-Pak mrtvý. Ty udęlal velká chyba, cizinec.
	AI_Output			(other, self, "DIA_Urshak_HOSHPAKRACHE_15_01"); //Já vędęt, ty budeš tady. Ty hrál na mę habaëůra.
	AI_Output			(other, self, "DIA_Urshak_HOSHPAKRACHE_15_02"); //Tvá pozice být víc, než ty rád pâipustit. Teë ty nebýt nic, jen nástroj zla.
