...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Hi_13_01");//Buë tę zvíâe sní, nebo tę sní zvíâe.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Tal_13_01");//Tady je hodnę starých krámů. Raven nám naâídil sesbírat všechno.
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Tal_13_02");//Nemám tušení, co s tím chtęl, ale nikdo komu zůstal aspoŕ malej mozek, nebude riskovat krk kvůli nękolika kamenným deskám ...
};
// *************************************************************************
// 							News
// *************************************************************************
...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_02");//Zásobovali nás vęzni, ale nikdy za to nedostali ani minci. Není divu, že jsou naštavný.
	
	if (BDT_13_einmal == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_03");//Ale proč by to dęlali? Útočili na tábor? (smích) HAHAHA.
		BDT_13_einmal = TRUE;
	};
};
