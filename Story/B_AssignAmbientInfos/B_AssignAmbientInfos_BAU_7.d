...
INSTANCE DIA_BAU_7_LOCATION(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Âekni mi víc o tomhle místę.";
};                       
...
{	
	...
	AI_Output (self, other, "DIA_BAU_7_LOCATION_07_02"); //A Begarova farma je na náhorní plošinę na jihovýchodę. Z údolí se tam dostaneš celkem snadno - vedou tam velké kamenné schody.
};
...
{	
	...
	if (Kapitel >= 5)
	{
		AI_Output (self,other,"DIA_BAU_7_STANDARD_07_05"); //Teë, když jsou draci mrtví, se konečnę pánové paladinové uráčili odtáhnout z męsta. Už je na čase, aby se sem vrátila spravedlnost.
	};
};
