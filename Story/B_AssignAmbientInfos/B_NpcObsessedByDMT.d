...
func void B_DMTWurm ()
{
		AI_Output	(self, other, "DIA_NoName_ObsessedByDMT_19_00"); //My tę vidęt, červe. Ty nemoct utéct.
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (NpcObsessedByDMT == FALSE)
		{
			...
			if (Hlp_GetInstanceID(medium) == Hlp_GetInstanceID(Brutus))
			{
				if (MIS_OCGateOpen == TRUE)
					{
						AI_Output	(self, other, "DIA_Brutus_ObsessedByDMT_19_00"); //Otevâení brány pâedstavovat velká služba našemu Pán, malý smrtelník. My postavit svatyni na jeho počest na tvůj hrob.
					}
					else
					{
							B_DMTWurm ();
			...
			{
				AI_Output	(self, other, "DIA_Engrom_ObsessedByDMT_19_00"); //Obraă sebe, dokud pro tebe nebýt pâíliš pozdę.
			...
			{
				AI_Output	(self, other, "DIA_Vino_ObsessedByDMT_19_00"); //Už brzo jim budeme všem velet. Ty pro nás se svými žalostnými magickými schopnostmi nepâedstavuješ žádné nebezpečí.
			...
			{
				AI_Output	(self, other, "DIA_Malak_ObsessedByDMT_19_00"); //Nemůžeš tuhle duši nijak zachránit, mágu. Nikdy se nevrátí do svého tęla.
			...
			{
				AI_Output	(self, other, "DIA_Randolph_ObsessedByDMT_19_00"); //Nezabývej se se slabochy. Všechny si je podrobíme.
