...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_00"); //Když už jsem se odtamtud dokázal dostat, nebudu se teë pro ty svinę dâít znovu!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_01"); //Poâád ta ruda. Furt to samé. Všichni prostę chtęj tu zatracenou rudu.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_02"); //Kdybys musel jíst tu šlichtu, co nám pâedhazujou, taky bys začal myslet na vzpouru!
	};
