...
{	
	...
	AI_Output (self, other, "DIA_OCVLK_1_PEOPLE_01_01"); //Velitel Garond. Ale od chvíle, co se tu situace zhoršila, ho nikdo nevidęl nikde jinde než v trůnním sálu. Je mi líto, že to vzalo tak špatný konec.
};
...
{	
	...
	AI_Output (self, other, "DIA_OCVLK_1_LOCATION_01_02"); //Nechtęl bych si to s nimi męnit. Celé údolí se hemží skâety. A to se ani nezmiŕuju o dracích.
};
