...
{	
	...
	AI_Output (self, other, "DIA_VLK_17_JOIN_17_01"); //Tady v Khorinisu mají velké slovo âemeslničtí mistâi z dolní části męsta. Męl by sis s jedním z nich promluvit.
};
...
{	
	...
	AI_Output (self, other, "DIA_VLK_17_PEOPLE_17_01"); //Jakmile dorazili paladinové do męsta, pâevzali velení nad celým Khorinisem.
	AI_Output (self, other, "DIA_VLK_17_PEOPLE_17_02"); //Lord Andre tu pâedstavuje zákon. Nalezneš ho v kasárnách.
	AI_Output (self, other, "DIA_VLK_17_PEOPLE_17_03"); //Ale smysl k nęmu má chodit jen tehdy, pokud se dostaneš do konfliktu se zákonem nebo se budeš chtít pâidat k domobranę.
};
...
INSTANCE DIA_VLK_17_LOCATION(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Co je tady v Khorinisu nejzajímavęjší?";
};                       
...
{	
	AI_Output (other, self, "DIA_VLK_17_LOCATION_15_00"); //Co je tady v Khorinisu nejzajímavęjší?
