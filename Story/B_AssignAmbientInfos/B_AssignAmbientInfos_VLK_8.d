...
{	
	...
	if (Kapitel == 1)
	{
		AI_Output (self,other,"DIA_Addon_VLK_8_STANDARD_08_00"); //Každý se cití nesvůj, nervozní poslední dobou.
		AI_Output (self,other,"DIA_Addon_VLK_8_STANDARD_08_01"); //Jako kdyby toho nebylo dost - vtrhli sem paladinové  - ted když se lidé ztrácejí!
		AI_Output (self,other,"DIA_Addon_VLK_8_STANDARD_08_02"); //Je čas, aby proti tomu domobrana nęco udęlala.
