...
{	
	...
	AI_Output (self, other, "DIA_VLK_16_JOIN_16_02"); //Pokud jsi občanem Khorinisu, můžeš se pâidat k domobranę - promluv si nękým od męstských stráží.
};
...
{	
	...
	if (Kapitel == 1)
	{
		AI_Output (self,other,"DIA_Addon_VLK_16_STANDARD_16_00"); //Doufám, že domobrana konečnę zjistí proč se populace Khorinisu zmenšuje.
		AI_Output (self,other,"DIA_Addon_VLK_16_STANDARD_16_01"); //Človęk se musí bát o svůj život, když slyší kolik lidí zmizelo.
	...
	if (Kapitel == 2)
	{
		...
		AI_Output (self,other,"DIA_VLK_16_STANDARD_16_02"); //Ráda bych vędęla, jestli to náhodu není ten důvod, proč farmáâi pâestali chodit na trh.
	};
	...
	if (Kapitel == 3)
	{
		...
		{
			AI_Output (self,other,"DIA_VLK_16_STANDARD_16_03"); //Žoldnéâ, o kterém se âíkalo, že zavraždil Lothara, je nevinný. Objevily se důkazy o tom, že na nęj nękdo ušil boudu. Zaslechla jsem to na tržišti.
		}
		else
		{
	...
	if (Kapitel == 4)
	{
		AI_Output (self,other,"DIA_VLK_16_STANDARD_16_06"); //Slyšela jsem, že ti šibeničníci opustili Onarovu farmu. Âíká se, že se ze strachu pâed lordem Hagenem stáhli zpęt do Hornického údolí.
	};
