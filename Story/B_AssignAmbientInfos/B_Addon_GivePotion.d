...
instance DIA_Addon_GivePotion(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Dát lečivý lektvar)";
};                       
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Dát elixír hojivé síly)",DIA_Addon_GivePotion_ItPo_Health_03);
	};
	if (Npc_HasItems (other,ItPo_Health_02) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Dát extrakt hojivé síly)",DIA_Addon_GivePotion_ItPo_Health_02);
	};
	if (Npc_HasItems (other,ItPo_Health_01) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Dát esenci hojivé síly)",DIA_Addon_GivePotion_ItPo_Health_01);
	};
};
// ------------------------------------------------------------
func void B_Addon_DrinkPotion ()
{
	AI_Output (other,self ,"DIA_Addon_Brandon_GivePotion_15_00"); //Na, vem si tento léčivý lektvar.
