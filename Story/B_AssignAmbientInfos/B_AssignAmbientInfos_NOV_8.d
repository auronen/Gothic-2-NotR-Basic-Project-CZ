...
{	
	AI_Output (other, self, "DIA_NOV_8_Fegen_15_00"); //Potâebuju pomoci zamést pokoje noviců.
...
INSTANCE DIA_NOV_8_LOCATION(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Âekni mi o klášteru nęco víc.";
};                       
...
{	
	...
	if (Kapitel == 1)
	{
		...
		{
			AI_Output (self,other,"DIA_NOV_8_STANDARD_08_03"); //Nedávno do Khorinisu pâijeli paladinové. Jeden z nich je tady v klášteâe, aby se tu modlil k Innosovi.
		};
	};
	...
	if (Kapitel >= 5)
	{
		...
		AI_Output (self,other,"DIA_NOV_8_STANDARD_08_12"); //V současnosti se musíme potýkat s množstvím temnoty a bude potâeba ještę zažehnout mnoho ohŕů, abychom ji zprovodili ze svęta.
	};
};
