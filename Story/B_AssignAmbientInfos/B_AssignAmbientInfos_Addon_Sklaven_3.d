...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_Addon_Sklaven_3_STANDARD_03_00"); //(strach) Co po mnę chceš? Jdi pryč!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_Addon_Sklaven_3_STANDARD_03_01"); //(nervóznę) Nic jsem neudęlal! Nech mę být!
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_Addon_Sklaven_3_STANDARD_03_02"); //(vystrašenę) Prosím, nebij mę!
	};
