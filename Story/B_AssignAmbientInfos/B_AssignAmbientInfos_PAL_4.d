...
{	
	...
	AI_Output (self, other, "DIA_PAL_4_PEOPLE_04_01"); //Velitelem všech jednotek na ostrovę je lord Hagen. Také po celou dobu naší pâítomnosti ve męstę zastává úâad místodržícího.
...
INSTANCE DIA_PAL_4_LOCATION(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Co dęláte vy, paladinové, tady v Khorinisu?";
};                       
...
{	
	AI_Output (other, self, "DIA_PAL_4_LOCATION_15_00"); //Co dęláte vy, paladinové, tady v Khorinisu?
