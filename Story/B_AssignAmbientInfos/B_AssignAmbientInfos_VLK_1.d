...
{	
	...
	AI_Output (self, other, "DIA_VLK_1_JOIN_01_01"); //Najdi si slušnou práci! Každý, kdo je v Khorinisu zamęstnán, je považován za občana męsta.
};
...
{	
	...
	AI_Output (self, other, "DIA_VLK_1_PEOPLE_01_02"); //Jejich velitelem je lord Hagen. Je také novým místodržícím, více ménę.
...
INSTANCE DIA_VLK_1_LOCATION(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Co je ve męstę zajímavého?";
};                       
