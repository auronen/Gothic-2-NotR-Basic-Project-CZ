...
INSTANCE DIA_MIL_6_JOIN(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Co musím udęlat, aby mę vzali do domobrany?";
};                       
...
instance DIA_Addon_MIL_6_MissingPeople		(C_INFO)
{
	...
	permanent	= TRUE;
	description	 = 	"Slyšel jsem, že nękteâí obyvatelé zmizeli.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_MIL_6_MissingPeople_15_00"); //Slyšel jsem, že nękteâí obyvatelé zmizeli.
	...
	AI_Output	(self, other, "DIA_Addon_MIL_6_MissingPeople_06_02"); //Nemůžu ti to vysvętlit tak, jak bych chtęl.
	AI_Output	(self, other, "DIA_Addon_MIL_6_MissingPeople_06_03"); //Nicménę nemůžeme udęlat víc než mít oči otevâené a stát na stráži.
};
...
INSTANCE DIA_MIL_6_PEOPLE(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Âekni mi nęco o tęch paladinech.";
};                       
...
{	
	AI_Output (other, self, "DIA_MIL_6_PEOPLE_15_00"); //Âekni mi nęco o tęch paladinech.
	AI_Output (self, other, "DIA_MIL_6_PEOPLE_06_01"); //Jakmile pâijeli do Khorinisu, obsadili horní část męsta.
...
{	
	...
	if (Kapitel == 2)
	{
		AI_Output (self,other,"DIA_MIL_6_STANDARD_06_04"); //Vypadá to, že teë máme problém s lupiči více ménę pod kontrolou. Pâepady se dotýkaly úplnę všech, ale nedávno to ustalo.
	};
	...
	if (Kapitel == 3)
	{
		...
		AI_Output (self,other,"DIA_MIL_6_STANDARD_06_06"); //Jsem si jist, že nemęl za lubem nic dobrého. Ale když jsem za ním šel kolem domu místodržícího, prostę zmizel. Pochybná existence, která...
	};
