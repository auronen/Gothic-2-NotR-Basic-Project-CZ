...
{	
	...
	{
		AI_Output (self, other, "DIA_MIL_7_JOIN_07_01"); //Ještę ses nestal občanem Khorinisu! Proč si myslíš, že by tę męl lord Andre pâijmout?
...
{	
	...
	if (Kapitel == 1)
	{
		...
		if (randy == 0)
		{
			AI_Output (self,other,"DIA_Addon_MIL_7_STANDARD_07_00"); //Jeden za druhým lidé mizí. Bohužel jsme ještę nezjistili, co se s nimi stalo. Můžou za tím být skâeti?
	...
	if (Kapitel == 2)
	{
		AI_Output (self,other,"DIA_MIL_7_STANDARD_07_02"); //Je na čase, aby paladinové konečnę tu rebelii potlačili. Každý, kdo poruší zákon, musí být potrestán. Zvlášă teë, když jsme ve válce.
	};
