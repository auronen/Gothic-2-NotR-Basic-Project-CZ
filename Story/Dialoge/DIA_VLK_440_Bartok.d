...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Bartok_Jager_04_00"); //Nedávno jsme byli ještę oba ve męstę.
	AI_Output (self ,other,"DIA_Addon_Bartok_Jager_04_01"); //Můj kámoš Trokar je velmi zručný lovec.
};	
...
instance DIA_Addon_Bartok_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Kde je tvůj kamarád teë?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Bartok_MissingPeople_15_00"); //Kde je tvůj kamarád teë?
	AI_Output	(self, other, "DIA_Addon_Bartok_MissingPeople_04_01"); //No, to je divný pâíbęh.
	AI_Output	(self, other, "DIA_Addon_Bartok_MissingPeople_04_02"); //Pâed pár dny jsme se oba potulovali kolem Coraganovi hospody a povídali si o lovu.
	AI_Output	(self, other, "DIA_Addon_Bartok_MissingPeople_04_03"); //Neptej se mę, co se stalo. Byl jsem totiž dost opilý.
	AI_Output	(self, other, "DIA_Addon_Bartok_MissingPeople_04_04"); //Jenom si pamtuju, že Trokar chtęl nęjakou trávu z bažin? Ale nikdy se už nevrátil.
...
{
	AI_Output			(other, self, "DIA_Addon_Bartok_MissingPeople_wo_15_00"); //Kde shánęl tu trávu z bažin?
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_wo_04_01"); //Myslím, že nękde z pâístavní čtvrti.
};
func void DIA_Addon_Bartok_MissingPeople_such ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_such_04_01"); //Ne, ale âekl jsem o tom domobranę.
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_such_04_02"); //A nikdo z nich nebyl schopný ho najít.
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_such_04_03"); //Doufám, že ho nenapadnul nęjaký vlk nebo nęco horšího.
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_such_04_04"); //Myšlenka, že pâi lovu zakopnu o jeho chladné tęlo mę dęsí.
	AI_Output			(self, other, "DIA_Addon_Bartok_MissingPeople_such_04_05"); //Nevím, jestli bych to pâenesl pâes srdce.
};
...
INSTANCE DIA_Bartok_TeachSneak (C_INFO)
{
	...
	permanent	= TRUE;
	description	= B_BuildLearnString ("Nauč mę, jak se plížit!", B_GetLearnCostTalent(other, NPC_TALENT_SNEAK, 1));
};                       
...
{	
	AI_Output (self ,other,"DIA_Bartok_Angekommen_04_00"); //Tak! Myslím, že se vrátim do męsta.
