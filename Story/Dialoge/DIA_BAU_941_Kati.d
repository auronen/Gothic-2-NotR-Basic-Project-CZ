...
func void DIA_Kati_SLDNOCHDA_Info ()
{
 ...
 if (Hilfe == FALSE)
 {
  AI_Output (self, other, "DIA_Kati_SLDNOCHDA_16_00"); //Ti hrdloâezové mému muži vyhrožují! Jsme âádnými občany męsta, vęrní králi a žoldáci nás chtęjí oloupit o všechno!
  Hilfe = TRUE;
 };
...
func void DIA_Kati_Baltram_Info ()
{
 ...
 AI_Output (self, other, "DIA_Kati_Baltram_16_01"); //Ano, samozâejmę. Tady, už jsem to zabalila.
...
func void DIA_Kati_BAUERNAUFSTAND_Info ()
{
 ...
 AI_Output (self, other, "DIA_Kati_BAUERNAUFSTAND_16_02"); //Na druhou stranu, jsou tu i Bengar a Sekob, co by se radęji vzdali svých farem, než by pracovali pro krále.
...
func void DIA_Kati_HIERWEG_Info ()
{
 ...
 AI_Output (self, other, "DIA_Kati_HIERWEG_16_02"); //Jediné dvę cesty ven jsou průsmyk do Hornického údolí a pâístav v Korinisu.
