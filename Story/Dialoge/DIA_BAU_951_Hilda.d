...
func void DIA_Hilda_BringBeet_Info ()
{
	...
	if (Npc_HasItems (other,ItPl_Beet) >= 20)
	{
		...
		AI_Output (self, other, "DIA_Hilda_BringBeet_17_02"); //Jinak, dokud jsi tady - vidęla jsem tudy pâed pár minutami procházet kočovného kupce.
...
func void DIA_Hilda_Einkaufen_Info ()
{
	AI_Output (other, self, "DIA_Hilda_Einkaufen_15_00"); //Dej mi zlato a já zajdu za tím kupcem.
		...
		if (hero.guild == GIL_NONE)
		{
			AI_Output (self, other, "DIA_Hilda_Einkaufen_17_01"); //Âíkáš, že ti mám vęâit? Tak jen ty peníze nevyhoë za chlast, slyšíš?!
		};
...
func void DIA_Hilda_KRANK_helfen ()
{
	...
	B_LogEntry (TOPIC_HealHilda,"Lobartovę ženę Hildę je špatnę, ale Vatras by pro ni męl mít lék."); 
	AI_StopProcessInfos (self);
};
