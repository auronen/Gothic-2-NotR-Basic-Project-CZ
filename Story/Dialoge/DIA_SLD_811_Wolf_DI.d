	...
	&& (Npc_IsDead(Bennet_DI)	==	FALSE)
		{
			...
			AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_03"); //Ále, vlastnę nic. Jen si udęlej, co musíš, a pak odsud zmizni, jo?
		}
	else
		{
			if (DIA_Wolf_DI_HALLO_OneTime == FALSE)
				...
				{
					AI_Output			(other, self, "DIA_Wolf_DI_HALLO_15_05"); //Mohl bys mi ukout nęjakou zbroj?
					AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_06"); //Je mi líto, chlape, ale s tímhle náâadím nic nepoâídím. To bude muset počkat, až dorazíme na pevninu.
				};
		};
};
...
INSTANCE DIA_Wolf_DI_Training (C_INFO)
{
	...
	description = "Vycvič mę prosím v boji na dálku.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Wolf_DI_Training_15_00"); //Vycvič mę prosím v boji na dálku.
	AI_Output (self ,other,"DIA_Wolf_DI_Training_08_01"); //V jakém konkrétnę?
...
func void DIA_Wolf_DI_Training_BOW_1()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_BOW_1_08_00"); //Luk je na rozdíl od kuše dost neskladný, a proto vyžaduje spoustu místa. Vždycky si proto dávej pozor, abys męl pâi boji okolo sebe dostatek volného prostoru.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_BOW_5()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_BOW_5_08_00"); //Pâi výstâelu ti musí tętiva v prstech klouzat - když ji budeš držet kâečovitę, můžeš tím šíp úplnę vychýlit z dráhy.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_CROSSBOW_1()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_CROSSBOW_1_08_00"); //Pâi stâelbę z kuše musíš stát absolutnę v klidu. Kohoutek je proto tâeba mačkat velmi pomalu a opatrnę.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_CROSSBOW_5()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_CROSSBOW_5_08_00"); //Chytrý kušiník si také všímá, kudy zrovna vane vítr, a nesnaží se stâílet pâímo proti nęmu.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_UndeadDragonDead_Info ()
{
	...
	AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_01"); //Jasnę. A co ty? Bylo to drsné, co?

	if (DIA_Wolf_DI_UndeadDragonDead_OneTime == FALSE)
		{
			AI_Output			(other ,self, "DIA_Wolf_DI_UndeadDragonDead_15_02"); //Kam teë půjdeš?
			AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_03"); //Kamkoliv, jen ne zpátky. Khorinisu už mám plné zuby.
			AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_04"); //Mnę je taky jedno, kam poplujeme, jenom když odsud konečnę vypadneme.
