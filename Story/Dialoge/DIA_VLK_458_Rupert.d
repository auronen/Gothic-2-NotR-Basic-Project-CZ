...
{	
	...
	if (Knows_Matteo == FALSE)
	{
		...
		B_LogEntry (TOPIC_CityTrader,"Matteův obchod leží u jižní męstská brány. Prodává různé vybavení, zbranę a zásoby.");
		Knows_Matteo = TRUE;
	};
};
...
{	
	...
	&& (hero.guild != GIL_DJG)
	{ 
		AI_Output (self ,other,"DIA_Rupert_YourOffer_03_02"); //Ten zatracenej velkostatkáâ už nechce dál doručovat své zboží a to, co získáme od malých statkáâů, nestačí pokrýt požadavky męsta ani náhodou.
	};
};
