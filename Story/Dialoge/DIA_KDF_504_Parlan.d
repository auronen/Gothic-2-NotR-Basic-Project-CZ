...
FUNC VOID DIA_Parlan_PMSchulden_Info()
{
	...
	AI_Output (self, other, "DIA_Parlan_PMSchulden_05_00"); //Porušil jsi zákona našeho společenství.
	...
	else if (B_GetGreatestPetzCrime(self) < Parlan_LastPetzCrime)
	{
		...
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, other, "DIA_Parlan_PMSchulden_05_10"); //Tvé hâíchy jsou nyní odpuštęny.
		...
		{
			AI_Output (self, other, "DIA_Parlan_PMSchulden_05_12"); //Zaplatíš svou pokutu - taková je vůle Innosova!
			B_Say_Gold (self, other, Parlan_Schulden);
...
{
			AI_Output (self, other, "DIA_Addon_Parlan_WELCOME_05_00"); //Odnes okamžitę svůj poplatek klášteru Goraxovi. Ten se o to postará.
};
...
instance DIA_Parlan_Amulett		(C_INFO)
{
	...
	permanent 	 =  FALSE; 
	description	 =  "Âekni mi nęco o Innosovę oku.";
};
...
FUNC VOID DIA_Parlan_TEACH_MANA_BACK()
{
	...
	{
		AI_Output (self, other, "DIA_Parlan_TEACH_MANA_05_00"); //Tvoje magická síla se zvýšila. Dál už ti pomoci nemohu.
...
FUNC VOID DIA_Parlan_IAmParlan_Info()
{
	...
	{
		AI_Output (self ,other,"DIA_Parlan_IAmParlan_05_02"); //Netuším, proč ti byl povolen vstup sem do kláštera. Jsem Parlan a zodpovídám za vás nováčky.
...
FUNC VOID DIA_Parlan_DontDisturb_Info()
{
	...
	AI_Output (self ,other,"DIA_Parlan_DontDisturb_05_02"); //(ráznę) Další vyrušování nebudu tolerovat!
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Cellar()
{
	...
	AI_Output (self, other, "DIA_Parlan_Add_05_04"); //Vstup do sklepů je v polovinę kolonády napravo.
};
