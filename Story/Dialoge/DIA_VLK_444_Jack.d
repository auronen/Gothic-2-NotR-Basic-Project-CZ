...
func void DIA_Jack_Job_Info ()
{
	...
	AI_Output			(self, other, "DIA_Jack_Job_14_02"); //Pâed mnoha lety jsem se tu usadil a už pęknou âádku let se starám o khorinisský maják.
	...
	AI_Output			(self ,other, "DIA_Jack_Job_14_09"); //Mám dojem, že vyhlížej nęjakou loë, co by mohli okrást.
...
instance DIA_Jack_City		(C_INFO)
{
	...
	description	 = 	"Pâicházíš do męsta často?";
};
...
instance DIA_Jack_Harbor		(C_INFO)
{
	...
	description	 = 	"Âekni mi nęco o pâístavu.";
};
...
func void DIA_Jack_Harbor_Info ()
{
	...
	AI_Output			(self ,other, "DIA_Jack_Harbor_14_01"); //Khorinisský pâístav už není, co býval.
...
func void DIA_Jack_BANDITENWEG_Info ()
{
	...
	AI_Output			(self, other, "DIA_Jack_BANDITENWEG_14_02"); //Pojë se mnou na maják. Nahoâe je krásnej výhled na moâe.
	AI_StopProcessInfos (self);
...
instance DIA_Jack_BEMYCAPTAIN		(C_INFO)
{
	...
	description	 = 	"Nechtęl by ses vrátit na moâe?";
};
...
func void DIA_Jack_BEMYCAPTAIN_seaman ()
{
	...
	AI_Output			(self, other, "DIA_Jack_BEMYCAPTAIN_seaman_14_03"); //(smích) To by mohlo nęco znamenat. No dobrá. Nemůžu tu jen tak nechat můj maják. Mmh. Co s tím udęláme?
...
func void DIA_Jack_LOSFAHREN_Info ()
{
	...
	if ((B_CaptainConditions (self)) == TRUE)
	{
		...
		AI_Output			(self, other, "DIA_Jack_LOSFAHREN_14_04"); //Jestli seš si jistej, že máme opravdu všechno, bęž do kapitánský kajuty a dej si dvacet. Bude se ti to hodit.
		AI_StopProcessInfos (self);
