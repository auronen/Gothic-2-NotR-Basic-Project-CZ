...
instance DIA_Addon_Hakon_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Nevíš náhodou nęco o ztracených obyvatelích Khorinisu?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Hakon_MissingPeople_15_00"); //Nevíš náhodou nęco o ztracených obyvatelích Khorinisu?
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_01"); //Vidęl jsem mnoho lidí procházet východní branou.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_02"); //Nękteré z nich jsem v životę nevidęl. A mnoho z nich se nikdy nevrátilo.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_03"); //Ale, nęco opravdu divného se asi dęje.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_04"); //Tamhle byl nęjaký týpek. Myslím, že se jmenoval Joe. Porád se vychloubal, že bude brzy pracháč.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_05"); //Vyzvídal, jak se má dostat do jedné z męstských vęží, kam si domobrana ukládá zbranę.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_06"); //Potom jsem ho už nikdy nevidęl. Chodil jsem okolo nęj každý den, dokud se neztratil.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_07"); //Byl jsem udiven, když ho domobrana zatkla a ptala se nás na nęj.
	AI_Output	(self, other, "DIA_Addon_Hakon_MissingPeople_12_08"); //Lord Andre nevędęl o čem jsem mluvil a nechtęl o tom chlápkovi už slyšet.

	Log_CreateTopic (TOPIC_Addon_Joe, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Joe, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_Joe,"Hakon, obchodník v Khorinisu, vídal chlápka jménem Joe, než se ztratil. Joe se chtęl dostat do jedné z męstských vęží, kde si domobrana skladovala zbranę."); 
...
instance DIA_Hakon_OutOfTown		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Âekni mi nęco o okolí męsta.";
};
...
func void DIA_Hakon_Paladine_Info ()
{
	...
	AI_Output (self ,other,"DIA_Hakon_Add_12_11"); //(jízlivę) A na oplátku se teë můžu v hotelu válet zdarma - ha!
};
...
instance DIA_Hakon_HaradBandits		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Harad mi âekl o útoku banditů.";
};
...
instance DIA_Hakon_Miliz		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Nemáš ponętí, kdo z domobrany se pátrání účastnil?";
};
...
instance DIA_Hakon_Success		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Už jsem ty bandity vyâídil.";
};
...
func void DIA_Hakon_Success_Info ()
{
	...
	AI_Output (other, self, "DIA_Hakon_Success_15_00"); //Už jsem ty bandity vyâídil.
...
{	
	...
	AI_Output (self ,other,"DIA_Hakon_Add_12_23"); //Harad konečnę skončil s tou zatrachtilou misí pro paladiny.
