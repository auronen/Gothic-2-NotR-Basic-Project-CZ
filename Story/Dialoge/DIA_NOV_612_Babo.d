...
FUNC VOID DIA_Babo_Hello_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_Hello_03_00"); //(ostýchavę) Ahoj, ty jsi tady také nový, co?
...
{	
	...
	AI_Output (self, other, "DIA_Babo_Wurst_03_03"); //Už jsi dostal stejnę o jednu víc, než si zasloužíš. Konkrétnę o tu, kterou jsem ti právę dal. A co je klobása mezi pâáteli?
...
FUNC VOID DIA_Babo_YouAndAgon_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_YouAndAgon_03_01"); //Ale to víš, trošku jsme se pohádali o tom, jak se starat o ohnivé kopâivy.
...
INSTANCE DIA_Babo_Windfaust  (C_INFO)
{
	...
	permanent   = TRUE;
	description	= "Co se toho svitku týče...";
};
//---------------------------------
...
FUNC VOID DIA_Babo_Kap3_HaveYourDocs_KeepThem()
{
	...
	FUNC VOID DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke()
	{
		...
		AI_Output (other,self ,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke_15_04"); //To je v poâádku. Tak si užij ty svoje DOKUMENTY.
