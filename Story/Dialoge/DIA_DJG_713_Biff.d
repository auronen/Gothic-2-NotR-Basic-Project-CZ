...
{
	AI_Output			(self, other, "DIA_Biff_ARBEITEN_lebenlassen_07_01"); //Nemám zapotâebí, aby si ze mę nękdo dęlal blázny.
};
...
{
	AI_Output			(other, self, "DIA_Biff_HALLO_15_00"); //Co tady dęláš?
	AI_Output			(self, other, "DIA_Biff_HALLO_07_01"); //To je ta nejblbęjší otázka, jakou jsem kdy slyšel. Co asi tak myslíš?

	Info_AddChoice	(DIA_Biff_HALLO, "Z tak pâiblblýho výrazu, jakej máš ty, se nedá nic poznat. Proto jsem se taky musel zeptat.", DIA_Biff_HALLO_spott );
...
func void DIA_Biff_HALLO_spott ()
{
	...
	AI_Output			(self, other, "DIA_Biff_HALLO_spott_07_01"); //Na můj vkus máš nęjak moc velkou hubu. Je načase, aby ti ji nękdo zavâel.
...
func void DIA_Biff_HALLO_keineAhnung_was ()
{
	...
	AI_Output			(self, other, "DIA_Biff_HALLO_keineAhnung_was_07_01"); //Hele chlape, ty sis vážnę nebyl dvakrát, když Innos rozdával rozum. Kdybych to vędęl, na nic bych nečekal.
...
func void DIA_Biff_HALLO_keineAhnung_was_was2 ()
{
	...
	Info_AddChoice	(DIA_Biff_HALLO, "Tak proč nęco nedęláš?", DIA_Biff_HALLO_keineAhnung_was_was2_was3 );

};
func void DIA_Biff_HALLO_keineAhnung_was_was2_was3 ()
{
	AI_Output			(other, self, "DIA_Biff_HALLO_keineAhnung_was_was2_was3_15_00"); //Tak proč nęco nedęláš?
	AI_Output			(self, other, "DIA_Biff_HALLO_keineAhnung_was_was2_was3_07_01"); //Jestli mi okamžitę nepâestaneš dávat ty pâiblblý otázky, tak ti tu tvojí nevymáchanou hubu rychle zavâu.
...
func void DIA_Biff_WASHIERIMTAL_Info ()
{
	...
	AI_Output			(self, other, "DIA_Biff_WASHIERIMTAL_07_01"); //Slávu a zlato. Co víc? Až se vypoâádám s tęmi draky, budu se topit v penęzích.
	AI_Output			(self, other, "DIA_Biff_WASHIERIMTAL_07_02"); //A doufám, že budu mít dost na to, abych si mohl do konce života užívat po všech hospodách a nevęstincích v zemi.

	Info_AddChoice	(DIA_Biff_WASHIERIMTAL, "Fajn, tak ti pâeju hodnę štęstí.", DIA_Biff_WASHIERIMTAL_vielglueck );
...
{
	AI_Output			(other, self, "DIA_Biff_WASHIERIMTAL_vielglueck_15_00"); //Fajn, tak ti pâeju hodnę štęstí.
	AI_Output			(self, other, "DIA_Biff_WASHIERIMTAL_vielglueck_07_01"); //Nepotâebuju žádný štęstí. Stačí mi moje sekera.
...
instance DIA_Biff_ARBEITEN		(C_INFO)
{
	...
	description	 = 	"Jak by se ti líbilo pracovat pro mę?";
};
...
{
	AI_Output			(other, self, "DIA_Biff_ARBEITEN_15_00"); //Jak by se ti líbilo pracovat pro mę?
	
	B_LogEntry (TOPIC_Dragonhunter,"Drakobijce Biff je žoldnéâ tęlem i duší. Když mu zaplatím, bojovat po mém boku."); 
	...
	Info_AddChoice	(DIA_Biff_ARBEITEN, "Budeš rád, když tę nechám naživu.", DIA_Biff_ARBEITEN_lebenlassen );
	Info_AddChoice	(DIA_Biff_ARBEITEN, "Dám ti půlku koâisti.", DIA_Biff_ARBEITEN_HalbeHalbe );
...
{
	AI_Output			(other, self, "DIA_Biff_ARBEITEN_HalbeHalbe_15_00"); //Dám ti půlku koâisti.
	AI_Output			(self, other, "DIA_Biff_ARBEITEN_HalbeHalbe_07_01"); //To zní dobâe. Ale varuju tę, nepokoušej se mę podvést, jinak toho budeš litovat.
	AI_Output			(self, other, "DIA_Biff_ARBEITEN_HalbeHalbe_07_02"); //A ještę jedna vęc, nezajímají mę žádné zbranę ani další krámy, co tady najdeš. Chci jen zlato, jasný?
	...
	{
		AI_Output			(self, other, "DIA_Biff_ARBEITEN_HalbeHalbe_07_03"); //Ale co to âíkám. Tohle všechno už jsi vędęl.
	};
};

func void DIA_Biff_ARBEITEN_lebenlassen ()
{
	AI_Output			(other, self, "DIA_Biff_ARBEITEN_lebenlassen_15_00"); //Budeš rád, když tę nechám naživu.
	B_BIFF_VERARSCHEN ();
	AI_StopProcessInfos (self);
	DJG_BiffParty_nomore = (DJG_BiffParty_nomore +1);
};
...
{
	AI_Output			(self, other, "DIA_Biff_GELDEINTREIBEN_07_00"); //Počkej chvilku! Neâíkals, že půlka koâisti patâí mnę? Dej to sem!
...
func void DIA_Biff_GELDEINTREIBEN_zuTeuer ()
{
	...
	AI_Output			(self, other, "DIA_Biff_GELDEINTREIBEN_zuTeuer_07_01"); //Pâestaŕ do mę hučet. Dohodli jsme se na polovinę.

	Info_ClearChoices	(DIA_Biff_GELDEINTREIBEN);
	Info_AddChoice	(DIA_Biff_GELDEINTREIBEN, "Teë se musíme rozdęlit, je mi líto.", DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen );
	Info_AddChoice	(DIA_Biff_GELDEINTREIBEN, "Tady je tvůj podíl.", DIA_Biff_GELDEINTREIBEN_geben );

};
func void DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen ()
{
	AI_Output			(other, self, "DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen_15_00"); //Teë se musíme rozdęlit, je mi líto.
	AI_Output			(self, other, "DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen_07_01"); //Když to âíkáš. Tak to si prostę vezmu svůj podíl.
...
{
	AI_Output			(self, other, "DIA_Biff_ICHBLEIBHIER_07_00"); //Tohle je vážnę nebezpečná oblast. Bęž dopâedu. Budu ti krejt záda.
...
instance DIA_Biff_Stay_AwayFromOC		(C_INFO)
{
	...
	description	 = 	"(Opęt vzít Biffa s sebou.)";
...
func void DIA_Biff_KOHLEWEGGEBEN_Info ()
{
	...
	AI_Output			(self, other, "DIA_Biff_KOHLEWEGGEBEN_07_01"); //Tak to bude lepší, když ho dáš mnę.
...
instance DIA_Biff_BIFFLOSWERDEN		(C_INFO)
{
	...
	description	 = 	"Mám dojem, že tady by naše spolupráce męla skončit.";
};
...
{
	AI_Output			(other, self, "DIA_Biff_BIFFLOSWERDEN_15_00"); //Mám dojem, že tady by naše spolupráce męla skončit.
	AI_Output			(self, other, "DIA_Biff_BIFFLOSWERDEN_07_01"); //Jak je libo. Taky bych męl začít myslet na lepší vęci. Tak zatím.
...
{
	AI_Output			(self, other, "DIA_Biff_MEHRGELD_07_00"); //Začínám mít dojem, že bych z tebe mohl dostat víc penęz.

	if (DJG_Biff_HalbeHalbe == TRUE)
	{
		AI_Output			(self, other, "DIA_Biff_MEHRGELD_07_01"); //100 zlatých by to męlo spravit.
		if (DIA_Biff_MEHRGELD_Info_OneTime == FALSE)
		{
			AI_Output			(self, other, "DIA_Biff_MEHRGELD_07_02"); //Žádnej problém. Jasnę, že jsem nezapomnęl, že si máme rozdęlit koâist.
			AI_Output			(self, other, "DIA_Biff_MEHRGELD_07_03"); //Proto jsem tę taky tak často otravoval, abys mi dal víc penęz.
	...
	Info_AddChoice	(DIA_Biff_MEHRGELD, "Dobrá. Za to mi ještę stojíš.", DIA_Biff_MEHRGELD_ok );

};

func void DIA_Biff_MEHRGELD_ok ()
{
	AI_Output			(other, self, "DIA_Biff_MEHRGELD_ok_15_00"); //Dobrá. Za to mi ještę stojíš.
	...
	if (B_GiveInvItems (other, self, ItMi_Gold,100))
		...
		{
			AI_Output			(self, other, "DIA_Biff_MEHRGELD_ok_07_02"); //Ty mizernej bâídile, nemůžeš ani zaplatit poâádnýho ozbrojence.
...
instance DIA_Biff_HEILUNG		(C_INFO)
{
	...
	description	 = 	"Nepotâebuješ nęjaký léčivý lektvar?";
};
...
{
	AI_Output			(other, self, "DIA_Biff_HEILUNG_15_00"); //Nepotâebuješ nęjaký léčivý lektvar?
	AI_Output			(self, other, "DIA_Biff_HEILUNG_07_01"); //Jasnę. To nemůže bejt na škodu.

	Info_ClearChoices	(DIA_Biff_HEILUNG);
	Info_AddChoice	(DIA_Biff_HEILUNG, "Dám ti nęjaký pozdęji.", DIA_Biff_HEILUNG_spaeter );
	Info_AddChoice	(DIA_Biff_HEILUNG, "(Nejslabší léčivý lektvar.)", DIA_Biff_HEILUNG_heiltrankLow );
	Info_AddChoice	(DIA_Biff_HEILUNG, "(Nejlepší léčivý lektvar.)", DIA_Biff_HEILUNG_heiltrank );
...
func void DIA_Biff_HEILUNG_heiltrank ()
{
	...
	{
	AI_Output			(self, other, "DIA_Biff_HEILUNG_heiltrank_07_00"); //Hádám, že si budu muset počkat, dokud pro mę nęjaký nebudeš mít.
	};
...
func void DIA_Biff_HEILUNG_heiltrankLow ()
{
	...
	{
	AI_Output			(self, other, "DIA_Biff_HEILUNG_heiltrankLow_07_00"); //Bohužel, žádný zrovna nemáš. Ještę se tu pozdęji pro nęjaký zastavím.
	};
...
{
	AI_Output			(other, self, "DIA_Biff_HEILUNG_spaeter_15_00"); //Dám ti nęjaký pozdęji.
	AI_Output			(self ,other, "DIA_Biff_HEILUNG_spaeter_07_01"); //Ale nezapomeŕ.
...
func void DIA_Biff_DRACHENTOT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Biff_DRACHENTOT_07_04"); //To je špatný. Právę jsem se rozehâál.
...
instance DIA_Biff_KnowWhereEnemy		(C_INFO)
{
	...
	PERMANENT 	 =  TRUE;
	description	 = 	"Nemęl bys chuă na menší výlet kolem svęta?";
};
...
{
	AI_Output			(other, self, "DIA_Biff_KnowWhereEnemy_15_00"); //Nemęl bys chuă na menší výlet kolem svęta?
	AI_Output			(self, other, "DIA_Biff_KnowWhereEnemy_07_01"); //Co?
		
	if (crewmember_count >= Max_Crew)
	{
		AI_Output			(other,self , "DIA_Biff_KnowWhereEnemy_15_02"); //Zapomeŕ na to. Stejnę už mám plnou loë.
		AI_Output			(self, other, "DIA_Biff_KnowWhereEnemy_07_03"); //Pâestaŕ si ze mę utahovat, chlape.
	}
	else 
	{
		AI_Output			(other,self , "DIA_Biff_KnowWhereEnemy_15_04"); //Chystám se opustit Khorinis a vyrazit na ostrov, abych se tam poohlédl po nęjakých nových protivnících.

		Info_ClearChoices (DIA_Biff_KnowWhereEnemy);
		Info_AddChoice (DIA_Biff_KnowWhereEnemy,"Prostę jsem si myslel, že bych se o tom męl zmínit.",DIA_Biff_KnowWhereEnemy_No);
...
FUNC VOID DIA_Biff_KnowWhereEnemy_Yes ()
{
	...
	AI_Output (self ,other,"DIA_Biff_KnowWhereEnemy_Yes_07_01"); //Další nepâátelé mę neberou. Chci...
	...
	AI_Output (other,self ,"DIA_Biff_KnowWhereEnemy_Yes_15_04"); //Ale nejdâív tę musíme dostat pryč z Hornického údolí.
    ...
    B_LogEntry (TOPIC_Crew,"Biff se ke mnę pâi vidinę nesmírného bohatství pâidal. Pokud mu poskytnu dost zlata, mohu s ním počítat."); 
...
{
	AI_Output (other,self ,"DIA_Biff_KnowWhereEnemy_No_15_00"); //Prostę jsem si myslel, že bych se o tom męl zmínit.
	AI_Output (self ,other,"DIA_Biff_KnowWhereEnemy_No_07_01"); //Dobrá, dobrá, tak hodnę štęstí.
...
instance DIA_Biff_Pass		(C_INFO)
{
	...
	description	 = 	"Dostaneš se pâes průsmyk?";
};
...
{
	AI_Output			(other, self, "DIA_Biff_Pass_15_00"); //Dostaneš se pâes průsmyk?
	AI_Output			(self, other, "DIA_Biff_Pass_07_01"); //Pâestaŕ žvanit. Pokračuj. Chci už to konečnę mít za sebou.
	AI_StopProcessInfos (self);
