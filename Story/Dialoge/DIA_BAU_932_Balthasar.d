...
func void DIA_Balthasar_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Balthasar_HALLO_05_03"); //Ó, to vidím. Nejsem už tak mladý jako dâív, však víš. A už léta čekám na nękoho, kdo by to po mnę pâevzal.
...
func void DIA_Balthasar_WASMACHSTDU_Info ()
{
	...
	AI_Output			(self, other, "DIA_Balthasar_WASMACHSTDU_05_01"); //Ó, hlídám ovce a dęlám to tak dlouho, co si jen pamatuju.
...
instance DIA_Addon_Balthasar_Rangerbandits		(C_INFO)
{
	...
	description	 = 	"Nevidęls kolem projíždęt nęjaké bandity?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Balthasar_Rangerbandits_15_00"); //Nevidęls kolem projíždęt nęjaké bandity?
	AI_Output	(self, other, "DIA_Addon_Balthasar_Rangerbandits_05_01"); //Najisto. Jeli kolem Sekobovy farmy nękam na sever do lesů.
	
	if (MIS_Vatras_FindTheBanditTrader == LOG_RUNNING)	
	{
		AI_Output	(self, other, "DIA_Addon_Balthasar_Rangerbandits_05_02"); //Vezli mnoho a mnoho zbraní. Vypadali jako by chtęli vyhrát skâetí válku sami!
	};
	
	if (SC_KnowsLuciaCaughtByBandits == TRUE)
	{
		AI_Output	(self, other, "DIA_Addon_Balthasar_Rangerbandits_05_03"); //A jestli mę oči nezklamaly, ti bastardi s sebou vlekli ještę nęjakou mladou holku.
...
instance DIA_Balthasar_BENGARUEBERREDET		(C_INFO)
{
	...
	description	 = 	"Už zase můžeš svoje ovce brát na Bengarovy pastviny.";
};
