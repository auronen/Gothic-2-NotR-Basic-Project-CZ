...
func void DIA_Torlof_Probe_Info ()
{
	...
	if (Npc_KnowsInfo (other, DIA_Lee_OtherSld))
	{
		...
		AI_Output (self, other, "DIA_Torlof_Probe_01_03"); //(vzdychne si) Fajn. Tak dobrá. Než se k nám budeš moci pâidat, musíš udęlat dvę vęci.
		...
		B_LogEntry (TOPIC_BecomeSLD,"Mám-li být pâijat mezi žoldnéâe, musím projít Torlofovou zkouškou a získat si úctu ostatních.");
	}
	else
	{
...
instance DIA_Torlof_Respekt (C_INFO)
{
	...
	permanent 	= FALSE;
	description	= "Jak si vysloužím respekt ostatních žoldnéâů?";
};
...
func void DIA_Torlof_Respekt_Info ()
{
	...
	AI_Output (self, other, "DIA_Torlof_Respekt_01_03"); //Nękteâí budou chtít využít toho, v jaké jsi situaci, jiným se prostę nebude líbit tvoje tváâ.
...
func void DIA_Torlof_RUF_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Torlof_RUF_01_02"); //Wolf nemá nic proti tomu, aby ses pâidal.
		Points_Sld = Points_Sld + 1;
	};
	...
	{
		AI_Output (self, other, "DIA_Torlof_RUF_01_08"); //Cipher âíká, že pro nęj bylo od začátku jasné, že by ses męl pâidat. Vypadá to, že ho nęco vážnę potęšilo.
		Points_Sld = Points_Sld + 1;
	}
	...
	{
		AI_Output (self, other, "DIA_Torlof_RUF_01_13"); //Sentenza pro tebe ruku zvedne. Âíká, že jsi se zachoval velice rozumnę.
		Points_Sld = Points_Sld + 1;
	...
	else if (Buster.aivar[AIV_TalkedToPlayer] == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Torlof_RUF_01_20"); //To nebyl dobrý nápad. Možná bys męl za ním zajít a vyzvat ho.
	};
	...
	if (Points_Sld >= 9) //geändert M.F.					//(Maximal 11 - 13 / insgesamt 6 + 3+1 oder 5+1 + 1 für Duell)
	{
		...
		B_LogEntry (TOPIC_BecomeSLD,"Mezi žoldnéâi už jsem si vydobyl dost úcty. Nyní bych męl prohodit pár slov s Leem."); 
	}
...
func void DIA_Torlof_BengarSuccess_Info ()
{
	...
	AI_Output (other, self, "DIA_Torlof_BengarSuccess_15_02"); //To by s tím męli docela potíže...
...
func void DIA_Torlof_DEMENTOREN_Info ()
{
	...
	AI_Output (self, other, "DIA_Torlof_DEMENTOREN_01_03"); //Šli smęrem na tábor banditů, co je v horách na jižním konci údolí.
...
func void DIA_Torlof_DmtSuccess_Info ()
{
	...
	AI_Output (self, other, "DIA_Torlof_DmtSuccess_01_02"); //Ani za mák jsem tęm chlapíkům nevęâil. Jenom by budili trable.
...
func void DIA_Torlof_WOISTSYLVIO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Torlof_WOISTSYLVIO_01_04"); //To pro mę není. Jsem námoâník. Patâím na moâe a ne do nęjakého dusného dračího doupęte.
...
instance DIA_Torlof_BEMYCAPTAIN2		(C_INFO)
{
	...
	description	 = 	"Brána do hradu v Hornickém údolí je otevâená a zaseknutá...";
};
...
{
	AI_Output			(other, self, "DIA_Torlof_BEMYCAPTAIN2_15_00"); //Brána do hradu v Hornickém údolí je otevâená a zaseknutá. Skâetům už nic nebrání v tom, aby nevzali hrad útokem.
...
func void DIA_Torlof_BEMYCAPTAIN3_ok ()
{
	...
	if (B_GiveInvItems (other, self, ItMi_Gold,	2500))
	{
		...
		B_LogEntry (TOPIC_Captain,"Jakmile jsem mu pâedal 2500 zlaăáků, je Torlof konečnę pâipraven mę dopravit k cíli.");     
	}
	else
	{
