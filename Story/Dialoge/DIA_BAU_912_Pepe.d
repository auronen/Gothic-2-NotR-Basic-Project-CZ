...
instance DIA_Pepe_Danger (C_INFO)
{
 ...
 permanent  = FALSE;
 description = "Co je tak nebezpečného na pastvinę?";
};
...
func void DIA_Pepe_KillWolves_Info ()
{
 ...
 AI_Output (self, other, "DIA_Pepe_KillWolves_03_01"); //(posmęšnę) Ty? A sám? Ha ha. Tomu nevęâím. To dâív uvęâil tomu, že to udęlá můj chlebodárce.
...
func void DIA_Pepe_Bullco_Info ()
{
 ...
 AI_Output (self, other, "DIA_Pepe_Bullco_03_02"); //Ale místo toho se se svým kámošem Sylviem jen celý dny flákaj kolem Thekly v kuchyni.
