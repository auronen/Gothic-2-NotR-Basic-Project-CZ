...
{
	AI_Output (self, other, "DIA_Serpentes_GOAWAY_10_00"); //Tvoje pâítomnost dokazuje nejen nedostatek úcty, ale také tvou hloupost, novici!
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info YOURSTORY
...
func void DIA_Serpentes_SUCCESS_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Serpentes_SUCCESS_10_02"); //(triumfálnę) Ale teë ses sám prozradil! Byls to ty, kdo zabil Garwiga!
...
func void DIA_Serpentes_MinenAnteile_was_jaSLD ()
{
	...
	Log_CreateTopic (TOPIC_MinenAnteile, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_MinenAnteile, LOG_RUNNING);
	B_LogEntry (TOPIC_MinenAnteile,"Musím pâed soud do kláštera pâivést Salandrila, alchymistu z horní khorinisské čtvrti. Nemusí mę zajímat, co vlastnę spáchal, hlavnę když za to dostanu zaplaceno."); 
};
...
instance DIA_Serpentes_GOTSalandril		(C_INFO)
{
	...
	description	 = 	"Vím, kdo vypustil ty podílové listy do obęhu.";
};
