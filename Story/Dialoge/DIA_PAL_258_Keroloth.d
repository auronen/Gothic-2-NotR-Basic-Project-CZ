...
{	
	...
	AI_Output	(self ,other,"DIA_Keroloth_HELLO_07_01"); //Ano. Až ti skâeti, nebo ještę hůâ draci znovu zaútočí, bude každá ruka dobrá.
};
//***********************************************
...
INSTANCE DIA_Keroloth_WantTeach(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Můžeš nęco naučit i mę?";
};                       
...
{	
	AI_Output 	(other,self ,"DIA_Keroloth_WantTeach_15_00"); //Můžeš nęco naučit i mę?
	AI_Output 	(self ,other,"DIA_Keroloth_WantTeach_07_01"); //Samozâejmę. Trénuji každého slušného človęka.
	AI_Output 	(self ,other,"DIA_Keroloth_WantTeach_07_02"); //Ale pokud tady chceš pâežít, budeš potâebovat kromę talentu i nęjakou dobrou zbraŕ.
	...
	B_LogEntry (TOPIC_Trader_OC,"Tandor na hradę prodává zbranę.");
};
//***********************************************
//	Kampflehrer EINHAND
//***********************************************
...
INSTANCE DIA_Keroloth_Teacher(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Naučit se jednoručnímu boji.)";
};                       
...
{
	AI_Output(self,other,"B_Keroloth_TeachNoMore1_07_00"); //Jsi velice dobrý. Už není nic, co bych tę mohl naučit.
};

FUNC VOID B_Keroloth_TeachNoMore2 ()
{
	AI_Output(self,other,"B_Keroloth_TeachNoMore2_07_00"); //Může ti pomoci už jen zkušený mistr meče.
};
...
INSTANCE DIA_Keroloth_Teach(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Osvojit si dovednost obouručního boje)";
};                       
//----------------------------------
...
{	
	AI_Output (other,self ,"DIA_Keroloth_Teach_15_00"); //Začnęme.
...
{	
	...
	AI_Output 	(other,self ,"DIA_Keroloth_Udar_15_02"); //Můžeš mę trénovat i v nęm?
	AI_Output	(self ,other,"DIA_Keroloth_Udar_07_03"); //Ne, ale můžeš se zeptat Udara, je to dobrý - ne, je to NEJLEPŠÍ stâelec z kuše, jakého znám.
...
instance DIA_Keroloth_KAP4_HELLO		(C_INFO)
{
	...
	description	 = 	"Nęjak protahuješ obličej.";
};
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_15_00"); //Nęjak protahuješ obličej.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_07_01"); //(nahnęvanę) Zatracenę. Jak povídám, jeden musí být jako ostâíž.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_07_02"); //Na chvíli se otočíš zády a hned ti začnou mizet vęci. Ksakru!

	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, DIALOG_BACK, DIA_Keroloth_KAP4_HELLO_ende );
	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, "Paladin by se nemęl nikdy pâestat ovládat.", DIA_Keroloth_KAP4_HELLO_ruhig );
 	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, "Nękdo ti nęco ukradl?", DIA_Keroloth_KAP4_HELLO_bestohlen );
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_bestohlen_15_00"); //Nękdo ti nęco ukradl?
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_07_01"); //Ne. Nękdo mi strčil do kapsy 20 zlatých. Samozâejmę, že mi nękdo nęco ukradl, blbečku!
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_07_02"); //Ale to ti povídám, až se mi ta prašivá svinę dostane do rukou...
...
func void DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_07_01"); //Męšec - męl jsem v nęm všechny své úspory.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_07_02"); //A teë je pryč!
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_15_03"); //Určitę se nękde objeví.
...
func void DIA_Keroloth_KAP4_HELLO_pack ()
{
	...
	if (hero.guild == GIL_DJG)
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_01"); //Nękdo z vás parchantů drakobijců, samozâejmę. Kdo jiný?
		}
	else
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_02"); //Samozâejmę nękdo z té drakobijecké chátry. O kom jiném bych asi tak mluvil?
		};
		
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_03"); //(pro sebe) Povídám, že je zapotâebí mít je poâád na očích.
};

func void DIA_Keroloth_KAP4_HELLO_ruhig ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_ruhig_15_00"); //Uklidni se! Paladin by se nemęl pâestat ovládat.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_ruhig_07_01"); //Ale já se nechci uklidnit. Bylo to zatracenę všechno, co jsem męl!
};
...
instance DIA_Keroloth_KAP4_GELDGEFUNDEN		(C_INFO)
{
	...
	description	 = 	"Asi jsem našel tvůj męšec.";
};
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_15_00"); //Asi jsem našel tvůj męšec.
	...
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_07_01"); //Je prázdný. Která svinę to udęlala?
	
		Keroloths_BeutelLeer = TRUE;
	};
	if (B_GiveInvItems (other, self, ItMi_KerolothsGeldbeutel_MIS,1))
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_07_02"); //Co? Kde? Který parchant to udęlal?
	};
	
	if (hero.guild == GIL_DJG)
	{
		Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Momentíček - jaká bude odmęna?", DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn );
	};

	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Byl tady hned u kovárny.", DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede );
	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Podezírám jednoho z drakobijců.", DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG );
	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Jak bych to mohl vędęt?", DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung);
};
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_15_00"); //Jak bych to mohl vędęt?

	if (hero.guild == GIL_DJG)
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_07_01"); //Dęláš si ze mę legraci? Pâiznej se, žes to byl ty.
	...
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_07_02"); //To ještę zjistím.
		AI_StopProcessInfos (self);
	};
};
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_15_00"); //Podezírám jednoho z drakobijců.
		
	AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_01"); //(rozzlobenę) Já to vędęl.
	
	if (hero.guild == GIL_DJG)
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_02"); //(kâičí) Nikdy tę nemęli pouštęt do hradu.
		}
		else
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_03"); //Jen počkej, já dám té svini co proto.
		};
...
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede_07_01"); //Kde? Poblíž kovárny? Určitę vypadl jednomu z tęch drakobijců z kapsy, neâíkej, že ne.
};

func void DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_15_00"); //Počkej. A co odmęna?
	
 	if (Keroloths_BeutelLeer == TRUE)
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_07_01"); //Tak to je poslední kapka. Už dlouho ti nikdo pęstí nepâepočítal zuby, co?
		AI_StopProcessInfos	(self);
		B_Attack (self, other, AR_NONE, 1);	
	}
	else
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_07_02"); //Arrh. Dobrá. Tady je pár zlatých. A teë mi âekneš, kdo to udęlal?
...
instance DIA_Keroloth_KAP4_BELOHNUNG		(C_INFO)
{
	...
	description	 = 	"Chci nálezné za tvůj męšec.";
};
...
{
 	AI_Output			(other, self, "DIA_Keroloth_KAP4_BELOHNUNG_15_00"); //Chci nálezné za tvůj męšec.

	if ((Keroloths_BeutelLeer == TRUE) || (hero.guild == GIL_DJG))
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_BELOHNUNG_07_01"); //Dostaneš akorát tak ránu do zubů!
		AI_StopProcessInfos	(self);
		B_Attack (self, other, AR_NONE, 1);	
	}
	else
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_BELOHNUNG_07_02"); //To je jediné, co tę zajímá? Tady máš sakra pár zlatých a teë zmiz.
...
func void DIA_Keroloth_KAP4_ENTSPANNDICH_Info ()
{
	...
	{
	AI_Output			(self, other, "DIA_Keroloth_KAP4_ENTSPANNDICH_07_02"); //Nemůžu to dokázat, ale myslím, že ty jsi ten zrádce, který otevâel bránu.
	...
	{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_ENTSPANNDICH_15_04"); //Máš svůj męšec zpátky, ne?
	AI_Output			(self, other, "DIA_Keroloth_KAP4_ENTSPANNDICH_07_05"); //Nehraj si se mnou, chlapče! Padej!
	AI_StopProcessInfos (self);
	};
};
