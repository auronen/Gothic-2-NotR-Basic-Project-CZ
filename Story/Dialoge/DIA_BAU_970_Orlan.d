...
func void DIA_Orlan_Wein_Info ()
{
 ...
 Info_AddChoice (DIA_Orlan_Wein,"Ty se mę snažíš napálit?",DIA_Orlan_Wein_NEIN);
};
...
FUNC VOID DIA_Orlan_Wein_NEIN()
{
 ...
 AI_Output (self, other, "DIA_Orlan_Wein_NEIN_05_01"); //Gorax tę snad varoval, ne? Dobrá, možná bychom na tom mohli vydęlat oba. Hele - dám ti za to víno 100 zlatých.
...
FUNC VOID DIA_Orlan_Wein_Nie()
{
 ...
 AI_Output (self, other, "DIA_Orlan_Wein_Nie_05_01"); //Copak na tom nechceš vydęlat, co? (povzdych) Dobrá, tady je zlato.
...
func void DIA_Orlan_WERBISTDU_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Orlan_WERBISTDU_05_04"); //Můžu ti to nabídnou všechno a dokonce ještę víc, pokud jsou tvé mince pravé.
...
func void DIA_Addon_Orlan_Greg_Info ()
{
 ...
 AI_Output (self, other, "DIA_Addon_Orlan_Greg_05_01"); //Už jsem ho tu jednou vidęl - takový hrubián.
 AI_Output (self, other, "DIA_Addon_Orlan_Greg_05_02"); //Ubytoval se v jednom z mých pokojů. Męl s sebou obrovskou truhlu.
 AI_Output (self, other, "DIA_Addon_Orlan_Greg_05_03"); //Až když jsem mu to nękolikrát pâipomínal, tak mi konečnę zaplatil nájem za pokoj - vůbec s tím nespęchal.
 AI_Output (self, other, "DIA_Addon_Orlan_Greg_05_04"); //A pak byl jednou prostę pryč. I se svou truhlou. Už nechci nic mít s lidmi jako on.
};
...
func void DIA_Addon_Orlan_Ranger_Info ()
{
 ...
 Info_AddChoice (DIA_Addon_Orlan_Ranger, "Človęče! Patâím ke 'Kruhu Vody'!", DIA_Addon_Orlan_Ranger_Idiot);
...
{
 AI_Output (other, self, "DIA_Addon_Orlan_Ranger_Aqua_15_00"); //Je to akvamarím. Už jsi nękdy nęjaký vidęl?
 AI_Output (self, other, "DIA_Addon_Orlan_Ranger_Aqua_05_01"); //Jo. Vítej na velitelství, bratâe prstenu.
 if (Npc_KnowsInfo (other, DIA_Addon_Orlan_NoMeeting)) //verrissen
 {
  AI_Output (self, other, "DIA_Addon_Orlan_Ranger_Aqua_05_02"); //... i když se nazdáš být nejchytâejší ...
 };
...
{
 AI_Output (other, self, "DIA_Addon_Orlan_Ranger_Lares_15_00"); //Človęče! Patâím ke 'Kruhu Vody'!
...
instance DIA_Addon_Orlan_Teleportstein  (C_INFO)
{
 ...
 description = "Už jsi nękdy použil teleportarční kámen?";
};
...
{
 AI_Output (other, self, "DIA_Addon_Orlan_Teleportstein_15_00"); //Už jsi nękdy použil teleportarční kámen?
 AI_Output (self, other, "DIA_Addon_Orlan_Teleportstein_05_01"); //Zbláznil ses? Dokud mi mágové Vody neâeknou, že je to bezpečné, nepâiblížím se na 10 kroků.
 AI_Output (self, other, "DIA_Addon_Orlan_Teleportstein_05_02"); //Povęâili mę, abych schoval jeden z tęch teleportačních kámenů a to je pâesnę to, co chci udęlat.

 B_GivePlayerXP (XP_Ambient);
 Info_ClearChoices (DIA_Addon_Orlan_Teleportstein);
 Info_AddChoice (DIA_Addon_Orlan_Teleportstein, "Můžu se na ten teleportarční kámen mrknout?", DIA_Addon_Orlan_Teleportstein_sehen );
 Info_AddChoice (DIA_Addon_Orlan_Teleportstein, "Kde je pâesnę ten teleportační kámen?", DIA_Addon_Orlan_Teleportstein_wo );
};
func void DIA_Addon_Orlan_Teleportstein_sehen ()
{
 AI_Output   (other, self, "DIA_Addon_Orlan_Teleportstein_sehen_15_00"); //Můžu se na ten teleportační kámen mrknout?
 AI_Output   (self, other, "DIA_Addon_Orlan_Teleportstein_sehen_05_01"); //Pro mę za mę. Tady je klíč. Zatarasil jsem vchod.
 ...
 B_LogEntry (TOPIC_Addon_TeleportsNW,"Orlan zamkl teleportační kámen v jeskyni na jihozápad od jeho hospody.");
};

func void DIA_Addon_Orlan_Teleportstein_wo ()
{
 AI_Output   (other, self, "DIA_Addon_Orlan_Teleportstein_wo_15_00"); //Kde je pâesnę ten teleportační kámen?
...
func void DIA_Addon_Orlan_NoMeeting_Info ()
{
 ...
 AI_Output (self, other, "DIA_Addon_Orlan_NoMeeting_05_01"); //(štiplavę) Nevidím prsten. Chceš nęco k pití?
};
...
instance DIA_Addon_Orlan_WhenRangerMeeting  (C_INFO)
{
 ...
 description  =  "Slyšel jsem nęco o srazu 'Kruhu' ve tvé hospodę.";
};
...
{
 AI_Output (other, self, "DIA_Addon_Orlan_WhenRangerMeeting_15_00"); //Slyšel jsem nęco o srazu 'Kruhu' ve tvé hospodę.
 AI_Output (self, other, "DIA_Addon_Orlan_WhenRangerMeeting_05_01"); //To je pravda. Męl by každou chvíli začít.
 AI_Output (self, other, "DIA_Addon_Orlan_WhenRangerMeeting_05_02"); //Zajímalo by mę, co je zdrželo.
...
func void DIA_Addon_Orlan_WhenRangerMeeting_Today ()
{
 ...
 AI_Output   (self, other, "DIA_Addon_Orlan_WhenRangerMeeting_Today_05_01"); //Pokud si to dobâe pamatuju tak ano.
 AI_Output   (self, other, "DIA_Addon_Orlan_WhenRangerMeeting_Today_05_02"); //Doufám, že zase pâijdou pozdę.
...
func void DIA_Orlan_RUESTUNG_Buy ()
{
 ...
 if (B_GiveInvItems  (other, self, ItMi_Gold, VALUE_ITAR_Leather_L))
  ...
  {
   AI_Output   (self, other,"DIA_Orlan_RUESTUNG_Buy_05_02"); //Promiŕ. Dokud nemáš peníze, žádné obchody nebudou.
  };
...
func void DIA_Orlan_TRADE_Info ()
{
 ...
 B_GiveTradeInv (self);
  ...
  if ((SC_IsRanger == TRUE) || (Orlan_KnowsSCAsRanger == TRUE)||(SCIsWearingRangerRing == TRUE))
   {
    AI_Output   (self, other, "DIA_Addon_Orlan_TRADE_05_00"); //Samozâejmę, bratâe kruhu.
    Orlan_KnowsSCAsRanger = TRUE;
   }
  //ADDON<
...
func void DIA_Orlan_HotelZimmer_ja ()
{
  ...
  {
   AI_Output   (self, other, "DIA_Orlan_HotelZimmer_ja_05_02"); //Nemáš 50. Nejdâív peníze, pak zábava.
  };
 Info_ClearChoices (DIA_Orlan_HotelZimmer);
};
...
func void DIA_Orlan_WETTKAMPFLAEUFT_Info ()
{
   ...
   if ((hero.guild != GIL_PAL) && (hero.guild != GIL_KDF))
    {
     AI_Output   (self, other, "DIA_Orlan_WETTKAMPFLAEUFT_05_06"); //Tak dobrá, doufám, že to bylo naposledy. O takovéhle pozdvižení ve svém domę nestojím, zapište si to všichni za uši.
    };
...
func void DIA_Orlan_Perm_Info ()
{
 ...
 {
  AI_Output (self, other, "DIA_Orlan_Perm_05_03"); //Snad ty černí mágové brzy odtáhnou, jinak můžu hospodu zavâít.
