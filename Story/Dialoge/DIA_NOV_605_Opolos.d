...
FUNC VOID DIA_Opolos_rezept_Info()
{
	if (Npc_HasItems (other, ItWr_Manarezept) >= 1)
	{
		...
		B_UseFakeScroll ();
		AI_Output (self ,other,"DIA_Opolos_rezept_12_03"); //Tak a je to. Pokud chceš, můžu tę nęco naučit.
...
instance DIA_Opolos_LIESEL		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Podívej, pâivedl jsem Betsy. Můžu ji nechat u tebe?";
};
...
FUNC VOID DIA_Opolos_Kap3_PERM_Info()
{
	...
	Info_AddChoice (DIA_Opolos_Kap3_PERM,"V Hornickém údolí jsou draci. Společnę s armádou skâetů obléhají královské jednotky.",DIA_Opolos_Kap3_PERM_DRAGONS);
...
FUNC VOID DIA_Opolos_Kap3_PERM_DMT()
{
	...
	AI_Output (other,self ,"DIA_Opolos_Kap3_PERM_DMT_15_03"); //Vypadá to na nęjaký druh mágů. Pâinejmenším jsou schopni provozovat magii.
