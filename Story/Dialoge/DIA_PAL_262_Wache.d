...
func void DIA_PAL_262_GREET_Info ()
{
	...
	AI_Output (other, self, "DIA_PAL_262_GREET_15_01"); //Mnohem důležitęjší je otázka, odkud jsem pâišel. Pâišel jsem skrz průsmyk.
	AI_Output (other, self, "DIA_PAL_262_GREET_15_02"); //Budeš mi tedy dál stát v cestę, nebo mę pustíš dál?
	AI_Output (self, other, "DIA_PAL_262_GREET_10_03"); //No, to jsem pâece nemohl vędęt. Jasnę, že můžeš jít dál.
...
func void DIA_Wache_PERM_Info ()
{
	...
	*/
	...
	AI_Output (self, other, "DIA_Addon_Wache_PERM_10_02"); //Jen bęž dovnitâ. Bęhem dne je najdeš v trůnním sále v pâízemí.
};
