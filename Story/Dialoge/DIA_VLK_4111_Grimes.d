...
{	
	AI_Output (self,other,"DIA_Grimes_Hallo_05_00");//Ty? Kdo by to byl âekl, že se znovu setkáme.
...
INSTANCE DIA_Grimes_Erz(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Kolik rudy už jsi vytęžil?";
};                       
...
{	
	AI_Output (other,self,"DIA_Grimes_Erz_15_00");//Kolik rudy už jsi vytęžil?
	AI_Output (self,other,"DIA_Grimes_Erz_05_01");//Nękolik beden. Ale nic z toho tady nezůstalo.
	AI_Output (self,other,"DIA_Grimes_Erz_05_02");//Paladin Marcos se rozhodl vzít rudu do hradu, protože nás poâád ohrožovali skâeti.
};
// ************************************************************
// 			 Weg
// ************************************************************
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_Weg_05_01");//Nešel pâímou cestou - místo toho chtęl pâejít âeku tam, kde byla zamrzlá.
	AI_Output (self,other,"DIA_Grimes_Weg_05_02");//Chtęl si to zkrátit a dostat se k hradu ze západu.
};
// ************************************************************
// 			  Grimes
// ************************************************************
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_Grimes_05_01");//Ne, zůstanu a budu tęžit rudu.
	AI_Output (self,other,"DIA_Grimes_Grimes_05_02");//Nenechám se zastavit nękolika skâety - už jsem pâečkal horší časy.
	AI_Output (self,other,"DIA_Grimes_Grimes_05_03");//Pamatuješ, jak jsme tęžili ve starém dole, a najednou se dovnitâ provalila voda...
	AI_Output (self,other,"DIA_Grimes_Grimes_05_04");//Ale to jsou staré pâíbęhy.
};
// ************************************************************
// 			  Grimes
// ************************************************************
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_PERM_05_01");//Tahle skála je zatracené nepoddajná - úplnę jako by se snažila nám zabránit v získávání rudy.
};
