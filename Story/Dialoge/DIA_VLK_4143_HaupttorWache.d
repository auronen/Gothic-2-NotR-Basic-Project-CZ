...
func void DIA_Haupttorwache_AUFGABE_Info ()
{
	...
	AI_Output			(self, other, "DIA_Haupttorwache_AUFGABE_13_01"); //Můj úkol je jednoduchý. Mám zajistit, aby se skâeti drželi dál než 30 stop od brány.
	AI_Output			(self, other, "DIA_Haupttorwache_AUFGABE_13_02"); //Když se pokusí dostat pâes padací mâíž, spustím poplach. Toă vše.
};
...
func void DIA_Haupttorwache_TOROEFFNEN_Info ()
{
	...
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_13_01"); //Proč bys to proboha chtęl vędęt?

	self.flags = 0;//Joly:zur sicherheit

	Info_ClearChoices	(DIA_Haupttorwache_TOROEFFNEN);
	Info_AddChoice	(DIA_Haupttorwache_TOROEFFNEN, "Mám starost o bezpečnost hradu.", DIA_Haupttorwache_TOROEFFNEN_sicherheit );
...
func void DIA_Haupttorwache_TOROEFFNEN_sicherheit ()
{
	...
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_sicherheit_13_01"); //Já taky - v jednom kuse, vęâ mi.
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_sicherheit_13_02"); //A Garond mi jako vęrnému strážci konečnę svęâil klíč od brány.
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_sicherheit_13_03"); //(hrdę) To je obrovská zodpovędnost. Budu jej hlídat jako oko v hlavę, musel jsem to Garondovi odpâísáhnout.
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_sicherheit_13_04"); //Ano. Jen si pâedstav, že nękdo pâijde, zatáhne za páku, aby bránu otevâel, a ta stará rezavá ocelová mâíž se zasekne.
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_sicherheit_13_05"); //Nikdo by pak tu bránu už nemohl zavâít. Radši si ani nebudu domýšlet, co by se stalo potom. Proto je dobâe, že nikdo neví, že ten klíč mám u sebe zrovna já.
	AI_StopProcessInfos (self);
};
...
func void DIA_Haupttorwache_TOROEFFNEN_frage ()
{
	...
	AI_Output			(self, other, "DIA_Haupttorwache_TOROEFFNEN_frage_13_01"); //Ne abys to nękde vyžvanil - jen by sis tím nadęlal problémy. Časy jsou už takhle dost zlé. A teë bęž, mám spoustu práce.
	AI_StopProcessInfos (self);
};
...
INSTANCE DIA_Haupttorwache_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Tenhle klíč by ukradlo i malé dítę.)";
};                       
