...
func void DIA_Sentenza_Hello_JustLooking()
{
	...
	Info_AddChoice		(DIA_Sentenza_Hello, "Jen si posluž, klíëo píëo si mę prohledej!" 			,DIA_Sentenza_Hello_SearchMe);
};
...
func void DIA_Sentenza_Hello_NotYourBusiness()
{
	...
	AI_Output (self ,other,"DIA_Sentenza_Hello_NotYourBusiness_09_01"); //(povzdech) Pak ti to důkladnę vysvętlím.
	...
	func void B_Sentenza_SearchMe()
	{
		...
		AI_Output (other, self,"DIA_Sentenza_Hello_SearchMe_15_00"); //Jen si posluž, klíëo píëo si mę prohledej!
		...
		else
		{
			...
			AI_Output (self ,other,"DIA_Sentenza_Hello_SearchMe_09_08"); //Je vidęt, že nejsi úplnę blbý. Určitę se ještę setkáme - tak na sebe zatím dávej pozor!
...
func void DIA_Sentenza_Hello_HandsOff()
{
	...
	Info_AddChoice		(DIA_Sentenza_Hello, "Nebo si na nęjaký čas budeš muset nechat zajít chuă na prohledávání."	,DIA_Sentenza_Hello_OrElse);
};
...
{	
	...
	Info_AddChoice		(DIA_Sentenza_Vzwei, "Jen si posluž, klíëo píëo si mę prohledej!" 	,DIA_Sentenza_Vzwei_SearchMe);
};
...
{	
	...
	AI_Output (self, other, "DIA_Sentenza_WannaJoin_09_02"); //(lhostejnę) Je ti jasné, že žoldáci budou hlasovat, jestli tę pâijmout nebo ne?
};
...
{	
	...
	{
		AI_Output (self, other, "DIA_Sentenza_Vote_09_04"); //Takhle to nefunguje, chlapečku! Jestli pro tebe mám hlasovat, pak musíš ke mnę nasmęrovat taky ŕájaký zlato.
...
{	
	AI_Output (other, self, "DIA_Sentenza_Pay50_15_00"); //Tady máš tedy tęch 50 zlaăáků.
...
{	
	AI_Output (other, self, "DIA_Sentenza_GoldBack_15_00"); //Vraă mi mé zlato!
...
INSTANCE DIA_Sentenza_AufsMaul (C_INFO)
{
	...
	description = "Povęz mi, to, co máš vepâedu, je tvůj ksicht, nebo to na mę vystrkuješ prdel?";
};                       
