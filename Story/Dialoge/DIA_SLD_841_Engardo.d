...
func void DIA_Engardo_HALLO_Info ()
{
	...
	if (Chance == FALSE)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_00"); //Hej, burane, to ses ztratil? Vraă se zpátky na pole a vytáhni tam nęjaký tuâíny.
		Chance = 1;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 1) 
	{	
		AI_Output (self, other, "DIA_Engardo_HALLO_13_01"); //Jsi ve špatný čas na špatném místę...
		AI_Output (self, other, "DIA_Engardo_HALLO_13_02"); //... takže mám dojem, že jestli se chceš dožít rána, męl bys teë hned odsud pęknę vysmahnout, jasný?
		Chance = 2;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 2)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_03"); //Máš snad nęco s ušima? Nebo se chceš pozdravit se zubatou? (cynicky) Fajn, teë už je pozdę.
