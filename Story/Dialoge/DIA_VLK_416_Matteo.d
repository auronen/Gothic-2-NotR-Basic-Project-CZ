...
{	
	...
	AI_Output (self, other, "DIA_Matteo_Paladine_09_02"); //Poslednę jsem míâil do horní části męsta, ale stráže mi zastoupily cestu a chtęly vędęt, co tam pohledávám!
	AI_Output (other, self, "DIA_Matteo_Paladine_15_03"); //A?
	AI_Output (self, other, "DIA_Matteo_Paladine_09_04"); //Samozâejmę mę pak pustili dovnitâ!
	AI_Output (self, other, "DIA_Matteo_Paladine_09_05"); //Můj obchod ve męstę stál ještę dâív, než ti nabubâelí hejhulové dâevęným mečem zapichovali podsvinčata!
...
{	
	...
	AI_Output (self, other, "DIA_Matteo_Confiscated_09_02"); //Prostę ke vchodu na dvůr postavily stráž.
...
INSTANCE DIA_Matteo_LehrlingLater(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Pomoz mi vstoupit do učení k nękterému z ostatních mistrů!";
};                       
...
{	
	AI_Output (other, self, "DIA_Matteo_LehrlingLater_15_00"); //Co za svou pomoc chceš?
	B_Matteo_Preis();
};
...
func void B_Matteo_RegDichAb()
{
	...
	B_LogEntry (Topic_Matteo,"Gritta, neteâ tesaâe Thorbena, dluží Matteovi 100 zlaăáků. Když mu je vrátím, pomůže mi v cestę do horní čtvrti.");
};
...
{	
	...
	AI_Output (self, other, "DIA_Matteo_WoAlsLehrling_09_04"); //Ale důležité je, aby s tím souhlasili i ostatní mistâi. Tak je to tady v Khorinisu zvykem.
...
INSTANCE DIA_Matteo_Minenanteil (C_INFO)
{
	...
	description = "Mezi tvým zbožím vidím i nęjaké důlní akcie. Kdo ti je prodal?";
};   
