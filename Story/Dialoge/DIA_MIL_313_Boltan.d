...
{
	//AI_Output (other, self, "DIA_Boltan_Add_15_15"); //Jenom tudy procházím.
...
instance DIA_Boltan_ToConvicts		(C_INFO)
{
	...
	permanent 	= TRUE;
	description = "Chtęl bych vidęt vęznę.";
};
...
{
	AI_Output (other, self, "DIA_Boltan_Add_15_01"); //Chtęl bych vidęt vęznę.
	...
	{
		AI_Output (self ,other, "DIA_Boltan_Add_05_02"); //Všechny cely jsou momentálnę prázdné.
	}
	else
	{
		...
		{
			AI_Output (self ,other, "DIA_Boltan_Add_05_05"); //Samozâejmę.
		}
		else
		{
			AI_Output (self ,other, "DIA_Boltan_Add_05_03"); //Jen bęž, ale nebuë tam dlouho, rozumíš?
		};
	};
};		
...
{
	AI_Output (self ,other, "DIA_Boltan_Add_05_08"); //Nepâišel jsi odsud vysekat toho svého pâítelíčka, že ne?
	AI_Output (self ,other, "DIA_Boltan_Add_05_09"); //Tak na to zapomeŕ! Jakmile spustím poplach, okamžitę tady budou ostatní hoši!
	AI_Output (self ,other, "DIA_Boltan_Add_05_10"); //A pak si dáme pár žoldanátků! (ošklivę se zasmęje)
};		
...
func void DIA_Boltan_HalloCanthar_Info ()
{
	...
	AI_Output (self ,other, "DIA_Boltan_Add_05_12"); //Pâišla se za nęj pâimluvit spousta lidí. Docela významných lidí.
	AI_Output (self ,other, "DIA_Boltan_Add_05_13"); //Celá ta vęc musela být jedno velké nedorozumęní. To se stává.
	AI_Output (self ,other, "DIA_Boltan_Add_05_14"); //Pâíštę by sis męl dávat vętší pozor, koho dáváš do vęzení.
};		
