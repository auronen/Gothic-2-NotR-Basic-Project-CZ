...
FUNC VOID DIA_BDT_1013_BANDIT_WHERE_WHO()
{
 ...
 AI_Output (self, other, "DIA_BDT_1013_BANDIT_WHERE_WHO_01_01"); //Jde po tobę půlka Khorinisu a ty mi chceš tvrdit, že o tom nic nevíš?
...
{
 AI_Output (other, self, "DIA_BDT_1013_BANDIT_WHERE_PRISONER_15_00"); //Byl jsem vęznęm v trestanecké kolonii.
 ...
 AI_Output (other, self, "DIA_BDT_1013_BANDIT_WHERE_PRISONER_15_08"); //Tak to abych ti radęji podękoval.
 AI_Output (self, other, "DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_09"); //Za nic. Prostę koukej zůstat naživu.
...
func void DIA_1013_BANDIT_DEXTER_Info ()
{
 ...
 {
  AI_Output (other, self, "DIA_1013_BANDIT_DEXTER_15_06"); //NÉ - Teë jsem si vzpomnęl, že vlastnę nemám 10 zlatých, co bych mohl postrádat.
...
instance DIA_1013_BANDIT_FromCavalorn (C_INFO)
{
 ...
 permanent  =  FALSE;
 description  =  "Brzo tu bude hodnę dusno!";
};
...
{
 AI_Output (other, self, "DIA_ADDON_1013_BANDIT_FromCavalorn_15_00"); //Brzo tu bude hodnę dusno!
 AI_Output (self, other, "DIA_ADDON_1013_BANDIT_FromCavalorn_01_01"); //Co schází?
 AI_Output (other, self, "DIA_ADDON_1013_BANDIT_FromCavalorn_15_02"); //Nicménę chlap, co se jmenuje Cavalorn, jde za tebou!
 AI_Output (self, other, "DIA_ADDON_1013_BANDIT_FromCavalorn_01_03"); //Do prdele! Je na živu? Já mizím.
