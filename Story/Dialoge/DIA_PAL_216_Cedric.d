...
{
	AI_Output (other, self, "DIA_Cedric_CanTeach_15_00"); //Můžeš mę učit?
	
	if (other.guild == GIL_PAL)
	{
		AI_Output (self, other, "DIA_Cedric_CanTeach_12_01"); //Můžu tę trénovat v boji s jednoručními zbranęmi.
		Cedric_Teach1H = TRUE;
		B_LogEntry (TOPIC_CityTeacher,"Paladin Cedric mę naučí zacházet s jednoručními zbranęmi.");
	}
	else
	{
...
{	
	AI_Output (other,self ,"DIA_Cedric_Teach_15_00"); //Chci, abys mę učil.
	
	if (other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //O boji s mečem už víš úplnę všechno. Není nic, co bych tę ještę mohl naučit.
	}
	else
	{
