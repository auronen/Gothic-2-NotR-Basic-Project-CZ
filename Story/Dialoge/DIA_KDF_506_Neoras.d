...
FUNC VOID DIA_Neoras_Ingrediences_Info()
{
	...
	Info_AddChoice (DIA_Neoras_Ingrediences,"Lektvar rychlosti.",DIA_Neoras_Ingrediences_Speed);
	Info_AddChoice (DIA_Neoras_Ingrediences,"Extrakt many.",DIA_Neoras_Ingrediences_Mana);
	Info_AddChoice (DIA_Neoras_Ingrediences,"Extrakt hojivé síly.",DIA_Neoras_Ingrediences_Health);
};
...
instance DIA_Neoras_USEDDRAGONEGGDRINK		(C_INFO)
{
	...
	description	 = 	"Zkoušel jsem tu smęs z dračího vejce. Vážnę výborná vęc!";
};
