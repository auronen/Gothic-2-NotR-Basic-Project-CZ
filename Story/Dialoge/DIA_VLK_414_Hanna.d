...
{	
	...
	AI_Output (self, other, "DIA_Hanna_Add_17_18"); //Lord Andre dokonce naâídil, aby v šibeniční uličce nalévali jedno pivo zdarma.
};
...
{
	AI_Output (other,self ,"DIA_Hanna_AnyNews_Yes_15_00"); //Ano, jistę, samozâejmę.
...
{	
	...
	AI_Output (self, other, "DIA_Hanna_Add_17_44"); //Pokud už ji Lehmar nemá, je to dobrá vęc. Stejnę bych ji ale radši ukryl u sebe.
};
...
func void Hanna_Blubb()
{
	...
	//-------------------
	AI_Output (other, self, "DIA_Hanna_Add_15_25"); //Už jsem zjistil, kde se skrývají zlodęji?
	...
	AI_Output (self, other, "DIA_Hanna_Add_17_35"); //Tohle jsem koupil zvlášă pro tebe.
