...
FUNC VOID DIA_Pablo_Perm_Info()
{
	...
	if (Kapitel == 3)
	{
		if (MIS_RescueBennet != LOG_SUCCESS)
		{
			...
			|| (hero.guild == GIL_PAL)
			{
				...
				AI_Output (self, other, "DIA_Pablo_Perm_12_02"); //Je na čase, abychom tęm neâádům uštędâili lekci. Tohle nevymyslel Bennet sám o sobę.
			}
		...
		else //Bennet ist unschuldig
		{
			...
			AI_Output (self, other, "DIA_Pablo_Perm_12_07"); //Jestli jste nedokázali najít pravého vraha, skâeti nebudou muset ani hnout prstem.
		};
	}
	else if (Kapitel == 5)
	{
	...
	{
		AI_Output (self, other, "DIA_Pablo_Perm_12_11"); //Teë je docela klid. Problémy nám dęlají jen bandité za okrajem męsta.
	};	
