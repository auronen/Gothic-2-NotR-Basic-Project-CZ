...
func void DIA_BDT_1020_Wegelagerer_FirstWarn_Info()
{
 ...
 AI_Output (self, other,"DIA_BDT_1020_Wegelagerer_FirstWarn_06_02"); //Jestli nechceš, abych ti nęjakou natáhnul, męl bys nękolik mincí ze svojí kapsy pâesunout do tý mý. A pronto!
 ...
 self.aivar[AIV_Guardpassage_Status] = GP_FirstWarnGiven;
  ...
  Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"To si dęláš srandu?",DIA_BDT_1020_Wegelagerer_FirstWarn_Joke);
  Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Z cesty!",DIA_BDT_1020_Wegelagerer_PissOff);

 if (MIS_SCHNITZELJAGD == LOG_RUNNING)
 {
  Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Âekni, nevidęl jsi novice?",DIA_BDT_1020_Wegelagerer_AGON);
 };
};
FUNC VOID DIA_BDT_1020_Wegelagerer_AGON ()
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_AGON_15_00"); //Âekni, nevidęl jsi novice?
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_AGON_06_01"); //(zmatenę) Ehm - co? Hmm... (pâemýšlí) Jo, to by mohlo být.
 ...
 Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Promiŕ, nemám žádné peníze.",DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney);
...
FUNC VOID DIA_BDT_1020_Wegelagerer_FirstWarn_HowMuch ()
{
 ...
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_HowMuch_06_01"); //(smęje se) 20 zlatých a můžeme bejt kámoši.
...
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_FirstWarn_Joke_15_00"); //To si dęláš srandu?
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_Joke_06_01"); //Vypadám na to?
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_Joke_06_02"); //Pokud neuvidím 20 zlatých, stačí udęlat jedinej krok navíc a...
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_Joke_06_03"); //V tom pâípadę tę sejmu. Tak už ty prachy naval.
...
FUNC VOID DIA_BDT_1020_Wegelagerer_PissOff ()
{
 ...
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_PissOff_06_01"); //Ty máš ale velkou hubu na tak vychrtlýho zaprcatęlýho chlápka.
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_PissOff_06_02"); //Už je načase, abych ti ji zavâel.
...
FUNC VOID DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney ()
{
 ...
 {
  AI_Output (self,other ,"DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney_06_01"); //(jízlivę) Âíkal jsem si, že 20 zlatých není tak velká cena za tvůj život. Můžeš projít.
 };
 if (Wegelagerer_Surprise == TRUE)
 {
  ...
  AI_Output (self,other ,"DIA_BDT_1020_Wegelagerer_FirstWarn_GiveMoney_06_03"); //Męl docela naspęch. Celou dobu se ohlížel. A teë se zdejchni.
 };
...
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_15_00"); //Promiŕ, nemám žádné peníze.
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_06_01"); //Jo, jsou to teë zlý časy, co.

 if Npc_HasEquippedMeleeWeapon (other)
 {
  AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_06_02"); //Ale nęco ti povím - dej mi svou zbraŕ. Pak tę nechám projít.

  Info_ClearChoices (DIA_BDT_1020_Wegelagerer_FirstWarn);
  Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Zapomeŕ na to.",DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon);
  Info_AddChoice (DIA_BDT_1020_Wegelagerer_FirstWarn,"Tady, vezmi si mou zbraŕ.",DIA_BDT_1020_Wegelagerer_FirstWarn_GiveWeapon);
 }
 else
 {
  AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoMoney_06_03"); //Já ti âeknu co: vraă se, až budeš mít nęjaký peníze. Žádný prachy, žádnej most.
...
FUNC VOID DIA_BDT_1020_Wegelagerer_FirstWarn_Never ()
{
 ...
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_Never_06_01"); //Takže ty na to jdeš tvrdę?
...
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon_15_00"); //Zapomeŕ na to.
 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_NoWeapon_06_01"); //Dobrá, tak teda tvrdę.
...
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_FirstWarn_GiveWeapon_15_00"); //Tady, vezmi si mou zbraŕ.

 AI_DrawWeapon (other);

 AI_Output (self ,other,"DIA_BDT_1020_Wegelagerer_FirstWarn_GiveWeapon_06_01"); //Nech tu zbraŕ na pokoji. Jen počkej!
 AI_StopProcessInfos (self);
...
{
 AI_Output (self, other,"DIA_BDT_1020_Wegelagerer_SecondWarn_06_00"); //Vážnę chceš ještę dostat šanci? Je to tvoje právo.
 ...
 Info_AddChoice (DIA_BDT_1020_Wegelagerer_SecondWarn,"Nedám ti ani męëák.",DIA_BDT_1020_Wegelagerer_SecondWarn_NoMoney);
...
{
 AI_Output (other,self ,"DIA_BDT_1020_Wegelagerer_SecondWarn_NoMoney_15_00"); //Nedám ti ani męëák.
