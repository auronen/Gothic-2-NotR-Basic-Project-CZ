...
{
	AI_Output (self, other, "DIA_Tandor_Hallo_08_00"); //Prošel jsi pâes průsmyk? Dobrá práce. Už jsme tam ztratili víc než dost dobrých mužů.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_01"); //Sám dobâe vím, jak to tam vypadá - jeden čas jsem byl u průzkumné jednotky.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_02"); //Máš zbraŕ? Jestli potâebuješ dobrou zbraŕ, tak jsi tady správnę.
...
func void DIA_Tandor_Trupp_Info ()
{
	...
	AI_Output (self, other, "DIA_Tandor_Trupp_08_01"); //Prozkoumávali jsme oblast a chtęli se dostat na pobâeží. Utáboâili jsme se v jeskyni.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_02"); //Pozdę v noci pâišli skâeti. Šturmovali po svahu s pochodnęmi a bubny - a našli nás.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_03"); //Pokusili jsme se uprchnout, ale byl jsem jediný, komu se podaâilo odtamtud vyváznout.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_04"); //Krátce na to postavili skâeti svou palisádu, tak jsme se stáhli do hradu.
};	
///////////////////////////////////////////////////////////////////////
//	Info Trade
///////////////////////////////////////////////////////////////////////
...
instance DIA_Tandor_Equipment		(C_INFO)
{
	...
	description	 = 	"Posílá mę Garond - potâebuju vybavit.";
};
...
{
	AI_Output (other, self, "DIA_Tandor_Equipment_15_00"); //Posílá mę Garond - potâebuju vybavit.
	AI_Output (self, other, "DIA_Tandor_Equipment_08_01"); //Zbraŕ na blízko, nebo na dálku?
...
FUNC VOID DIA_Tandor_Equipment_Nah()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Nah_08_01"); //Bojuješ jednou rukou, nebo obęma?
	
	Info_ClearChoices (DIA_Tandor_Equipment);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Jednou rukou.",DIA_Tandor_Equipment_Ein);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Obęma rukama.",DIA_Tandor_Equipment_Zwei);
};
...
FUNC VOID DIA_Tandor_Equipment_Ein()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Ein_08_01"); //Tak si vezmi tohle. Je to dobrá zbraŕ.
	B_GiveInvItems (self,other, ItMw_Steinbrecher,1);
	Info_ClearChoices (DIA_Tandor_Equipment);
};
FUNC VOID DIA_Tandor_Equipment_Zwei()
{
	AI_Output (other, self, "DIA_Tandor_Equipment_Zwei_15_00"); //Obęma rukama.
	AI_Output (self, other, "DIA_Tandor_Equipment_Zwei_08_01"); //S tímhle obouručákem bys męl být spokojený.
...
FUNC VOID DIA_Tandor_Equipment_Bow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Bow_08_01"); //Tenhle lovecký luk je pro tebe jako dęlaný. Dám ti také nęjaké šípy.
...
FUNC VOID DIA_Tandor_Equipment_Crossbow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Crossbow_08_01"); //V tom pâípadę si vezmi tuhle lehkou kuši. Můžu ti dát také nęjaké šipky.
...
{
	AI_Output (other, self, "DIA_Tandor_News_15_00"); //Nęco nového?

	if (hero.guild == GIL_DJG)
		{
			AI_Output (self, other, "DIA_Tandor_News_08_01"); //V poslední dobę se stala jediná vęc - pâišli drakobijci.
		}
	else
		{
			AI_Output (self, other, "DIA_Tandor_News_08_02"); //Pâijeli drakobijci.
			AI_Output (self, other, "DIA_Tandor_News_08_03"); //Vypadají jako pęknę tvrdí parchanti - a to doufám jsou, protože jinak moc dlouho nevydrží.
		};
};
//#####################################################################
//##
...
instance DIA_Tandor_WASISTLOS		(C_INFO)
{
	...
	description	 = 	"Netváâíš se zrovna šăastnę.";
};
...
{
	AI_Output			(other, self, "DIA_Tandor_WASISTLOS_15_00"); //Netváâíš se zrovna šăastnę.

	if (MIS_OCGateOpen == TRUE)
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_01"); //Skâetů bude stále víc a víc. Dokud nebude po nás.
	}
	else
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_02"); //Už týden jsem poâádnę nejedl. Mám hlad jako vlk.
	};
};
