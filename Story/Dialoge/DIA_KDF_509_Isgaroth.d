...
{
	AI_Output	(self ,other,"DIA_Isgaroth_EXIT_01_00"); //Nechă nad tebou Innos bdí.
...
{
	AI_Output (self ,other,"DIA_Isgaroth_Hello_01_00"); //Innos tę doprovázej. Co pro tebe mohu udęlat, poutníče?
}; 
//****************************************************************************
//	Segen
//****************************************************************************
...
FUNC VOID DIA_Isgaroth_Segen_Info()
{
	...
	AI_Output (self ,other,"DIA_Isgaroth_Segen_01_01"); //Žehnám ti jménem Innosovým. Nechă ve tvém srdci plane oheŕ našeho Pána a nechă ti dá sílu âídit se jeho spravedlivostí.
...
{
	AI_Output (other,self ,"DIA_Isgaroth_Wolf_15_00"); //Posílá mę Sergio. Pâevzal jsem jeho úkol. Tak, o co jde?
	...
	B_LogEntry (Topic_IsgarothWolf,"Kolem svatynę se potuluje temný vlk. Męl bych ho najít a zabít.");
...
FUNC VOID DIA_Isgaroth_tot_Info()
{
	...
	AI_Output (self ,other,"DIA_Isgaroth_tot_01_01"); //Dobrá práce, novici. Jsi statečný muž. Teë se vraă do kláštera a vęnuj se svým povinnostem.
...
{
	AI_Output (other,self ,"DIA_Isgaroth_Job_15_00"); //Co tady dęláš?
	AI_Output (self ,other,"DIA_Isgaroth_Job_01_01"); //Jsem ohnivý mág. Knęz našeho boha Innose.
	AI_Output (self ,other,"DIA_Isgaroth_Job_01_02"); //Toto místo je zasvęcené JEMU, nejvyššímu bohu, stvoâiteli ohnę a pánovi spravedlnosti.
	AI_Output (self ,other,"DIA_Isgaroth_Job_01_03"); //Lidé sem pâicházejí, aby se modlili k Innosovi a obdrželi požehnání.
	AI_Output (self ,other,"DIA_Isgaroth_Job_01_04"); //Za nęjaký ten drobný ode mę také můžeš dostat mnohé užitečné vęci.
	
	Log_CreateTopic (Topic_KlosterTrader,LOG_NOTE);
	B_LogEntry (Topic_KlosterTrader,"Ve svatyni pâed klášterem sídlí mistr Isgaroth, který prodává užitečné magické pâedmęty.");
};
//****************************************************************************
//	Trade
//****************************************************************************
...
INSTANCE DIA_Isgaroth_Kloster   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Kam mę tahle cesta dovede?";
};
...
{
	AI_Output (other,self ,"DIA_Isgaroth_Kloster_15_00"); //Kam mę tahle cesta dovede?
	AI_Output (self ,other,"DIA_Isgaroth_Kloster_01_01"); //Tahle cesta vede do kláštera ohnivých mágů. Vstup do nęj je ovšem povolen jen služebníkům Innose.
	
	if (other.guild == GIL_NONE)
	{
		AI_Output (self ,other,"DIA_Isgaroth_Kloster_01_02"); //A jestli chceš být do kláštera pâijat jako novic, musíš s sebou pâivést ovci a...
		B_Say_Gold (self, other,Summe_Kloster);
		
		Log_CreateTopic (Topic_Kloster,LOG_MISSION);
		Log_SetTopicStatus (Topic_Kloster,LOG_RUNNING);
		B_LogEntry (Topic_Kloster,"Chci-li se stát novicem v Innosovę svatyni, potâebuji ovci a 1000 zlaăáků.");
	}
	else 
	{
		AI_Output (self ,other,"DIA_Isgaroth_Kloster_01_03"); //Protože ses ovšem již rozhodl spojit se s jinou skupinou, bude ti vstup odepâen.
	};
};
...
FUNC VOID DIA_Isgaroth_Vatras_Info()
{
	...
	if (Npc_HasItems (other,ItWr_VatrasMessage) == 1)
	{
		...
		AI_Output (self ,other,"DIA_Isgaroth_Vatras_01_03"); //Dobrá, můžeš Vatrasovi vyâídit, že jsem tu zprávu obdržel.
		AI_Output (self ,other,"DIA_Isgaroth_Vatras_01_04"); //Vezmi si tyhle lektvary jako odmęnu za své služby, určitę se ti budou hodit.
	...
	else if (Npc_HasItems (other,ItWr_VatrasMessage_open) == 1)
	{
		...
		AI_Output (self ,other,"DIA_Isgaroth_Vatras_01_05"); //Pečeă je rozlomená. Na cos myslel, ty blázne!
		AI_Output (self ,other,"DIA_Isgaroth_Vatras_01_06"); //Bęž a vyâië Vatrasovi, že jsem jeho zprávu obdržel.
		AI_StopProcessInfos (self);
	};	
	Vatras_Return = TRUE;
};
