...
func void DIA_Engor_HALLO_Info ()
{
 	...
 	AI_Output (self, other, "DIA_Engor_HALLO_13_00"); //Ah, ty jsi ten chlapík, který pâežil cestu průsmykem.
	AI_Output (other, self, "DIA_Engor_HALLO_15_01"); //Ano.
	AI_Output (self, other, "DIA_Engor_HALLO_13_02"); //Výbornę. Já jsem Engor - mám na starosti zásobování.
	AI_Output (self, other, "DIA_Engor_HALLO_13_03"); //Jen si nemysli, že ti dám nęco zadarmo!
...
func void DIA_Engor_ABOUTPARLAF_Info ()
{
	...
	AI_Output (self, other, "DIA_Engor_ABOUTPARLAF_13_01"); //To je pravda. Proč? Mám tę teë taky nakrmit?
	AI_Output (self, other, "DIA_Engor_ABOUTPARLAF_13_02"); //Pokud nęco chceš, zaplatíš za to - stejnę jako všichni ostatní.
};
///////////////////////////////////////////////////////////////////////
//	Info Ruestung
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (other, self, "DIA_Engor_Ruestung_15_00"); //Máš pro mę nęco zajímavého?
	AI_Output (self, other, "DIA_Engor_Ruestung_13_01"); //Můžu ti sehnat lepší brnęní - tęžké brnęní domobrany, pokud máš zájem.
	AI_Output (self, other, "DIA_Engor_Ruestung_13_02"); //Samozâejmę to není levné. Tak sežeŕ zlato a já ti dám brnęní.
};
///////////////////////////////////////////////////////////////////////
//	Info RSkaufen
///////////////////////////////////////////////////////////////////////
instance DIA_Engor_RSkaufen		(C_INFO)
{
	...
	permanent 	 =  TRUE;
	description	 = 	"Koupit si tęžkou zbroj domobrany (Obrana: zbranę 70, šípy 70 (2500 zlaăáků)."; 
};
//--------------------------------------
...
func void DIA_Engor_RSkaufen_Info ()
{
	...
	{
		AI_Output (other, self, "DIA_Engor_RSkaufen_15_00"); //Dej mi to brnęní.
		AI_Output (self, other, "DIA_Engor_RSkaufen_13_01"); //Tady ho máš, dobâe tę ochrání - je to zatracenę dobrá práce.
		B_GiveInvItems (self,other, ITAR_MIL_M,1);
		DIA_Engor_RSkaufen_perm = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Engor_RSkaufen_13_02"); //Nejdâíve sežeŕ zlato.
	};
};
...
func void DIA_Engor_HELP_Info ()
{
	...
	AI_Output (self, other, "DIA_Engor_HELP_13_01"); //Hmm .. Jistę, proč ne? Potâeboval bych pomoc.
	AI_Output (other, self, "DIA_Engor_HELP_15_02"); //Tak, co je tâeba udęlat?
	AI_Output (self, other, "DIA_Engor_HELP_13_03"); //Naše zásoby jídla jsou malé. Pâedevším jsme témęâ bez masa.
	AI_Output (self, other, "DIA_Engor_HELP_13_04"); //Tak pokud můžeš sehnat nęjaké maso, syrové nebo vaâené, šunku nebo klobásky, bylo by to kvitováno s velkým povdękem. Co tomu âíkáš, pomůžeš nám?

	
	Info_ClearChoices (DIA_Engor_HELP);
	Info_AddChoice (DIA_Engor_HELP,"Na to nemám čas.",DIA_Engor_HELP_NO);
	Info_AddChoice (DIA_Engor_HELP,"Nemęj strach, nęjaké maso seženu.",DIA_Engor_HELP_YES);
...
{
	AI_Output (other, self, "DIA_Engor_HELP_YES_15_00"); //Nemęj strach, nęjaké maso seženu.
	AI_Output (self, other, "DIA_Engor_HELP_YES_13_01"); //Asi dva tucty poâádných kusů masa by mi pomohlo nasytit nejménę sto hladových krků. Vraă se, až budeš mít maso. Teë se musím vrátit ke své práci.
	...
	B_LogEntry  (TOPIC_BringMeat,"Nevadí, půjde-li o klobásy, šunku, pečené či syrové maso. Jenom aby chlapi męli co zakousnout.");  
...
instance DIA_Engor_BRINGMEAT		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Tumáš, nęco jsem ti koupil (pâedat maso)..";
};
...
func void DIA_Engor_BRINGMEAT_Info ()
{
	...
	AI_Output (other, self, "DIA_Engor_BRINGMEAT_15_00"); //Tady, nęco jsem ti sehnal.
...
// ***** Schinken *****	
	...
	{	
		...
		AI_Output (self, other, "DIA_Engor_BRINGMEAT_13_01"); //Pro začátek to není špatné, ale potâebuji toho víc.
		
		GesamtFleisch = IntToString (Meat_Counter);
		GesamtFleisch = ConcatStrings ("(dát smęs různého masa)",GesamtFleisch);
		
		AI_PrintScreen (GesamtFleisch, -1, 48, FONT_ScreenSmall, 3);
	};
	if (Meat_counter >= Meat_Amount)
	{
		AI_Output (self, other, "DIA_Engor_BRINGMEAT_13_02"); //Výbornę, pâinesl jsi dostatek masa. Nęjakou dobu to vydrží.
		AI_Output (self, other, "DIA_Engor_BRINGMEAT_13_03"); //Ale nemysli si, že ti dám nęco zadarmo!
		/*
		...
		*/
		...
		Log_AddEntry (TOPIC_BringMeat,"Engor už dostal maso a postará se, aby si je ostatní mezi sebou spravedlivę rozdęlili."); 
	};
};
...
func void DIA_Engor_Business_Info ()
{
	AI_Output (other, self, "DIA_Engor_Business_15_00"); //Jak jdou obchody?
		...
		{
			AI_Output (self, other, "DIA_Engor_Business_13_02"); //Všiváci! Paladinové právę teë nic nekupují.
		};

	AI_Output (self, other, "DIA_Engor_Business_13_03"); //Co ty, vybral sis nęco?
};
