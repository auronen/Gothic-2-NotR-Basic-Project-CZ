...
FUNC VOID DIA_Lee_PMSchulden_Info()
{
	...
	if (B_GetTotalPetzCounter(self) > Lee_LastPetzCounter)
	{
		...
		{
			AI_Output (self, other, "DIA_Lee_PMSchulden_04_03"); //Bude tedy po tobę chtít také víc penęz.
			AI_Output (other, self, "DIA_Lee_PMAdd_15_00"); //Kolik že to bylo?
...
FUNC VOID DIA_Lee_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Lee_PETZMASTER_04_00"); //Kýho čerta - (pâekvapenę) - to jsi TY ten nováček, který jde z jednoho maléru do druhého?
	...
	if (B_GetGreatestPetzCrime(self) == CRIME_MURDER) 
	{
		...
		AI_Output (self, other, "DIA_Lee_PETZMASTER_04_05"); //Můžu ti pomoci dostat se z téhle šlamastyky s čistým štítem.
...
INSTANCE DIA_Lee_Paladine   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Potâebuju si nutnę promluvit s paladiny z męsta.";
};
...
func void DIA_Addon_Lee_Ranger_Info ()
{
	...
	AI_Output	(other, self, "DIA_Addon_Lee_Ranger_15_02"); //Ale no tak, âekni mi o tom.
	AI_Output	(self, other, "DIA_Addon_Lee_Ranger_04_03"); //Nejsem do toho pâímo zapletený. Vím jen, že existuje tahle tajná frakce, za kterou jsou vodní mágové.
	AI_Output	(self, other, "DIA_Addon_Lee_Ranger_04_04"); //Od pádu bariéry, už nejsem vázaný dohodou, kterou jsem uzavâel s mágy Vody.
	AI_Output	(self, other, "DIA_Addon_Lee_Ranger_04_05"); //Samozrejmę, že se ti pokusím pomoct, když budeš nęco potâebovat. Avšak, mám málo času poslední dobou a své problémy, které mę zaneprázdŕují.
	AI_Output	(self, other, "DIA_Addon_Lee_Ranger_04_06"); //Mohl by sis promluvit s Cordem pokud o tom chceš získat nęjaké informace. Pokud vím, tak je jedním z nich.
...
FUNC VOID DIA_Lee_JoinNOW_Info()
{
	...
	{		
		...
		else //Onar ist einverstanden
		{
			...
			AI_Output (self, other, "DIA_Lee_JoinNOW_04_17"); //Má to co do činęní s paladiny. Je na čase, aby ses za nimi vypravil.
...
INSTANCE DIA_Lee_AngebotSuccess (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Donesl jsem lordu Hagenovi tvoji nabídku pâímęâí.";
};
...
FUNC VOID DIA_Lee_AngebotSuccess_Info()
{
	...
	AI_Output (other, self, "DIA_Lee_AngebotSuccess_15_02"); //Âekl, že tobę může zajistit prominutí tvých činů, ale ne tvým lidem.
	...
	AI_Output (self, other, "DIA_Lee_AngebotSuccess_04_06"); //Že bych sám vytáhl krk z oprátky a opustil své muže, to vůbec nepâipadá v úvahu.
...
{	
	...
	{
		AI_Output (self ,other,"DIA_Lee_ArmorM_04_03"); //Torlof dostal od Onara úkol, o který se męl již pâed časem postarat.
		AI_Output (self ,other,"DIA_Lee_ArmorM_04_04"); //Takže to nejdâív zaâië - pak si můžeme promluvil o lepším brnęní!
	};
};
...
instance DIA_Lee_BuyArmorM (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Koupit si stâednę tęžkou žoldnéâskou zbroj. Ochrana: zbranę 50, šípy 50, cena 1000 zlaăáků.";
};                       
...
instance DIA_Lee_BuyArmorH (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Koupit tęžkou žoldnéâskou zbroj. Ochrana: zbranę 80, šípy 80, cena: 2500 zlaăáků.";
};                       
...
{	
	...
	B_LogEntry (TOPIC_RichterLakai,"Lee chce, abych našel nęjaký inkriminující důkaz proti khorinisskému soudci. Mám mu proto nabídnout své služby a pâitom mít oči na stopkách."); 
...
{	
	...
	AI_Output (other,self ,"DIA_Lee_RichterBeweise_15_02"); //Najal si pár ranaâů, aby pâepadli místodržícího Khorinisu.
...
{	
	...
	AI_Output (self ,other,"DIA_Lee_TalkAboutBennet_04_01"); //Takže jsi už o tom slyšel. Ti bastardi ho zavâeli, jen tak pro nic za nic.
	if ((hero.guild != GIL_MIL)&&(hero.guild != GIL_PAL))
	{
...
{	
	...
	AI_Output (self ,other,"DIA_Lee_DoAboutBennet_04_01"); //Ještę nevím. Pár chlapců by rádo vtrhlo do męsta povyráželi lordu Hagenovi všechny zuby, jeden po druhém.
	...
	B_LogEntry (TOPIC_RESCUEBENNET,"Když dostatečnę rychle neprokážu Bennetovu nevinu, Lee za další následky už neponese zodpovędnost. Jeho lidé bez váhání kdykoliv napadnou męsto a Benneta se zbaví násilím."); 
	...
	&& ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
	{ 
		AI_Output (self ,other,"DIA_Lee_DoAboutBennet_04_07"); //Ano, a abych nezapomnęl... Buster s tebou chce mluvit. Nechtęl mi âíct, o co jde. Možná by ses męl za ním stavit!
	};
};
...
{	
	...
	AI_Output (self ,other,"DIA_Lee_CanHelpYou_04_01"); //Jasnę, troška inteligence a rozvahy nemůže být na škodu.
...
FUNC VOID DIA_Lee_CanTeach_Yes ()
{
	...
	AI_Output (self ,other,"DIA_Lee_CanTeach_Yes_04_01"); //Dobrá. Můžeš si být jist, že za to stojím.
...
instance DIA_Lee_DRACHENEI		(C_INFO)
{
	...
	description	 = 	"Ještęrani roznášejí dračí vejce po celé zemi.";
};
...
{
	AI_Output			(other, self, "DIA_Lee_DRACHENEI_15_00"); //Ještęrani roznášejí dračí vejce po celé zemi.
	B_GivePlayerXP (XP_Ambient);
	AI_Output			(self, other, "DIA_Lee_DRACHENEI_04_01"); //Męlo mę to napadnout. Je na čase vypadnout.
	...
	if (hero.guild == GIL_DJG)
	{
		...
		AI_Output			(self, other, "DIA_Lee_DRACHENEI_04_04"); //Ze skoâápek by možná šlo dęlat brnęní nebo tak nęco.
...
{	
	...
	AI_Output (self ,other,"DIA_Lee_KAP4_Perm_04_01"); //No, co odešel Sylvio, tady byl konečnę docela klid.
	AI_Output (other,self ,"DIA_Lee_KAP4_Perm_15_02"); //To nezní špatnę.
	AI_Output (self ,other,"DIA_Lee_KAP4_Perm_04_03"); //Práce bohužel neubylo. Muži jsou čím dál tím nespokojenęjší, protože musejí pracovat i za Sylviovy muže.
...
func void DIA_Lee_GetShip_Info ()
{
	...
	Log_SetTopicStatus(TOPIC_Ship, LOG_RUNNING);                                                                                                                                                                                                                                                 
		...
		&& ((Npc_IsDead(Richter))== FALSE)
		{
			AI_Output	(self, other, "DIA_Lee_GetShip_04_04"); //Konec konců máme soudce ve své moci. Zkus za ním jít a vymáčknout z nęj dopis, který by tę k tomu opravŕoval.
		...
		{
			AI_Output	(self, other, "DIA_Lee_GetShip_04_05"); //Mám tady falešné oprávnęní. S jeho pomocí tę nechají stráže projít.
...
func void DIA_Lee_GetShip_crew ()
{
	...
	B_LogEntry (TOPIC_Crew,"Ve vęci posádky pro mę toho Lee moc udęlat nemohl. Ale poradil mi, že bych męl najmout jen lidi, kterým mohu vęâit. Mám se zeptat ještę Benneta, mohlo by ho to zajímat.");
};
...
instance DIA_Lee_GotRichtersPermissionForShip		(C_INFO)
{
	...
	description	 = 	"To povolení zafungovalo. Loë je teë moje...";
};
