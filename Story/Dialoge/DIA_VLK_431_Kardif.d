...
func void DIA_Kardif_Hallo_Info ()
{
	...
	Log_CreateTopic (Topic_CityTrader,LOG_NOTE);
	B_LogEntry (Topic_CityTrader,"Kardif, hospodský v pâístavní krčmę, prodává informace.");
...
FUNC VOID DIA_Kardif_Hallo_Angebot()
{
	...
	Info_AddChoice 	  (DIA_Kardif_Hallo,"Fajn, 7 zlaăáků zní rozumnę.",DIA_Kardif_Hallo_Sieben);
};
...
instance DIA_Kardif_TradeInfo		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Potâebuji informace.";
};
...
instance DIA_Addon_Kardif_MissingPeople		(C_INFO)
{
	...
	permanent    =  TRUE;
	description	 = 	"Víš nęco o hledaných męšăanech?";
};
//-------------------------------------------
...
func void DIA_Addon_Kardif_MissingPeople_Info ()
{
	if B_GiveInvItems (other,self,ItMi_Gold, Kardif_Deal)
	{
		AI_Output (other, self, "DIA_Addon_Kardif_MissingPeople_15_00"); //Víš nęco o hledaných męšăanech?
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_01"); //Vím nęco o tęch, co zmizeli nedávno.
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_02"); //Byli to lidé tady odtud z pâístavu. Męl by ses tu projí a poptat se jich.
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_03"); //Nękteâí pâedpokládali nęjaké pâípady v nižších čtvrtích męsta.
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_04"); //Víc by ti poradil asi Coragon.
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_05"); //Má krčmu v nižší čtvti męsta, bude-li mít čas, určitę ti nęco zajímanýho poví.
		AI_Output (self, other, "DIA_Addon_Kardif_MissingPeople_14_06"); //Ještę je tu taky rybáâ Halvor, ten by také mohl nęco vędęt a âek bych, že se s tebou o to rád podęlí.
		
	 	Log_CreateTopic (TOPIC_Addon_WhoStolePeople, LOG_MISSION);
		Log_SetTopicStatus(TOPIC_Addon_WhoStolePeople, LOG_RUNNING);
		B_LogEntry (TOPIC_Addon_WhoStolePeople,"Kardif si myslí, že krčmáâ Coragon nebo pâístavní rybáâ Halvor by mohli o hledaných lidech vędęt víc."); 
...
func void DIA_Kardif_Paket_Info ()
{
	if B_GiveInvItems (other,self,ItMi_Gold, Kardif_Deal)
	{
		...
		AI_Output (self, other, "DIA_Kardif_Paket_14_01"); //Ten, kdo takový balík vlastní, je boháč. A nejspíš taky tęžký pohodáâ!
...
FUNC VOID DIA_Kardif_Zeichen_Info()
{
	...
	AI_Output (self, other, "DIA_Kardif_Zeichen_14_01");//(tiše) Když budeš potâebovat nęjaké šperháky, pâijë za mnou, pár jich tu ještę mám. A stačí, když si âekneš o nęco k pití.
...
FUNC VOID DIA_Kardif_Crew_Info()
{
	...
	AI_Output (self, other, "DIA_Kardif_Crew_14_01");//Časy jsou zlé, pâíteli. V celém Khorinisu asi dost námoâníků neseženeš - vętšina z nich z męsta odešla.
