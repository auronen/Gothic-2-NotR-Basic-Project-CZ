...
func void DIA_Ulthar_GREET_Info ()
{
	...
	AI_Output (self, other, "DIA_Ulthar_GREET_05_06"); //Chápu, že jsi rozčílený, ale než se rozhodneme nęco podniknout, musíme vše důkladnę zvážit.
...
func void DIA_Ulthar_SCHREINEVERGIFTET_Info ()
{
	if ((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL))
		{
			AI_Output			(self, other, "DIA_Ulthar_SCHREINEVERGIFTET_05_00"); //Ještę jedna vęc. Nepâítel znesvętil nękteré ze svatyŕ podél cest, které byly zasvęcené Innosovi. Pâišly o své magické požehnání.
			...
			AI_Output			(self, other, "DIA_Ulthar_SCHREINEVERGIFTET_05_04"); //S pomocí svatých slov očišăování získá svatynę opęt svou starou moc.
