...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Zůstaneš ve męstę?
	AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_01"); //Jeden z nás tu musí zůstat, pokud Vatras odejde z męsta.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_02"); //Ještę jedna vęc, co ti chci âíct.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_03"); //Byl to pravý hrdinský čin, který jsi učinil v Jharkendaru.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_04"); //Bohužel jsem ještę nesplnil svůj úkol v Khorinisu.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_05"); //Jsem si jistý, že to zvládneš.
