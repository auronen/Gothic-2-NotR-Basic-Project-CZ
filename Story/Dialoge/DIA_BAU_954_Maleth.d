...
func void DIA_Maleth_BanditsALIVE_Info ()
{
 ...
 AI_Output (self, other, "DIA_Maleth_BanditsALIVE_08_03"); //Ale jestli si myslíš, že náš té lůzy můžeš zbavit, bude ti celá farma vdęčná.
...
func void DIA_Maleth_ToTheCity_Info ()
{
 ...
 AI_Output (self, other, "DIA_Maleth_ToTheCity_08_05"); //Fajn, napâíklad, že jsi z Lobartovy farmy a potâebuješ jít za męstským kováâem.
...
func void DIA_Maleth_PROBLEME_schafe_probleme_geldher_auftrag ()
{
 ...
 AI_Output   (other, self, "DIA_Maleth_PROBLEME_schafe_probleme_geldher_auftrag_15_03"); //A to je to, kvůli čemu dęláš takovej kravál?
...
func void DIA_Maleth_PROBLEME_schafe_probleme_drohen ()
{
 ...
 AI_Output   (self, other, "DIA_Maleth_PROBLEME_schafe_probleme_drohen_08_01"); //Jediný, co dovedeš, jsou âeči. Nejlíp udęláš, když půjdeš pryč.
};
