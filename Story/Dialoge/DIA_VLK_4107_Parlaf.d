...
func void DIA_Parlaf_HALLO_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_HALLO_03_01"); //Jak si myslíš že se mám? Celé dny trávím u brousku a brousím meče.
	if ((Npc_IsDead(Engor))== FALSE)
	{
		AI_Output (self, other, "DIA_Parlaf_HALLO_03_02"); //A včera nám Engor ještę k tomu zase zmenšil pâídęl jídla. Když to takhle půjde dál, za chvíli pomâeme hlady.
		AI_Output (self, other, "DIA_Parlaf_HALLO_03_03"); //Nebo nás zabijou skâeti. Žádné pâíjemné vyhlídky se nekonají.
	};
};
///////////////////////////////////////////////////////////////////////
//	Info ENGOR
...
func void DIA_Parlaf_ENGOR_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_01"); //Engor se stará o zásobování a rozdęluje potraviny - pâídęly jsou ale každý týden menší a menší.
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_02"); //No jasnę, můžeš s ním smlouvat, ale potâebuješ k tomu tvrdou zlatou męnu.
	AI_Output (other, self, "DIA_Parlaf_ENGOR_15_03"); //A ty to nemůžeš zatáhnout?
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_04"); //Za svůj mizerný žold si můžu koupit leda tak pár pitomých tuâínů!
...
func void DIA_Parlaf_Wo_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_Wo_03_01"); //V rytíâském sídle. Stačí projít otevâeným průchodem u kovárny.
};
///////////////////////////////////////////////////////////////////////
//	Info HUNGRIG
///////////////////////////////////////////////////////////////////////
...
func void DIA_Parlaf_HUNGRIG_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_HUNGRIG_03_01"); //Ten zatracený Engor by męl vydávat víc jídla!
};
///////////////////////////////////////////////////////////////////////
//	Info SATT
///////////////////////////////////////////////////////////////////////
...
func void DIA_Parlaf_SATT_Info ()
{
	...
	&& ((Npc_IsDead(Engor))== FALSE)
	{
		AI_Output (self, other, "DIA_Parlaf_SATT_03_01"); //Engor vydal nové pâídęly masa. Už bylo načase.
		DIA_Parlaf_SATT_OneTime = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Parlaf_SATT_03_02"); //Tvůj pâíjezd je jedinou novinkou, která je opravdu nová.
	};
};
