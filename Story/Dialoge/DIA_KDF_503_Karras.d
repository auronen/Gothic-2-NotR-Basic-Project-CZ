...
func void DIA_Karras_Aufgabe_Info ()
{
	...
	AI_Output (self, other, "DIA_Karras_Aufgabe_10_01"); //Ano. Týká se to toho bláznivého Ignaze. Žije v Khorinisu a experimentuje s různými lektvary a léčivými odvary. Ale také s kouzly a magií.
...
func void DIA_Karras_Success_Info ()
{
	...
	AI_Output (self, other, "DIA_Karras_Success_10_02"); //Ale teë je na čase, aby ses vęnoval svým studiím.
...
FUNC VOID DIA_Karras_KAP3_Perm_Info()
{
	...
	&& (hero.guild == GIL_KDF)
	{
		...
		AI_Output (self ,other,"DIA_Karras_KAP3_Perm_10_07"); //Ale kdyby se ti podaâilo získat z nich nęco, co bych mohl podrobit zkoumání...
	...
	else if MIS_KarrasResearchDMT == LOG_RUNNING 
	{
		...
		AI_Output (self ,other,"DIA_Karras_KAP3_Perm_10_09"); //Samozâejmę, že jakmile nęco zjistím, dám ti okamžitę vędęt.
	}
	else 
	{
		AI_Output (self ,other,"DIA_Karras_KAP3_Perm_10_10"); //Nepâítel má mnoho tváâí. Je strašnę obtížné určit, která z nich pâedstavuje pro klášter nejvętší nebezpečí.
	};
};
...
FUNC VOID DIA_Karras_KAP3_Perm_Material()
{
	...
	Info_AddChoice (DIA_Karras_KAP3_Perm,"Takže chceš, abych ti pâinesl mrtvolu?",DIA_Karras_KAP3_Perm_Corpse);
};

FUNC VOID DIA_Karras_KAP3_Perm_WillSee()
{
	AI_Output (other,self ,"DIA_Karras_KAP3_Perm_WillSee_15_00"); //Pokusím se.
	AI_Output (self ,other,"DIA_Karras_KAP3_Perm_WillSee_10_01"); //To by bylo opravdu výborné. Mezitím se budu vęnovat mému vlastnímu výzkumu.
	Info_ClearChoices (DIA_Karras_KAP3_Perm);
};
...
INSTANCE DIA_Karras_HaveBook   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Mám u sebe Almanach posedlých. Možná by se ti mohl k nęčemu hodit.";
};
...
FUNC VOID DIA_Karras_ResearchDMTEnd_Info()
{
	...
	{
		AI_Output (self ,other,"DIA_Karras_ResearchDMTEnd_10_01"); //Ano. Už vím, kdo nebo co Pátrači skutečnę jsou zač.
...
FUNC VOID DIA_Karras_KarrasBlessedStone_Info()
{
	...
	B_LogEntry (TOPIC_DEMENTOREN,"Karras mi dal amulet, který mę ochrání pâed mentálními útoky Pátračů. Teë už bude všechno mnohem jednodušší."); 
