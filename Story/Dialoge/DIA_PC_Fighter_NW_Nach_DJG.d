...
func void DIA_GornNW_nach_DJG_KnowWhereEnemy_Info ()
{
	...
	B_LogEntry (TOPIC_Crew,"Když jsem Gornovi vyprávęl o ostrovę, byl jednoznačnę pro. Budu-li potâebovat sekeru, mohu ho smęle vzít s sebou.");
	...
	if (crewmember_count >= Max_Crew)
	{
		...
		AI_Output			(self, other, "DIA_GornNW_nach_DJG_KnowWhereEnemy_12_06"); //V tęchto tęžkých časech je každá ruka dobrá.
	}
	else 
	{
		...
		Info_AddChoice (DIA_GornNW_nach_DJG_KnowWhereEnemy,"Popluj se mnou. Počkej na mę v pâístavu.",DIA_GornNW_nach_DJG_KnowWhereEnemy_Yes);
	};
};
...
{
	AI_Output (other,self ,"DIA_GornNW_nach_DJG_KnowWhereEnemy_No_15_00"); //Dám ti vędęt, až bude na čase.
...
func void DIA_GornNW_nach_DJG_LeaveMyShip_Info ()
{
	...
	AI_Output			(self, other, "DIA_GornNW_nach_DJG_LeaveMyShip_12_01"); //To tę mám nechat jít samotného? Hmm. Není to pro mę jednoduché, ale je to konec konců tvoje válka. Pokud bys nakonec pâece jenom chtęl, abych šel s tebou, klidnę za mnou pâijë.
...
func void DIA_GornNW_nach_DJG_StillNeedYou_Info ()
{
	...
	AI_Output	(self, other, "DIA_GornNW_nach_DJG_StillNeedYou_12_01"); //No tak vidíš. A já už si myslel, že mę tu necháš shnít, zatímco si budeš sám užívat. Uvidíme se pozdęji.
