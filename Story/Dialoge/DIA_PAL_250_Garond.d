...
func void DIA_Garond_PETZMASTER_PayLater()
{
	...
	AI_Output (self, other, "DIA_Garond_PETZMASTER_PayLater_10_02"); //A varuju tę: jestli se zapleteš ještę do nęčeho, tak se ta částka ještę zvýší!
...
{	
		...
		{
			AI_Output (self ,other,"DIA_Garond_Hello_10_05"); //Vrtá mi hlavou, proč by chtęl žoldák nęco takového. Co tady dęláš?
		};
};
...
INSTANCE DIA_Garond_NeedProof (C_INFO)
{
	...
	description = "Pâicházím od lorda Hagena. Chce, abych mu donesl důkaz o pâítomnosti draků.";
};                       
...
{		
	...
	B_LogEntry (TOPIC_ScoutMine,"Velitel Garond mę povęâil dalším posláním. Už pâed časem vyslal tâi oddíly kopáčů, kteâí męli pátrat po magické rudę, ale nikdo z nich s dosud nevrátil.");
...
{		
	...
	AI_Output (self ,other,"B_Garond_OreCounter3_10_01"); //Moji muži jsou témęâ mrtví a s tou trochou rudy, co máme, bychom nezastavili JEDINÉHO SKÂETA, NATOŽ CELOU ARMÁDU!
...
INSTANCE DIA_Garond_Pay (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Chtęl bych vykoupit Gorna.";
};                       
...
func void DIA_Garond_DragonPlettBericht_Info ()
{
	...
	if (Garond_DragonCounter < MIS_KilledDragons)
	{
		...
		{
			AI_Output (other, self, "DIA_Garond_DragonPlettBericht_15_05"); //Vydal jsem se do zmrzlé oblasti na západę a zlikvidoval tamního draka.
