...
{
	AI_Output (other, self, "DIA_Ruga_Hallo_15_00"); //Co tady dęláš?
	AI_Output (self, other, "DIA_Ruga_Hallo_11_01"); //Cvičím chlapce v zacházení s kuší a pomáhám jim být trochu obratnęjší.
	
	Log_CreateTopic (Topic_CityTeacher, LOG_NOTE);
	B_LogEntry (Topic_CityTeacher, "Ruga, pâíslušník męstské gardy, mi vylepší obratnost a naučí mę používat kuši. Musím ale nejdâíve vstoupit do královských služeb.");
};
///////////////////////////////////////////////////////////////////////
//	Info Train
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (other, self, "DIA_Ruga_Train_15_00"); //Mohl bys mę cvičit?
	
	if (hero.guild == GIL_MIL)
	|| (hero.guild == GIL_PAL)
	|| (hero.guild == GIL_KDF)
	{
		AI_Output (self, other, "DIA_Ruga_Train_11_01"); //Jasná páka. Jestli jsi dostatečnę zkušený, pomohu ti.
		AI_Output (self, other, "DIA_Ruga_Train_11_02"); //A pamatuj, obratnost a boj na dálku k sobę patâí jako šipka a kuše. Jedno...
	...
	|| 		 (hero.guild == GIL_DJG))
	{
		AI_Output (self, other, "DIA_Ruga_Train_11_04"); //Táhni mi z očí, (opovržlivę) žoldáku.
		AI_StopProcessInfos (self);
	}
	else 
	{	 
		AI_Output (self, other, "DIA_Ruga_Train_11_05"); //Ne, mohu cvičit jen muže v královských službách. Nikoho jiného.
		AI_Output (self, other, "DIA_Ruga_Train_11_06"); //Ale vždycky se nám hodí dobâí chlapi. Takže pokud by ses chtęl pâidat k domobranę, bęž si promluvit s lordem Andrem.
	};     
};
//**************************************
//			Ich will trainieren
...
FUNC VOID DIA_Ruga_Teach_Back ()
{
	...
	{
		AI_Output(self,other,"DIA_Ruga_Teach_11_00"); //Už není nic, co bych tę mohl naučit. Je na čase, aby sis našel nového učitele.
...
{
	AI_Output (other, self, "DIA_Ruga_TEACHDEX_15_00"); //Chtęl bych být o nęco obratnęjší.
...
func void DIA_Ruga_TEACHDEX_BACK()
{
	...
	{
		AI_Output (self, other, "DIA_Ruga_TEACHDEX_11_00"); //To je vše, co tę můžu naučit. Jestli chceš být ještę obratnęjší, najdi si jiného učitele.
