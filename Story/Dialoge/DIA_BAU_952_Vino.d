...
func void DIA_Vino_SeekWork_Info ()
{
 ...
 if (hero.guild == GIL_NONE)
 {
  ...
  {
   AI_Output (self, other, "DIA_Vino_SeekWork_05_04"); //okud chceš pro Lobarta pracovat jako nádeník, musím tę varovat. Lidem jako ty platí fakt mizernę!
 ...
 {
  AI_Output (self, other, "DIA_Vino_SeekWork_05_09"); //Neâekl bych. Nękdo tvého postavení nemůže mít zájem o takový druh práce, co nabízím.
 };
};
...
func void DIA_Vino_PERM45UND6_Info ()
{
 ...
 {
 AI_Output   (self, other, "DIA_Vino_PERM45UND6_05_01"); //Počet skâetů se v okolí nepâíjemnę zvýšil.
