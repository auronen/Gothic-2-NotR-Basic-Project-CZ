...
FUNC VOID DIA_Kjorn_SellInfos_Info()
{
	...
	AI_Output 	(self ,other,"DIA_Kjorn_SellInfos_06_03"); //Hmm... tęžko âíct. Ale myslím, že 50 zlatých za každou poskytnutou informaci vypadá celkem slušnę.
};
...
FUNC VOID DIA_Kjorn_BuyInfos_Dragon1 ()
{
	...
	AI_Output (self ,other,"DIA_Kjorn_BuyInfos_Dragon1_06_01"); //Draci jsou starobylá, neuvęâitelnę mocná stvoâení. Kdysi jich žily tisíce po celém svętę.
	AI_Output (self ,other,"DIA_Kjorn_BuyInfos_Dragon1_06_02"); //Ale už je pâes sto let, co nękterého z nich nękdo vidęl.
...
FUNC VOID DIA_Kjorn_BuyInfos_Colony1 ()
{
	...
	AI_Output (self ,other,"DIA_Kjorn_BuyInfos_Colony1_06_01"); //Hornické údolí v Khorinisu je díky magické rudę známé po celé zemi.
...
FUNC VOID DIA_Kjorn_BuyInfos_OldCamp1 ()
{
	...
	AI_Output (self ,other,"DIA_Kjorn_BuyInfos_OldCamp1_06_02"); //Dâív, když to údolí ještę sloužilo jako vęzení, męli veškerou rudu odtamtud pod palcem rudní baroni.
...
FUNC VOID DIA_Kjorn_BuyInfos_Orks1 ()
{
	...
	AI_Output (self ,other,"DIA_Kjorn_BuyInfos_Orks1_06_01"); //Ti skâeti tu nejsou moc dlouho. Alespoŕ ti, co jsou teë pâed hradem.
