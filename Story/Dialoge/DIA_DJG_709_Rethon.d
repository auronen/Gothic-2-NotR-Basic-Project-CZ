...
instance DIA_Rethon_PALADINE		(C_INFO)
{
	...
	description	 = 	"Copak o tobę paladinové nevędí?";
};
...
func void DIA_Rethon_PALADINE_Info ()
{
	...
	AI_Output			(self, other, "DIA_Rethon_PALADINE_12_03"); //Jen se podívej, jak si snaží dát dohromady ty nalámaný meče, se kterými se chtęjí vydat do boje.
...
func void DIA_Rethon_WOGRUPPE_Info ()
{
	...
	AI_Output			(self, other, "DIA_Rethon_WOGRUPPE_12_02"); //Když bych pâišel domů s prázdnýma rukama, tak teda nevím, proč bych to vlastnę dęlal. Takže nemůžu potâebovat nikoho dalšího.
};
...
func void DIA_Rethon_ANGST_sylviomoegen ()
{
	...
	AI_Output			(self, other, "DIA_Rethon_ANGST_sylviomoegen_12_02"); //Sylvio nemá žádné pâátele. Potâebuje lidi, co za ním půjdou, a je úplnę jedno, co za lidi to bude.
