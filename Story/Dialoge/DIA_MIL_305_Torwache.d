...
func void DIA_Mil_305_Torwache_FirstWarn_Info()
{
	...
	if (B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
	{
		...
		AI_Output (self, other,"DIA_Mil_305_Torwache_FirstWarn_03_04"); //Bęž za lordem Andrem a urovnej celou tu záležitost!
	}
...
INSTANCE DIA_Mil_305_Torwache_PassAsCitizen (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Jsem uznávaný občan Khorinisu! Nechte mę projít!";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_305_Torwache_PassAsCitizen_15_00"); //Jsem uznávaný občan Khorinisu! Nechte mę projít!

	if (Player_IsApprentice > APP_NONE)
	{
		AI_Output (self, other,"DIA_Mil_305_Torwache_PassAsCitizen_03_01"); //Aă už khorinisské mistry pâimęlo ke tvému zapsání mezi učedníky cokoliv - nechci to vędęt.
