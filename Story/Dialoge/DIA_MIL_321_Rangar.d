...
{
	AI_Output	(other, self, "DIA_Addon_Rangar_Erwischt_15_00"); //Co tady dęláš?
	AI_Output	(self, other, "DIA_Addon_Rangar_Erwischt_07_01"); //(cítí se pâistižen) Eeehm. Já...eh..to tę nemusí zajímat. Ztraă se.
	AI_Output	(other, self, "DIA_Addon_Rangar_Erwischt_15_02"); //Martin bude rád, až mu povím, kdo se šăoural v jeho vęcech mezi tím, co byl pryč.
	AI_Output	(self, other, "DIA_Addon_Rangar_Erwischt_07_03"); //(výsmęšnę) Udęlej, co chceš. Půjdu ještę jednou, chlapče.
...
instance DIA_Addon_Rangar_nachhaken		(C_INFO)
{
	...
	description	 = 	"Asi si myslíš, že tę nechám uniknout trestu?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Rangar_nachhaken_15_00"); //Asi si myslíš, že tę nechám uniknout trestu?
	AI_Output	(self, other, "DIA_Addon_Rangar_nachhaken_07_01"); //(lhostejnę) Nedęlej tak velké důsledky kvůli trošce zásob a potravin.
};
