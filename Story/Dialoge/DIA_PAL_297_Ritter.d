...
instance DIA_Addon_PAL_297_Rangerbandits		(C_INFO)
{
	...
	description	 = 	"Prošli tudy v poslední dobę nęjací banditi?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_PAL_297_Rangerbandits_15_00"); //Prošli tudy v poslední dobę nęjací banditi?
	AI_Output	(self, other, "DIA_Addon_PAL_297_Rangerbandits_04_01"); //Nevím o čem to mluvíš. Za tu dobu, co jsme tu na stráži tudy nikdo neprošel. A už vůbec ne nikdo z tęch všivých banditů.
	AI_Output	(self, other, "DIA_Addon_PAL_297_Rangerbandits_04_02"); //Farmáâi na otázky moc odpovídat nechtęjí. Možná nęco zahlédli.
};
