...
{
 AI_Output   (self, other, "DIA_NAME_BANDIT_SCHAFBLEIBTHIER_09_00"); //Hej, ty vandráku. Jak jsi pâišel k tý ovci?

 if (MIS_Akil_SchafDiebe == 0)
 {
  AI_Output   (other, self, "DIA_NAME_BANDIT_SCHAFBLEIBTHIER_15_01"); //Ovce? Jaká ovce?
  AI_Output   (self, other, "DIA_NAME_BANDIT_SCHAFBLEIBTHIER_09_02"); //Hodnej kluk. A teë zmizni. Nemáš tu co pohledávat.
 };
};
...
func void DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_Info ()
{
 ...
 AI_Output   (self, other, "DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_09_01"); //A co? Co s tím jako budeš dęlat?

 Info_ClearChoices (DIA_NAME_BANDIT_RUECKDASSCHAFRAUS);
 Info_AddChoice (DIA_NAME_BANDIT_RUECKDASSCHAFRAUS, "Nic. Co je pro mę nęjaká hloupá ovce?", DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_nichts );
 Info_AddChoice (DIA_NAME_BANDIT_RUECKDASSCHAFRAUS, "Dej mi tu ovci, nebo ti poâídim slušivej monokl.", DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_schaf );

};
func void DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_schaf ()
{
 AI_Output   (other, self, "DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_schaf_15_00"); //Dej mi tu ovci, nebo ti poâídim slušivej monokl.
...
{
 AI_Output   (other, self, "DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_nichts_15_00"); //Nic. Co je pro mę nęjaká hloupá ovce?
 AI_Output   (self, other, "DIA_NAME_BANDIT_RUECKDASSCHAFRAUS_nichts_09_01"); //Tak, nerozčiluj mę. Zmizni!
 hero.aivar[AIV_LastDistToWP]  = Npc_GetDistToWP (hero,"NW_FOREST_CAVE1_IN_01");
 AI_StopProcessInfos (self);
};
