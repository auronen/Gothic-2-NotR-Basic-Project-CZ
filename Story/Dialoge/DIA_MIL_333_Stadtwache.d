...
func void DIA_Mil_333_Stadtwache_FirstWarn_Info()
{
	...
	if (B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
	{
		...
		{
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_03"); //Po męstę jsi hledaný pro vraždu!
		};
	
		if (B_GetGreatestPetzCrime(self) == CRIME_THEFT)
		{
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_04"); //Nechceme tady žádný prašivý zlodęje!
		};
	
		if (B_GetGreatestPetzCrime(self) == CRIME_ATTACK)
		{
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_05"); //Pro potížisty není ve męstę místo!
		};
	
		AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_06"); //Proč myslíš, že bychom tę męli nechat jít dál?
	}
	else // ------ normales Reinkommen ------
	{
		...
		|| (Hlp_IsItem(itm, ItAr_Bau_M) == TRUE)
		{
			...
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_08"); //Vypadáš jako naprostý somrák. V tomhle męstę nemáme místo pro lidi bez penęz.
			...
			{
				AI_Output (other, self,"DIA_Mil_333_Stadtwache_FirstWarn_15_11"); //Ale já se chci pâidat k męstské stráži!
				AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_12"); //Haha! Nechtęj mę rozesmát! Bęž ke druhé bránę a zkus vęšet bulíky na nos zase JIM.
				AI_Output (other, self,"DIA_Mil_333_Stadtwache_FirstWarn_15_13"); //Tam už jsem byl - a oni mę poslali sem.
				AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_14"); //(ošklivę se zasmęje) No potęš! Že oni nám sem posílají vždycky samou smetánku.
			};
		}
		...
		else 
		{
			...
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_16"); //Jen jsem se chtęl na tebe podívat. Tak dobrá, zdá se, že nęjaké ty peníze máš. Můžeš jít.
...
{
	AI_Output (self, other,"DIA_Mil_333_Stadtwache_SecondWarn_06_00"); //Máš snad nęco s ušima? Ještę jeden krok a ochutnáš můj meč!
...
{
	AI_Output (other, self,"DIA_Mil_333_Stadtwache_Bribe_15_00"); //Tady je 100 zlatých. Nech mę projít!
	
	if (B_GiveInvItems (other, self, itmi_gold, 100))
	{
		AI_Output (self, other,"DIA_Mil_333_Stadtwache_Bribe_06_01"); //(lakomę) 100 zlatých zní hezky. Tak bęž dovnitâ.
		
		if (B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
		{
			AI_Output (self, other,"DIA_Mil_333_Stadtwache_Bribe_06_02"); //A jdi rovnou za Andrem! Nebo po tobę budu pâíštę chtít dalších 100 zlatých!
		};
	...
	{
		AI_Output (self, other,"DIA_Mil_333_Stadtwache_Bribe_06_03"); //Co?! Kde?! Nevidím žádné zlaăáky. Zmiz!
	};
