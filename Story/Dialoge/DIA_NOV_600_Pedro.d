...
{
	AI_Output (self, other, "DIA_Pedro_WELCOME_09_00"); //Vítej v Innosovu klášteâe, cizinče.
...
{	
 	...
 	else
 	{
		...
		//B_Say_Gold (self, other, Summe_Kloster);  
 		...
 		AI_Output (self, other, "DIA_ADDON_Pedro_TEMPEL_09_04"); //Ovci a 1000 zlaăáků.
...
{
	AI_Output (other, self, "DIA_Addon_Pedro_Statuette_15_00"); //Mám tady tuhle sošku. Mám dojem, že ji postrádají v klášteâe.
	AI_Output (other, self, "DIA_Addon_Pedro_Statuette_15_01"); //Můžu teë projít?
	if (other.guild == GIL_NONE)
	{
		AI_Output (self, other, "DIA_Addon_Pedro_Statuette_09_02"); //Takže, za tohoto stavu vęcí už ti nic nebrání stát se novicem.

		Log_CreateTopic (TOPIC_Addon_RangerHelpKDF, LOG_MISSION);
		Log_SetTopicStatus(TOPIC_Addon_RangerHelpKDF, LOG_RUNNING);
		B_LogEntry (TOPIC_Addon_RangerHelpKDF,"Novic Pedro mę pustil do kláštera, protože jsem męl tu chybęjící sošku. Męl bych ji doručit nękomu v klášteâe."); 
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Pedro_Statuette_09_03"); //Bojím se ale, že dokonce i s tímto vzácným skvostem tę nemůžu pâijmout.
		AI_Output (self, other, "DIA_Addon_Pedro_Statuette_09_04"); //Už jsi se rozhodl pro jinou cestu. Cesta do kláštera pro tebe zůstává uzavâena.
	};
};
...
func void DIA_Addon_Pedro_Statuette_Abgeben_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Pedro_Statuette_Abgeben_09_01"); //Samozâejmę, okamžitę se o ni postarám. Díky za tvůj nesobecký skutek.
...
func void DIA_Pedro_AUFNAHME_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Pedro_AUFNAHME_09_02"); //Je to opravdu tvoje pâání? Uvędom si ale jednu vęc. Všechny ostatní cesty pro tebe zůstanou navždy uzavâeny.
