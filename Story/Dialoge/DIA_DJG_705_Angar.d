...
instance DIA_AngarDJG_HALLO		(C_INFO)
{
	...
	description	 = 	"Neznáme se? Ty jsi Cor Angar. Býval jsi templáâem v táboâe v bažinách.";
};
...
func void DIA_AngarDJG_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_AngarDJG_HALLO_04_04"); //(pâehlíživę) Ach, nebyl jsem jeden čas vůbec schopen usnout. Poâád jsem męl noční můry.
...
{	
	if (Angar_KnowsMadPsi == FALSE)
	{
		...
		AI_Output			(other, self, "DIA_Angar_B_SCTellsAngarAboutMadPsi_15_01"); //Tví dâívęjší pâátelé ze starého tábora procházejí zemí v černých róbách a vypadají, že je vše, co se hýbe, neskutečnę štve.
...
{
	AI_Output			(other, self, "DIA_Angar_WIEKOMMSTDUHIERHER_nun_15_00"); //Co budeš dęlat dál?
...
func void DIA_AngarDJG_WHATSINTHERE_Info ()
{
	...
	AI_Output			(self, other, "DIA_AngarDJG_WHATSINTHERE_04_03"); //Obrátili se nazpęt a zmizeli mezi stromy. A tys męl pocit, jako by vysáli všechen život z okolí jako houba vysává vodu.
...
instance DIA_Angar_PERMKAP4		(C_INFO)
{
	...
	description	 = 	"Vážnę tę můžu nechat samotného?";
};
