...
FUNC VOID DIA_Andre_PETZMASTER_Info()
{
	...
	if (B_GetGreatestPetzCrime(self) == CRIME_MURDER) 
	{
		...
		AI_Output (self, other, "DIA_Andre_PETZMASTER_08_06"); //Nemám žádný zájem na tom tę povęsil. Jsme ve válce a potâebujeme každého muže.
	...
	{
		AI_Output (self, other, "DIA_Andre_PETZMASTER_08_09"); //Dobâe, že jsi pâišel! Jsi obvinęný z krádeže! Jsou na to svędci!
		if ((PETZCOUNTER_City_Attack + PETZCOUNTER_City_Sheepkiller) > 0)
		{
			AI_Output (self, other, "DIA_Andre_PETZMASTER_08_10"); //A to nemluvím o dalších vęcech, které se mi donesly.
		};
		AI_Output (self, other, "DIA_Andre_PETZMASTER_08_11"); //Takové chování nebudu ve męstę tolerovat!
...
func void DIA_Andre_PaladineAgain_Info ()
{
	...
	{
		AI_Output (other, self, "DIA_Andre_PaladineAgain_15_00"); //Âekneš mi teë, proč jste vy paladinové pâijeli sem do Khorinisu?
	}
	else
	{
...
func void DIA_Andre_ABOUTMILIZ_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_AboutMiliz_08_02"); //Je to špinavá a nękdy i krvavá práce. Jakmile budeš jedním z nás, bude tę čekat spousta práce.
...
func void DIA_Addon_Andre_MartinEmpfehlung_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Andre_MartinEmpfehlung_08_01"); //(nevęâícnę) Cože? Okamžitę mi ho ukaž.
	B_GiveInvItems (other, self, ItWr_Martin_MilizEmpfehlung_Addon,1);
	B_UseFakeScroll();
	AI_Output	(self, other, "DIA_Addon_Andre_MartinEmpfehlung_08_02"); //(ohromenę) Já zírám! To ses musel opravdu snažit, abys na nęho udęlal dojem, že? Martin totiž vętšinou nebývá tak velkorysý v tęhle vęcech.
	AI_Output	(self, other, "DIA_Addon_Andre_MartinEmpfehlung_08_03"); //Dobâe, dobâe. Tím si mę pâesvędčil. Když máš podporu Martina, tak já tę budu také akceptovat. Âekni mi, kdy budeš pâipravený.
...
func void DIA_Andre_GuildOfThieves_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_GuildOfThieves_08_01"); //Poslední dobou se ve męstę stalo množství krádeží. Zatím se nám nepodaâilo nikoho chytit, ti zlodęji jsou prostę pâíliš dobâí.
	...
	AI_Output (self, other, "DIA_Andre_GuildOfThieves_08_03"); //Nepâekvapilo by mę, kdyby byl tady v Khorinisu zlodęjský cech. Najdi vůdce toho gangu a sejmi ho.
	if (other.guild == GIL_NONE)
	{
	...
	B_LogEntry (TOPIC_BecomeMIL,"K męstské gardę se mohu pâidat i jinak, a to tak, že vypátrám a zničím khorinisský zlodęjský cech.");
...
func void DIA_Andre_Auslieferung_Nagur()
{
	...
	AI_Output (other, self, "DIA_Andre_Auslieferung_Nagur_15_00"); //Nagur zabil Baltramova posla. Pokusil se použít mę jako nového posla, aby zachytil Akilovu zásilku.
...
func void DIA_Andre_Auslieferung_Canthar()
{
	...
	AI_Output (other,self , "DIA_Andre_Auslieferung_Canthar_15_02"); //Męl jsem jí podstrčit falešný dopis, ve kterém tvrdí, že dodává zbranę Onarovi.
...
func void DIA_Andre_Auslieferung_Sarah()
{
	...
	AI_Output (other, self, "DIA_Andre_Auslieferung_Sarah_15_02"); //Má ve své kapse dopis, ve kterém jsou podrobnosti o dodávce zbraní k nęmu.
...
func void DIA_Andre_JOIN_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Andre_JOIN_08_00"); //Martin za tebe ručí a dokonce tę i doporučil. To mi bude stačit.
	}
	//ADDON
	...
	else if (Player_IsApprentice > APP_NONE)
	{
		...
		AI_Output (self, other, "DIA_Andre_JOIN_08_13"); //Pokud pro tebe bude hlasovat, nestojí nic v cestę tvému pâijetí do domobrany.
...
FUNC VOID DIA_Andre_FOUND_PECK_SOMEWHERE()
{
	...
	AI_Output (self, other, "DIA_Andre_FOUND_PECK_SOMEWHERE_08_01"); //Dobrá, tak jdi za ním a vyzvedni si zbraŕ.
...
func void DIA_Andre_FIRSTMISSION_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_FIRSTMISSION_08_01"); //V poslední dobę stoupl ve męstę prodej trávy z bažin.
	...
	AI_Output (self, other, "DIA_Andre_FIRSTMISSION_08_05"); //Mám podezâení, že za tím jsou ti žoldáci. Vsadím se, že to jsou oni, kdo to svinstvo pâináší do męsta.
...
func void DIA_Andre_FIND_DEALER_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_FIND_DEALER_08_06"); //Najdi toho dealera a nech si od nęj nęjakou tu trávu prodat. Nebude to snadné, ale jinak ho nemůžeme zatknout.
...
func void DIA_Andre_HILFBAUERLOBART_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_HILFBAUERLOBART_08_02"); //Pokud mu pomůžeme, upevníme jeho vztahy s męstem. Jdi tedy za ním a zjisti, co se dęje.
...
instance DIA_Addon_Andre_MissingPeople		(C_INFO)
{
	...
	description	= "Co je s tęmi chybęjícími lidmi?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Andre_MissingPeople_15_00"); //Co je s tęmi chybęjícími lidmi?
	...
	AI_Output (self, other, "DIA_Addon_Andre_MissingPeople_08_03"); //Dostal jsem rozkaz od lorda Hagena chránit męsto a jeho okolí.
	AI_Output (self, other, "DIA_Addon_Andre_MissingPeople_08_04"); //A to znamená, že budu chránit lidi, kteâí jsou stále TADY.
	AI_Output (self, other, "DIA_Addon_Andre_MissingPeople_08_05"); //Hlídky domobrany jsou každou noc v ulicích. Nemůžu udęlat víc.
	AI_Output (self, other, "DIA_Addon_Andre_MissingPeople_08_06"); //A TY se budeš starat o ten úkol, co jsem ti dal, rozumęls?
...
instance DIA_Addon_Andre_MissingPeople2	(C_INFO)
{
	...
	description	= "Ohlednę tęch chybęjících lidí ...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Andre_MissingPeople2_15_00"); //Ohlednę tęch chybęjících lidí ...
	AI_Output (self, other, "DIA_Addon_Andre_MissingPeople2_08_01"); //Jen se o ty fámy starej. Já mám vlastních problémů dost.
	MIS_Addon_Andre_MissingPeople = LOG_RUNNING;
};
...
instance DIA_Addon_Andre_ReturnedMissingPeople		(C_INFO)
{
	...
	description	 = 	"Podaâilo se mi pár tęch chybęjících lidí zachránit.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Andre_ReturnedMissingPeople_15_00"); //Podaâilo se mi pár tęch chybęjících lidí zachránit.
	if (other.guild == GIL_MIL)
	{
		AI_Output (self, other, "DIA_Addon_Andre_ReturnedMissingPeople_08_01"); //Už mę začínalo zajímat, kde ses tak dlouho toulal!
		AI_Output (self, other, "DIA_Addon_Andre_ReturnedMissingPeople_08_02"); //Ty jsi člen domobrany! Takové vęci se tę netýkají!
	...
	AI_Output (other, self, "DIA_Addon_Andre_ReturnedMissingPeople_15_05"); //Všechny, kteâí byli ještę naživu ...
	AI_Output (self, other, "DIA_Addon_Andre_ReturnedMissingPeople_08_06"); //Všichny?! Já ... on ...
	if (other.guild == GIL_MIL)
	{
		AI_Output (self, other, "DIA_Addon_Andre_ReturnedMissingPeople_08_07"); //Jsem na tebe hrdý! Jsem nadšený, že jsem tę sem pâijal.
		B_AndreSold ();
	};
	AI_Output (self, other, "DIA_Addon_Andre_ReturnedMissingPeople_08_08"); //Byl to tęžký úkol.
...
func void DIA_Andre_BennetInPrison_Info ()
{
	...
	AI_Output (self ,other,"DIA_Andre_BennetInPrison_Talk_08_01"); //Jistę, jak je libo. Ale pokud se pokusíš pomoci mu k útęku, skočíš tam také.
};
...
func void DIA_Andre_Cornelius_Liar_Info ()
{
	...
	Info_AddChoice (DIA_Andre_Cornelius_Liar,"Ne. O tom se musí dozvędęt lord Hagen.",DIA_Andre_Cornelius_Liar_No);  
