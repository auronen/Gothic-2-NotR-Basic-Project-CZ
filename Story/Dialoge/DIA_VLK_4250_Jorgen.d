...
INSTANCE DIA_Jorgen_Milten   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Jestli míâíš do kláštera, męl by sis promluvit s Miltenem...";
};
...
FUNC VOID DIA_Jorgen_Milten_Info()
{
	...
	AI_Output (self ,other,"DIA_Jorgen_Milten_07_03"); //Dost tęch nesmyslů - jasnę že roucho noviců. To je pâesnę to, po čem bažím, i když potom budu muset ohlodávat kůru ze stromů.
}; 
...
FUNC VOID DIA_Jorgen_Home_Info()
{
	...
	AI_Output (self ,other,"DIA_Jorgen_Home_07_04"); //Jediná loë, která v Khorinisu kotví, je ta zatracená válečná královská galéra - a tam nikoho dalšího nepâijmou.
...
INSTANCE DIA_Jorgen_BeCarefull   (C_INFO)
{
	...
	permanent   = TRUE;
	description	= "Udęlals dobâe, že jsi nikam nešel.";
};
...
func void DIA_Jorgen_PERM4_Info ()
{
	...
	AI_Output			(self, other, "DIA_Jorgen_PERM4_07_02"); //Jediné, co potâebuju, je zase stará dobrá paluba pod nohama.
};
