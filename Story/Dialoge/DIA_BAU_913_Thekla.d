...
func void DIA_Thekla_PERM_Info()
{
 ...
 if (MIS_Thekla_Paket == FALSE)
 {
  ...
  AI_Output (self, other, "DIA_Thekla_PERM_17_08"); //Zajdi za Sagittou, léčitelkou, co žije za Sekobovou farmou, a pâines mi od ní balík bylinek.
 ...
 else if (MIS_Thekla_Paket == LOG_SUCCESS)
 {
  if (Kapitel <= 2)
  {
   ...
   {
    AI_Output (self, other, "DIA_Thekla_PERM_17_10"); //NDobrá. Tak budu hodná. Tady. Aă mi neumâeš hlady pâed očima.
    B_GiveInvItems (self, other, ItFo_XPStew, 1);
