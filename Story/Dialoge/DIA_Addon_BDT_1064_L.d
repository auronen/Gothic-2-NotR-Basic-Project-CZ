...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Je jen jedna cesta jak se dostat do našeho tábora živý - pâes most.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Âíkáš si o jednu do držky, co? Ještę JEDEN krok a poletíš ze skály dolů.
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_02"); //Dobrá, âekl sis o to ...
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Jdeš mi na nervy!
	AI_StopProcessInfos(self);
};
