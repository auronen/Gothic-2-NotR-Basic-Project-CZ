...
FUNC VOID DIA_Oric_CanHelp_Info()
{
	...
	Info_AddChoice (DIA_Oric_CanHelp,"Myslím, že byste si męli najít nękoho jiného.",DIA_Oric_CanHelp_NotYourMan); 
...
INSTANCE DIA_Oric_NeedStuff   (C_INFO)
{
	...
	description = "Budu potâebovat pár vęcí.";
};
...
FUNC VOID DIA_Oric_NeedStuff_Info()
{
	...
	Info_AddChoice (DIA_Oric_NeedStuff,"1 elixír obratnosti",DIA_Oric_NeedStuff_Dexterity);
	Info_AddChoice (DIA_Oric_NeedStuff,"1 elixír síly",DIA_Oric_NeedStuff_Strength);
	Info_AddChoice (DIA_Oric_NeedStuff,"3 elixíry many",DIA_Oric_NeedStuff_Mana);	
...
func void DIA_Oric_DragonPlettBericht_Info ()
{
		...
		||	(Oric_IcedragonInfo_OneTime == FALSE))
	{
		...
		&& (Oric_SwampdragonInfo_OneTime == FALSE)
		{
			...
			B_LogEntry (TOPIC_DRACHENJAGD,"Oric mi dal aspoŕ nęjakou stopu: západnę od hradu se pâed nękolika dny zničeho nic objevila hluboká bažina. To je opravdu podezâelé."); 
