...
{	
	AI_Output (self ,other, "DIA_Addon_Xardas_Hello_14_00"); //Tak tę tu máme! Už jsem si nemyslel, že se ještę setkáme.
	AI_Output (other, self, "DIA_Addon_Xardas_Hello_15_01"); //Citím se jako kdybych tâi týdny ležel pod hromadou kamení.
	AI_Output (self ,other, "DIA_Addon_Xardas_Hello_14_02"); //No, taky že ano. Pouze magie v tvé zbroji tę zachránila.
	AI_Output (self ,other, "DIA_Addon_Xardas_Hello_14_03"); //Bál jsem se, že už tę nebudu moci osvobodit z ruin chrámu.
	AI_Output (self ,other, "DIA_Addon_Xardas_Hello_14_04"); //Ale dost toho. Teë jsi tady.
	...
	Info_AddChoice	(DIA_Xardas_Hello, "Teë alespoŕ máme dost času. Postaral jsem se o to. Spáč...", DIA_Addon_Xardas_Hello_Dragons );
...
func void DIA_Addon_Xardas_Hello_Man ()
{
	...
	AI_Output (self, other, "DIA_Addon_Xardas_AddonIntro_Add_14_10"); //Beliarův hnęv se jen zvýšil po pádu bariéry a odstranęní Spáče!
...
func void DIA_Addon_Xardas_Hello_Dragons ()
{
	...
	AI_Output (self ,other,"DIA_Xardas_Hello_14_14"); //Utáboâila se nedaleko odsud, v Hornickém údolí poblíž Khorinisu. Pomalu se pâipravuje k útoku.
	...
	{
		AI_Output (self ,other, "DIA_Addon_Xardas_Hello_Dragons_14_06"); //Ale to není vše. Je tady JINÁ hrozba o které jsem se právę dozvędęl.
		Info_ClearChoices	(DIA_Xardas_Hello);
		Info_AddChoice	(DIA_Xardas_Hello, "O jakém NOVÉM nebezpečí to mluvíš?", DIA_Addon_Xardas_Hello_Man );
	};
};
...
func void DIA_Xardas_TODO_Info ()
{
	...
	AI_Output (self, other, "DIA_Xardas_TODO_14_05"); //Âekni paladinům o nebezpečí, které hrozí. MUSÍŠ pâesvędčit jejich vůdce, aby nám pomohl!
	AI_Output (self, other, "DIA_Addon_Xardas_Add_14_07"); //A jak s ním budeš mluvit, musíš najít Beliarův artefakt.
	AI_Output (self, other, "DIA_Addon_Xardas_Add_14_08"); //Je to protęjšek Innosova Oka. Nesmí padnout do rukou zla.
	Log_CreateTopic (TOPIC_INNOSEYE, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_INNOSEYE, LOG_RUNNING);
	B_LogEntry (TOPIC_INNOSEYE,"V Khorinisu se usadila skupina paladinů, kteâí opatrují mocný artefakt zvaný Innosovo oko, jenž nám může pomoci zahnat dračí hrozbu. Musím ty svaté bojovníky nęjak pâesvędčit, aby se k nám pâidali."); 
};
...
instance DIA_Addon_Xardas_StonePlate		(C_INFO)
{
	...
	description	 = 	"Můžeš mi âíct nęco o téhle kamenné desce?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Xardas_StonePlate_15_00"); //Můžeš mi âíct nęco o téhle kamenné desce?
	...
	AI_Output	(self, other, "DIA_Addon_Xardas_StonePlate_14_03"); //Nejprve jsem si myslel že to je jakýsi magický artefakt, ale došel jsem k závęru, že to není moc důležité.
	AI_Output	(self, other, "DIA_Addon_Xardas_StonePlate_14_04"); //Nedokázal jsem tu tabulku úplnę pâeložit , ale vypadá to, že jde o pâíbęh velmi staré kultury.
	AI_Output	(self, other, "DIA_Addon_Xardas_StonePlate_14_05"); //Jestli ji chceš, klidnę si ji vem. Nemám pro ni už žádné upotâebení.
...
func void DIA_Addon_Xardas_Portal_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_02"); //Až najdeš nęco, co nám OPRAVDU pomůže, zprav mę o tom!
	AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_03"); //Nękde tam mohl být skryt Beliarův artefakt. Najdi ho!
};
...
func void DIA_Addon_Xardas_PortalAgain_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_18"); //Nezatęžuj mę detaily. Vraă se až najdeš nęco skutečnę užitečného.
};
...
func void DIA_Addon_Xardas_AddonSuccess_Info ()
{
	...
	AI_Output (other, self, "DIA_Addon_Xardas_AddonSuccess_15_05"); //Vše nabralo smęr k mocnému artefaktu. Beliarovu drápu.
	AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_06"); //Beliarův Dráp? Kde je teë ? Máš ho u sebe?

	if (C_SCHasBeliarsWeapon())
	{
		AI_Output (other, self, "DIA_Addon_Xardas_AddonSuccess_15_07"); //Jo, mám ho tady.
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_08"); //(lačnę) Velmi zajímavé.
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_09"); //Tato zbraŕ může být pro nás velmi užitečná. Ale také extrémnę nebezpečná.
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_10"); //Použivj ji opatrnę! A hlavnę, neztraă ji!
		B_GivePlayerXP (XP_Ambient*3);
	}
	else
	{
		AI_Output (other, self, "DIA_Addon_Xardas_AddonSuccess_15_11"); //Už ji nemám ...
		AI_Output (other, self, "DIA_Addon_Xardas_AddonSuccess_15_12"); //Dal jsem ji mágům Vody, aby ji vrhli do moâe ...
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_13"); //(rozzuâenę) Zbláznil ses? Víš vůbec co jsi dal pryč z rukou?
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_14"); //Tato zbraŕ nám mohla být velmi užitečná!
		AI_Output (other, self, "DIA_Addon_Xardas_AddonSuccess_15_15"); //Vęâím, že tak je to lepší.
...
func void DIA_Xardas_FirstPal_Info ()
{
	...
	AI_Output (other, self, "DIA_Xardas_FirstPal_15_02"); //Nepustil mę k nęmu.
...
INSTANCE DIA_Xardas_KdfSecret (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Proč o tobę nemají mágové ohnę vędęt?";
};                       
...
func void DIA_Xardas_DMTSINDDA_Info ()
{
	...
	B_LogEntry (TOPIC_INNOSEYE, "Nepâítel se domákl, že hledám Innosovo oko. Je načase je získat, než bude pâíliš pozdę.");
	
	Info_ClearChoices	(DIA_Xardas_DMTSINDDA);
	Info_AddChoice	(DIA_Xardas_DMTSINDDA, "Zaútočili na mę mágové v černých rouchách.", DIA_Xardas_DMTSINDDA_DMT );
...
{
	AI_Output			(other, self, "DIA_Xardas_DMTSINDDA_DMT_15_00"); //Zaútočili na mę mágové v černých rouchách.
...
func void DIA_Xardas_DMTSINDDA_Beweis ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_DMTSINDDA_Beweis_14_03"); //To by snad męlo toho militantního politika pâesvędčit. Dobrá práce.
...
func void DIA_Xardas_DMTSINDDA_DMT_WhatToDo ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_DMTSINDDA_DMT_WhatToDo_14_01"); //Jdi a dones lordu Hagenovi dopis od Garonda, męl by ti zaâídit pâístup k Innosovu oku.
...
func void DIA_Xardas_INNOSEYEBROKEN_wasnun ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_INNOSEYEBROKEN_wasnun_14_01"); //To je bolestná zpráva. Musíme se sami v téhle situaci zorientovat. Stáhnu se a zkusím najít âešení.
	AI_Output			(self, other, "DIA_Xardas_INNOSEYEBROKEN_wasnun_14_02"); //Mezitím bys męl jít do męsta a promluvit si s vodním mágem Vatrasem. Je možné, že bude vędęt, co by męlo být udęláno.

	B_LogEntry (TOPIC_INNOSEYE, "Zpráva o zničení Oka Innosova Xardase rozhodnę nepotęšila. Naší jedinou nadęjí je nyní mág vody jménem Vatras, který sídlí ve męstę Khorinisu.");
...
func void DIA_Xardas_WARUMNICHTJETZT_grund ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_WARUMNICHTJETZT_grund_14_02"); //A na tom nehodlám nic męnit, leda že bych nemęl na vybranou.
