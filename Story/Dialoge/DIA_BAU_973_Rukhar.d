...
func void DIA_Rukhar_WASMACHSTDU_Info ()
{
 ...
 B_LogEntry (TOPIC_Wettsaufen,"V té hospodę se uzavírají sázky.");
...
{
 AI_Output   (other, self, "DIA_Rukhar_HOLERANDOLPH_15_00"); //A můžu si tedy vsadit na nękoho jiného?
 ...
 AI_Output   (self, other, "DIA_Rukhar_HOLERANDOLPH_12_03"); //Dohoë mi nękoho, kdo bude mít dost odvahy si to se mnou rozdat, a můžeš se vsadit.
...
instance DIA_Rukhar_RANDOLPHWILL  (C_INFO)
{
 ...
 description  =  "Mám nękoho, kdo by chtęl s tebou soupeâit.";
};
...
func void DIA_Rukhar_Perm_Info ()
{
 ...
 AI_Output (self, other, "DIA_Rukhar_Perm_12_01"); //ic, o čem bych vędęl. Nikdo mi nic neâekl.
};
