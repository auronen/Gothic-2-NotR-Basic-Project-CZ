...
instance DIA_Maria_Umsehen  (C_INFO)
{
 ...
 permanent   = FALSE;
 description = "Jen jsem si to chtęl tady prohlédnout.";
};
...
instance DIA_Maria_BringPlate (C_INFO)
{
 ...
 permanent   = FALSE;
 description = "Mám u sebe zlatý talíâ. Není náhodou tvůj?";
};
...
func void DIA_Maria_BringPlate_Info ()
{
 ...
 AI_Output (other, self, "DIA_Maria_BringPlate_15_00"); //Mám u sebe zlatý talíâ. Není náhodou tvůj?
...
{
 AI_Output (other, self, "DIA_Maria_Belohnung_15_00"); //Pracuješ pro mého manžela jako žoldnéâ, ne?
...
instance DIA_Maria_AboutOnar (C_INFO)
{
 ...
 permanent   = FALSE;
 description = "Âekni mi nęco o Onarovi.";
};
...
func void DIA_Maria_AboutOnar_Info ()
{
 ...
 AI_Output (self, other, "DIA_Maria_AboutOnar_17_02"); //Âekla jsem svému muži, proč ty vojáky necháš se sebou takhle zacházet?
 ...
 AI_Output (self, other, "DIA_Maria_AboutOnar_17_05"); //Ale mi vlastnę jsme ve válce, nebo ne?
};
