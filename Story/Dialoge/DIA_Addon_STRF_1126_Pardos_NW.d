...
{
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_00");//Jsi v pohodę?
	AI_Output (self, other, "DIA_Addon_Pardos_NW_Hi_03_01");//(šklebí se) Hej, můj zachránče. Znovu dękuji. Nyní mohu odpočívat celý den.
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_02");//Chápu. Půjdu tedy pryč.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
