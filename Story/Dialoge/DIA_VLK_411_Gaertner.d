...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Job_09_05"); //Ale správce Larius potâeboval dalšího zahradníka a tak jsem tady mohl zůstat.
...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_01"); //Pár. Pęstuji vrbky úzkolisté a ohnivé kopâivy. Také jsem zkoušel trávu z bažin, ale vůbec se jí tady nedaâilo.
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_02"); //Nuže, právę jsem sklidil. Takže pokud chceš nęco koupit...
...
{	
	AI_Output (other,self ,"DIA_Gaertner_Krautabak_15_00"); //Mám tady tabákové listy. Zakouâíte si?
