...
func void DIA_Sonja_STANDARD_Info ()
{
	...
	&& (Sonja_Says == FALSE)
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_01"); //To je problém vás chlapů - radši byste vraždili skâety, než zatloukli hâebík.
		Sonja_Says = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_02"); //A jestli se rád s nękým vybavuješ, najdi si babu a ožeŕ se s ní.
	};
	AI_StopProcessInfos (self);
};
