...
func void DIA_Rengaru_Hauab_Info ()
{
	...
	AI_Output (self, other, "DIA_Rengaru_Hauab_07_01"); //Nejsem si jist, jestli ti do toho nęco je. Ztraă se!
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info HalloDieb
...
{
	AI_Output (other, self, "DIA_Rengaru_GOTYOU_Anteil_15_00"); //Zasloužím si nęjaký podíl na koâisti.
...
func void DIA_Rengaru_GOTYOU_WhoAreYou ()
{
	...
	AI_Output (self, other, "DIA_Rengaru_GOTYOU_WhoAreYou_07_01"); //Jsem jen ubohej mizera, co se snaží vyjít s penęzi, jak se dá.
	AI_Output (self, other, "DIA_Rengaru_GOTYOU_WhoAreYou_07_02"); //Co ještę můžu udęlat? Ve męstę o práci nezavadíš.
	AI_Output (other, self, "DIA_Rengaru_GOTYOU_WhoAreYou_15_03"); //... Dobrá, to vím. Ušetâi mę tęch náâků!
};
///////////////////////////////////////////////////////////////////////
//	Info InKnast
///////////////////////////////////////////////////////////////////////
...
func void DIA_Rengaru_INKNAST_Knast ()
{
	...
	AI_Output (self, other, "DIA_Rengaru_INKNAST_Knast_07_02"); //(varovnę) Dávej si bacha - mí kamarádi nebudou odvázaní z toho, co tady vyvádíš.
