...
{
	AI_Output (self ,other,"DIA_Agon_Hello_07_00"); //(opovržlivę) Co chceš?
};
...
FUNC VOID DIA_Agon_New_Info()
{
	...
	AI_Output	(self ,other,"DIA_Agon_New_07_02"); //Jestli zatím nemáš co na práci, promluv si s Parlanem. On už ti nęjakou dá.
};
//***********************************************************************
...
FUNC VOID DIA_Agon_YouAndBabo_Info()
{
	...
	AI_Output	(self ,other,"DIA_Agon_YouAndBabo_07_01"); //Nemęl bys vęâit všemu, co uslyšíš.
	AI_Output	(self ,other,"DIA_Agon_YouAndBabo_07_02"); //(neústupnę) Âeknęme si jedno: půjdu svou vlastní cestou. Tou, kterou mi pâedurčil Innos.
	AI_Output	(self ,other,"DIA_Agon_YouAndBabo_07_03"); //Nedovolím nikomu stát mi v cestę, a určitę ne tomu jelimánkovi Babovi.

	Info_ClearChoices 	(DIA_Agon_YouAndBabo);
	Info_AddChoice	(DIA_Agon_YouAndBabo,"Nemęli bychom my novicové držet pohromadę?",DIA_Agon_YouAndBabo_AllTogether);
	Info_AddChoice	(DIA_Agon_YouAndBabo,"Innos sám ví, jakou cestou bychom se męli vydat.",DIA_Agon_YouAndBabo_InnosWay);
...
{
	AI_Output (other,self ,"DIA_Agon_YouAndBabo_AllTogether_15_00"); //Nemęli bychom my novicové držet pohromadę?
	AI_Output (self ,other,"DIA_Agon_YouAndBabo_AllTogether_07_01"); //Vy ostatní si držte pohromadę, jak chcete.
	AI_Output (self ,other,"DIA_Agon_YouAndBabo_AllTogether_07_02"); //Ale prosím, neplýtvej mým časem. (chladnę) A nestav se mi do cesty.
...
{
	AI_Output	(other,self ,"DIA_Agon_YouAndBabo_InnosWay_15_00"); //Innos sám ví, jakou cestou bychom se męli vydat.
	AI_Output 	(self ,other,"DIA_Agon_YouAndBabo_InnosWay_07_01"); //Moje rodina vždycky stála vysoko v Innosovę pâízni a na tom se nic nezmęní.
...
{
	AI_Output (other,self ,"DIA_Agon_GetHerb_15_00"); //Co tady pęstujete?
	AI_Output (self ,other,"DIA_Agon_GetHerb_07_01"); //Snažíme se vypęstovat léčivé byliny, aby mohl mistr Neoras vaâit lektvary.
};
//************************************************************************
...
{
	AI_Output (self ,other,"DIA_Agon_GolemDead_07_00"); //(vítęznę) Jdeš pozdę!
	AI_Output (self ,other,"DIA_Agon_GolemDead_07_01"); //Byl jsem tady první! Vyhrál jsem!
	 
	Info_ClearChoices (DIA_Agon_GolemDead);
	Info_AddChoice (DIA_Agon_GolemDead,"(výhrůžnę) Jenom pokud se odsud dostaneš živý.",DIA_Agon_GolemDead_NoWay);
	Info_AddChoice (DIA_Agon_GolemDead,"Drž hubu!",DIA_Agon_GolemDead_ShutUp);
	Info_AddChoice (DIA_Agon_GolemDead,"Gratuluji, vážnę sis to zasloužil.",DIA_Agon_GolemDead_Congrat);
};

FUNC VOID DIA_Agon_GolemDead_NoWay ()
{
	AI_Output (other,self ,"DIA_Agon_GolemDead_NoWay_15_00"); //(výhrůžnę) Jenom pokud se odsud dostaneš živý.
	AI_Output (self ,other,"DIA_Agon_GolemDead_NoWay_07_01"); //Chceš mę zabít? To se ti nikdy nepovede.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_07_01"); //(výsmęšnę) Nemáš nárok, prohrál jsi! Pâiznej si to.
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_07_02"); //Jenom mnę bylo osudem určeno stát se mágem.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp_MyChest ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_MyChest_07_01"); //(rozzlobenę) Ne, to teda ne, to tę spíš zabiju.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp_YouWin ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_YouWin_07_01"); //(zbęsile) Ne, mę neošálíš. Snažíš se mę zbavit.
...
{
	AI_Output (other,self ,"DIA_Agon_GolemDead_Congrat_15_00"); //Gratuluji, vážnę sis to zasloužil.
	AI_Output (self ,other,"DIA_Agon_GolemDead_Congrat_07_01"); //(nedůvęâivę) Co to má znamenat? Co máš za lubem?
	AI_Output (other,self ,"DIA_Agon_GolemDead_Congrat_15_02"); //O čem to mluvíš?
	AI_Output (self ,other,"DIA_Agon_GolemDead_Congrat_07_03"); //(nervóznę) Chceš mę zabít a nechat si všechnu slávu pro sebe!
...
{
	AI_Output (self ,other,"DIA_Agon_GolemLives_07_00"); //(pâekvapenę) Našel jsi ten úkryt pâede mnou. To nejde...
	AI_Output (self ,other,"DIA_Agon_GolemLives_07_01"); //(odhodlanę) Tak to nemůže zůstat! To nedovolím.
...
{
	AI_Output (other,self ,"DIA_Agon_StillAlive_15_00"); //Co tady dęláš?
...
FUNC VOID DIA_Agon_Perm_Info()
{
	...
	{
		AI_Output	(self ,other,"DIA_Agon_Perm_07_02"); //(arogantnę) Tady v Innosovę klášteâe jsi jenom hostem. Męl by ses tedy podle toho chovat a nerušit mę v mé práci. Pâeji hezký den.
	};
};
