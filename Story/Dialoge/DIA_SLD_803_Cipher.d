...
instance DIA_Cipher_TradeWhat (C_INFO)
{
	...
	permanent	= FALSE;
	description = "A s čímpak obchoduješ teë?";
};                       
...
{	
	...
	AI_Output (self, other, "DIA_Cipher_TradeWhat_07_01"); //Ach, neptej se mę.
...
instance DIA_Cipher_DoWithThief (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Co tedy chceš s tím zlodęjem udęlat?";
};                       
...
{	
	...
	AI_Output (self, other, "DIA_Cipher_DoWithThief_07_03"); //Kdybych ho napadnul tady uprostâed dvora, ostatní farmáâi by si toho všimli a já bych si to odskákal.
...
{	
	...
	AI_Output (self, other, "DIA_Cipher_WannaJoin_07_04"); //Ale poslední dobou to už pâehání. Chce si sem prostę jen tak sednout a čekat, dokud paladinové nezemâou hladem.
...
instance DIA_Cipher_DarLOST (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Skutečnę jsi dal Darovi co proto. Cítíš se teë líp?";
};                       
...
{	
	...
	AI_Output (other, self, "DIA_Cipher_DarLOST_15_02"); //Pâedpokládám, že ale ON ne...
