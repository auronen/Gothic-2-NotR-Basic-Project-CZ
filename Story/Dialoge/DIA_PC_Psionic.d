...
instance DIA_Lester_SEND_XARDAS		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Musíš âíct Xardasovi o tom stínu, mohlo by to být důležité.";
};
...
func void DIA_Lester_SEND_XARDAS_Info ()
{
	...
	AI_Output (self, other, "DIA_Lester_SEND_XARDAS_13_05"); //(povzdychne si) No dobrá, když je to tak důležité, tak za ním půjdu - ale ještę ne.
...
instance DIA_Addon_Lester_STADT		(C_INFO)
{
	...
	description	 = 	"Jsem na cestę do Khorinisu! Co o tom męstę víš?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lester_STADT_15_00"); //Jsem na cestę do Khorinisu! Co o tom męstę víš?
	AI_Output	(self, other, "DIA_Addon_Lester_STADT_13_01"); //Khorinis? Hm, je to pâístav. Nic zvláštního.
	AI_Output	(self, other, "DIA_Addon_Lester_STADT_13_02"); //Proč se ptáš?
	AI_Output	(other, self, "DIA_Addon_Lester_STADT_15_03"); //Potâebuju si promluvit s paladiny, kteâí by męli být ve męstę.
	AI_Output	(self, other, "DIA_Addon_Lester_STADT_13_04"); //(smęje se) To myslíš vážnę?. I kdyby ses už dostal do męsta, tak k paladinům nikdy.
};
...
instance DIA_Addon_Lester_Vorschlag		(C_INFO)
{
	...
	description	 = 	"Máš nęjaký návrh, jak bych se mohl dostat do męsta?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lester_Vorschlag_15_00"); //Máš nęjaký návrh, jak bych se mohl dostat do męsta?
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_01"); //Vlastnę ano. Nedávno jsem pracoval pro starého alchymistu Constantina.
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_02"); //Má ve męstę určitý vliv a naâídil strážím, aby pustili lidi, kteâí mu nesou vzácné byliny.
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_03"); //Ve skutečnosti to však není tak složité. Jednoduše nasbíráš hrst bylin, které tu rostou všude kolem. A pak jednoduše pâedstíráš, že dęláš pro Konstantina. Męli by tę pustit.
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_04"); //Nicménę, ujisti se, že máš všechny druhy stejné. Ne jenom náhodnę sebrané. Stráže nesjou pâíliš bystâí a neví skoro nic o alchymistických vęcech.
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_05"); //Takže, trs, který obsahuje rostliny pouze jednoho druhu by je męl zmást.
	AI_Output	(self, other, "DIA_Addon_Lester_Vorschlag_13_06"); //Hádal bych, že 10 bude stačit.
	...
	B_LogEntry (TOPIC_Addon_PickForConstantino,"Lester si myslí, že bych se mohl dostat do męsta, když strážím u brány ukážu 10 rostlin stejného druhu. Jen musím pâedstírat, že je nesu pro alchymistu Constantina."); 
...
instance DIA_Addon_Lester_PASSAGEPLANTSSUCCESS		(C_INFO)
{
	...
	description	 = 	"Ten 'trik' s rostlinami fungoval. Prošel jsem kolem stráží.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lester_PASSAGEPLANTSSUCCESS_15_00"); //Ten 'trik' s rostlinami fungoval. Prošel jsem kolem stráží.
	AI_Output	(self, other, "DIA_Addon_Lester_PASSAGEPLANTSSUCCESS_13_01"); //Jak âíkám. Víš, že poslouchat moje rady se vyplatí, kámo.
...
func void DIA_Lester_PERM3_Info ()
{
	...
	else
	{
		...
		{
			AI_Output			(self, other, "DIA_Lester_PERM3_13_14"); //Ta bolest hlavy začíná být nesnesitelná. A teë na mę ještę poâád útočí ti ještęrani. Musím se sám sebe ptát, odkud se berou.
		}
		else
		{
