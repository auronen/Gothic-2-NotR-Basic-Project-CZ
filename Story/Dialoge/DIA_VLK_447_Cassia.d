...
FUNC VOID DIA_Cassia_News_Info()
{
	...
	else 
	{
		...
		AI_Output (self, other, "DIA_Cassia_News_16_07");//Nicménę, tvá pâítomnost tady nám poskytuje nové možnosti...
...
INSTANCE DIA_Cassia_MissingPeople   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Je tu nęco, co mi můžeš âíct o ztracených obyvatelích?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Cassia_Add_15_00"); //Je tu nęco, co mi můžeš âíct o ztracených obyvatelích?
	AI_Output (self, other, "DIA_Addon_Cassia_Add_16_01"); //Proč bys to chtęl vędet?
	AI_Output (other, self, "DIA_Addon_Cassia_Add_15_02"); //Rád bych zjistil, co se jim stalo.
	AI_Output (self, other, "DIA_Addon_Cassia_Add_16_03"); //Když budeš opouštet stoku, plav mírnę doprava po pobreží.
	AI_Output (self, other, "DIA_Addon_Cassia_Add_16_04"); //Tam najdeš odpovędi na své otázky ...
};
...
FUNC VOID DIA_Cassia_Ablehnen_Kill()
{
	...
	AI_Output (self, other, "DIA_Cassia_Ablehnen_Kill_16_01");//To je zlé. Męla jsem dojem, že jsi chytâejší.
...
FUNC VOID DIA_Cassia_Aufnahme_Info()
{
	...
	B_LogEntry (Topic_Diebesgilde,"Byj jsem pâijat do zlodęjského cechu."); 
...
FUNC VOID DIA_Cassia_Blutkelche_Info()
{
	...
	else 
	{
		...
		AI_Output (self, other, "DIA_Cassia_Blutkelche_16_08");//Pâines mi je. Já se zatím pokusím sehnat na nę kupce.
...
INSTANCE DIA_Cassia_abgeben   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "O Krvavých kalichách...";
};
...
{
	AI_Output (other, self, "DIA_Cassia_abgeben_15_00");//O Krvavých kalichách...
	
	if B_GiveInvItems (other, self, ItMi_BloodCup_MIS,6)
	{
		AI_Output (other, self, "DIA_Cassia_abgeben_15_01");//Mám vęch šest kalichů.
		AI_Output (self, other, "DIA_Cassia_abgeben_16_02");//Dobrá práce. Já jsem zatím našel kupce.
		AI_Output (self, other, "DIA_Cassia_abgeben_16_03");//Můžeš hned vzít svou odmęnu. Dík, žes to pro mę udęlal.
