...
instance DIA_Till_WASMACHSTDU  (C_INFO)
{
 ...
 description  =  "Tak co dęláš, když si zrovna nehraješ na pána farmy?";
};
...
func void DIA_Till_BRONKO_Info ()
{
 ...
 if (Npc_IsDead(Sekob)== FALSE)
 {
  AI_Output   (self, other, "DIA_Till_BRONKO_03_05"); //Můj otec je na mę pęknę naštvaný, že jsem ho ještę nedokázal pâinutit, aby se vrátil do práce.
 };
};
