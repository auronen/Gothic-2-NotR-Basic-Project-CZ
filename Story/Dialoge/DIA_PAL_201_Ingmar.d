...
func void DIA_Ingmar_Hallo_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Ingmar_Hallo_06_03"); //Myslel jsem, že sis pâišel promluvit s lordem Hagenem. Męl bys jít dál a popovídat si s ním.
	};
};
///////////////////////////////////////////////////////////////////////
...
func void DIA_Ingmar_ORKELITE_wieso ()
{
	...
	AI_Output (self, other, "DIA_Ingmar_ORKELITE_wieso_06_01"); //Pokud to, co âíkáš, je pravda, tak nás chtęjí oslabit zevnitâ tím, že na nás budou útočit jejich nejlepší válečníci.
...
instance DIA_Ingmar_HAUPTQUARTIER		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Našel jsem hlavní stan skâetů. Jejich vojevůdce padl.";
};
