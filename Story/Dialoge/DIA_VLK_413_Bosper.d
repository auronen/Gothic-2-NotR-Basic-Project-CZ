...
func void DIA_Bosper_HALLO_Info ()
{
	...
	AI_Output (self, other, "DIA_Bosper_HALLO_11_02"); //Co tę pâivádí do Khorinisu?
	
	Log_CreateTopic	(TOPIC_CityTrader,LOG_NOTE);
	B_LogEntry (TOPIC_CityTrader,"Bosper vyrábí luky a obchoduje s kůžemi. Jeho obchod najdu v dolní části męsta, u jižní brány.");
};
...
func void DIA_Bosper_LEHRLING_Info ()
{
	...
	if (MIS_Bosper_WolfFurs == LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Bosper_LEHRLING_11_04"); //Ale Harad tę prý ještę nikdy nevidęl.
		};
		...
		if (Constantino.aivar[AIV_TalkedToPlayer] == TRUE)
		{
			...
			{
				AI_Output (self, other,"DIA_Bosper_LEHRLING_11_09"); //Constantino prohlašuje, žes byl obvinęný ze zločinu - doufám, že šlo jen o nęjakou banalitu.
		...
		if (Matteo.aivar[AIV_TalkedToPlayer] == TRUE)
		{
			...
			{
				AI_Output (self, other,"DIA_Bosper_LEHRLING_11_12"); //A Matteo praví, že by tę męli vyvažovat zlatem.
				stimmen = stimmen + 1;
			}
		...
		{
			AI_Output (self, other,"DIA_Bosper_LEHRLING_11_15"); //Matteo tvrdí, že tę ještę nikdy v životę nevidęl.
		};		
...
func void DIA_Bosper_Job_Info ()
{
	...
	B_LogEntry (TOPIC_BosperWolf,"Musím Bosperovi pâinést šest vlčích kůží - pak pro nęj budu moci pracovat, nebo mę doporučí, abych mohl vstoupit do učení u jiného mistra.");
...
func void DIA_Bosper_BringFur_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Bosper_BringFur_11_01"); //Už jsi vstoupil do učení k jinému mistrovi. Kůže od tebe proto odkoupím už jenom za bęžnou cenu.
	...
	if (B_GiveInvItems (other, self, ItAt_WolfFur, 6))		
	{
		...
		AI_Output (self, other, "DIA_Bosper_BringFur_11_05"); //No a? Co si myslíš? Není to lepší práce, než se celé dny ohánęt mečem nebo se v nevętraném kutlochu patlat s nęjakými lahvičkami?
...
func void DIA_Bosper_TeachFUR_Info ()
{
	...
	if (B_TeachPlayerTalentTakeAnimalTrophy (self, other, TROPHY_Fur))
	{
		...
		AI_Output (self, other, "DIA_Bosper_TeachFUR_11_02"); //Stačí vzít ostrý nůž a rozâíznout zvíâeti bâicho. Pak po stranách trochu naâízni kůži na nohou a můžeš celou kožišinu smęle stáhnout.
		if (MIS_Bosper_WolfFurs == LOG_RUNNING)
		{
...
{
	AI_Output (other, self, "DIA_Bosper_BogenRunning_15_00"); //Slyšel jsem, že tę prý nękdo okradl.
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_01"); //Kdo ti to âekl? Nejspíš Bartok, že? To ti nemohl povędęt nic lepšího? No tak jo.
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_02"); //Âeknu ti, aă se ten hajzl modlí, abych ho nedostal do ruky!
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_03"); //Jen na chviličku jsem odešel z krámu a když jsem se vrátil, spatâil jsem jenom, jak utíká - s mým lukem na rameni.
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_04"); //Okamžitę jsem zavolal stráže, ale ten lump bęžel smęrem k pâístavu. A tam se jim ztratil.
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_05"); //Trochu jsem jim pâipálil koudel u zadku, takže prohledali celou pâístavní čtvră, ale nenašli vůbec nic.
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_06"); //Jsou to prostę mamlasové!
	AI_Output (self, other, "DIA_Bosper_BogenRunning_11_07"); //Vsadím se, že můj luk bude poâád ještę nękde ve męstę. Informoval jsem stráže u obou męstských bran, a tak by nikoho s mým lukem ven nepustili.
...
func void DIA_Bosper_BogenSuccess_Info ()
{
	...
	AI_Output (other, self, "DIA_Bosper_BogenSuccess_15_02"); //V černé díâe plné krys.
	AI_Output (self, other, "DIA_Bosper_BogenSuccess_11_03"); //Doufám, žes s tím nemęl nęjaké trable.
	AI_Output (other, self, "DIA_Bosper_BogenSuccess_15_04"); //Ne - s takovými vęcmi už jsem se vypoâádal dâív.
	AI_Output (self, other, "DIA_Bosper_BogenSuccess_11_05"); //Hm, aă je to, jak chce, dękuji ti. Jsem tvým dlužníkem!
...
func void DIA_Bosper_Aufgaben_Info ()
{
	...
	if (other.guild == GIL_NONE)
	{
		...
		AI_Output (self, other, "DIA_Bosper_Aufgaben_11_05"); //Bohužel tu pro tebe nemám žádný volný pokoj. Ale v hotelu na tržišti tę nękam uložit musí.
	};
	...
	|| (Npc_HasItems(other, ItAt_Addon_KeilerFur) > 0)
	{
		...
		|| (Npc_HasItems(other, ItAt_TrollBlackFur) > 0)
		{
			if (Bosper_TrollFurSold == FALSE)
			{
				...
				AI_Output (self, other, "DIA_Bosper_SellFur_11_08"); //... ta má cenu celého jmęní!
