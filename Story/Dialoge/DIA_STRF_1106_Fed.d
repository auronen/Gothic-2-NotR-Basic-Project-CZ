...
func void DIA_Fed_HALLO_Info ()
{
	...
	AI_Output (other, self, "DIA_Fed_HALLO_15_01"); //Klídek, v pohodę - nikdo po tobę nechce, aby nękam chodil.
...
func void DIA_Fed_Perm_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Fed_Perm_08_02"); //Vypadá to, že se chŕapavci stáhli. Ale to ještę nic neznamená. Oni se vrátí - nebo vlci nebo ještęrani nebo skâeti.
		AI_Output (self, other, "DIA_Fed_Perm_08_03"); //A dâíve či pozdęji nás dostanou a pošmáknou si na našich mrtvolách.
	};
	AI_StopProcessInfos(self);
