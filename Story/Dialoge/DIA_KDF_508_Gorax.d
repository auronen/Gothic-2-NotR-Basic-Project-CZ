...
INSTANCE DIA_Gorax_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Ukrast tento klíč bude zatracenę tęžké)";
};                       
...
instance DIA_Addon_Gorax_DaronsStatue		(C_INFO)
{
	...
	description	 = 	"Mám tady sošku, kterou męl Daron doručit do kláštera.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Gorax_DaronsStatue_15_00"); //Mám tady sošku, kterou męl Daron doručit do kláštera.
	
	if (Npc_HasItems (other,ItMi_LostInnosStatue_Daron))
	{
		AI_Output	(self, other, "DIA_Addon_Gorax_DaronsStatue_14_01"); //(povzdychne) Je to hanebné, že takový vzácný kus sem musí pâinést novic.
		AI_Output	(self, other, "DIA_Addon_Gorax_DaronsStatue_14_02"); //A pâece, je to svędectví o tvém odhodlaní sloužit Innosovi.
		...
		AI_Output	(self, other, "DIA_Addon_Gorax_DaronsStatue_14_03"); //Buë si jistý mou vdęčností, mladý novici.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Gorax_DaronsStatue_14_04"); //Soška? Nevidím žádnou sošku. Dones mi ji a já budu veâit tvému malému pâíbehu.
	};
};
...
instance DIA_Gorax_Wurst		(C_INFO)
{
	...
	permanent	 =  TRUE;
	description	 = 	"Rozdęlil jsem ty klobásy.";
};
...
func void DIA_Gorax_Aufgabe2_Info ()
{
	...
	B_LogEntry (Topic_GoraxWein,"Mistr Gorax chce, abych hospodskému Orlanovi doručil dvanáct lahví vína. Cena za kus činí 240 zlaăáků.");
};
///////////////////////////////////////////////////////////////////////
//	Info Orlan
///////////////////////////////////////////////////////////////////////
