...
FUNC VOID DIA_Jorgen_DI_Hallo_Info()
{
	...
	if (ORkSturmDI == FALSE)
	{
		AI_Output (self ,other,"DIA_Jorgen_DI_Hallo_07_01"); //Jasnę že jo - aspoŕ dokud se ty potvory od nás drží dál.
	}
	else
	{
		AI_Output (self ,other,"DIA_Jorgen_DI_Hallo_07_02"); //Další podobný skâetí útok už nepâežijeme, takže si pospęš - musíme odsud rychle zmizet.
...
func void DIA_Jorgen_DI_UndeadDragonDead_Info ()
{
	...
	AI_Output			(self ,other, "DIA_Jorgen_DI_UndeadDragonDead_07_01"); //To je dobrá zpráva. Víc už jsme na tomhle ostrovę udęlat nemęli?

	Info_ClearChoices	(DIA_Jorgen_DI_UndeadDragonDead);
	Info_AddChoice	(DIA_Jorgen_DI_UndeadDragonDead, "Ještę minutku - musím si tu nęco zaâídit.", DIA_Jorgen_DI_UndeadDragonDead_moment );
...
{
	AI_Output			(other, self, "DIA_Jorgen_DI_UndeadDragonDead_moment_15_00"); //Ještę minutku - musím si tu nęco zaâídit.
	AI_Output			(self, other, "DIA_Jorgen_DI_UndeadDragonDead_moment_07_01"); //Tak dobâe, ale pospęš si.
	AI_StopProcessInfos (self);
};
