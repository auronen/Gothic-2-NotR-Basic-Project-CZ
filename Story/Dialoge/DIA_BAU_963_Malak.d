...
instance DIA_Malak_PALADINE  (C_INFO)
{
 ...
 description  =  "Rád bych se dozvędęl nęco o paladinech.";
};
...
instance DIA_Malak_BACKTOBENGAR  (C_INFO)
{
 ...
 description  =  "Bengar tę potâebuje.";
};
...
func void DIA_Malak_BACKTOBENGAR_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Malak_BACKTOBENGAR_08_01"); //Nejsem blázen. Dokud nebude farma dobâe zabezpečena, nehodlám odsud vystrčit nos!
 ...
 AI_Output   (self, other, "DIA_Malak_BACKTOBENGAR_08_05"); //(zvędavę) Mmh. Asi neni šance, že bys mi to âekl, co?
