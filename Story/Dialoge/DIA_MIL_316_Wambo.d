...
{	
	AI_Output (other,self ,"DIA_Wambo_Job_15_00"); //Co tady dęláš?
	AI_Output (self ,other,"DIA_Wambo_Job_03_01"); //Starám se o to, aby nikdo nevešel dovnitâ.
...
INSTANCE DIA_Wambo_Ramirez(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Pâicházím od našeho společného pâítele Ramireze.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Wambo_Ramirez_15_00"); //Pâicházím od našeho společného pâítele Ramireze.
	AI_Output (self ,other,"DIA_Wambo_Ramirez_03_01"); //Cože? Ten Ramirez je pękná krysa. A není žádný můj pâítel. To je jedno. Pâinášíš mi nęco?
	AI_Output (other,self ,"DIA_Wambo_Ramirez_15_02"); //To záleží na tom, co chceš.
	AI_PlayAni (self, "T_SEARCH");
	AI_Output (self ,other,"DIA_Wambo_Ramirez_03_03"); //(tiše) Dobrá, âeknu ti, jak to chodí. Zaplatíš 250 zlatých. Pak tady v noci nebudu.
	AI_Output (self ,other,"DIA_Wambo_Ramirez_03_04"); //Pokud bys ale byl pâíliš nápadný a já tady pâece jenom byl, tak z obchodu sešlo.
};
//*************************************************************
//	Deal
//*************************************************************
INSTANCE DIA_Wambo_Deal(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Zaplatit 250 zlaăáků)";
};                       
//-----------------------------------
...
{	
	...
	if B_GiveInvItems (other, self, ItMi_Gold, 250)
	{
		...
		AI_Output (self ,other,"DIA_Wambo_Deal_03_02"); //A nezapomeŕ - kdybys dęlal nęjaké problémy, tak tę neznám.
	...
	else
	{
		...
		AI_Output (self ,other,"DIA_Wambo_Deal_03_04"); //Nesnáším, když ze mę nękdo dęlá šaška. Tak pâines to zlato.
		AI_StopProcessInfos (self);
	};
};
