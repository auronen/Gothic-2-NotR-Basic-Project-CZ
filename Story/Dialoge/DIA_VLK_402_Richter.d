...
FUNC VOID DIA_Richter_Hello_MayBe ()
{
	...
	AI_Output (self ,other,"DIA_Richter_Hello_MayBe_10_03"); //A teë mi ztraă z očí!
...
{	
	...
	else
	{
		...
		AI_Output (self ,other,"DIA_Richter_Perm_10_07"); //Tak to samozâejmę doufám, že ti to došlo teë.
	};
};
...
{	
	...
	AI_Output (self ,other,"DIA_Richter_KillMorgahard_10_01"); //Jsem opravdu pâekvapen. Ty to myslíš vážnę, co? Tady je tvá odmęna.
...
{	
	...
	AI_Output (self ,other,"DIA_Richter_KilledMorgahard_10_01"); //Á. Jsi dobrej chlap. Tady je tvá odmęna.
...
{	
	...
	AI_Output (self ,other,"DIA_Richter_PermissionForShip_10_06"); //Toho budeš litovat. Nikdo mę nebude vydírat, aniž by z toho vyváz se zdravou kůží.
	AI_Output (self ,other,"DIA_Richter_PermissionForShip_10_07"); //Tady je to tvé oprávnęní. A teë vypadni. Vyâídím si to s tebou pozdęji.
