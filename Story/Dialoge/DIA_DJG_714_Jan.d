...
{		
		...
		AI_Output (self ,other,"DIA_Jan_Dragons_10_02"); //Dęlám zbranę. Bojování pâenechávám nękomu jinému.
		...
		Info_AddChoice (DIA_JAN_Dragons,"Męl bych si hledęt svého.",DIA_JAN_Dragons_ShitHappen);
...
{	
	...
	B_LogEntry (TOPIC_JanBecomesSmith,"Drakobijec Jan z hradu v Hornickém údolí chce pracovat v kovárnę. Parcival mu to ale nechce dovolit."); 
...
INSTANCE DIA_JAN_OldCamp (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Co všechno se na hradę stalo?";
};                       
...
{		
		...
		if (hero.guild == GIL_PAL)
		{
			AI_Output (self ,other,"DIA_Jan_SellWeapons_10_01"); //To víš. A pak mę tví kolegové šoupnou za mâíže za černej obchod, co? Ne, zapomeŕ na to.
		}
		else
		{
...
instance DIA_Jan_DJG_ARMOR_M		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 =	"Stâední drakobijecká zbroj: ochrana: zbranę 120, šípy 120 (12000 zlaăáků)"; //Wenn ändern, dann bitte auch in der Info-Instanz. s.u.
};
...
func void DIA_Jan_DragonPlettBericht_Info ()
{
	...
	&& (hero.guild != GIL_SLD)
	{
		...
		AI_Output (self, other, "DIA_Jan_DragonPlettBericht_10_08"); //Pokud bys mi chtęl pâinýst nęjakou dračí krev, slušnę ti za ni zaplatím.
