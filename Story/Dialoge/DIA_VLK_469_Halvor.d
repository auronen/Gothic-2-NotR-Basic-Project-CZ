...
{
	AI_Output (self, other, "DIA_Halvor_Night_06_00"); //Hej, jestli máš zájem o mé ryby, pâijë do mého stánku zítra, dobrá?
};
...
instance DIA_Addon_Halvor_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Âekl bys mi nęco o ztracených lidech, tedy pokud o tom nęco víš?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Halvor_MissingPeople_15_00"); //Âekl bys mi nęco o ztracených lidech, tedy pokud o tom nęco víš?
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_01"); //Ztracení lidé? Chlape, tohle je pâístavištę. Jak asi víš, nękdo se tu občas ztratí.
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_02"); //Moâe se s nikým nepatlá. Je to tak, buë je nęjakej ten útes nebo moâská obluda a hned je koho hledat.
	...
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_04"); //A když už nebyli dobrovolníci vyplul, po chvíli se nęco stalo a po lodi ani vidu ani slechu.
	...
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "Jaká loë to byla?", DIA_Addon_Halvor_MissingPeople_schiff );
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "Víš nęco o lidech, kteâí zmizeli?", DIA_Addon_Halvor_MissingPeople_wer );
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "A TY postrádáš nękoho?", DIA_Addon_Halvor_MissingPeople_you );
};
...
{
	AI_Output			(other, self, "DIA_Addon_Halvor_MissingPeople_wer_15_00"); //Víš nęco o lidech, kteâí zmizeli?
	AI_Output			(self, other, "DIA_Addon_Halvor_MissingPeople_wer_06_01"); //Nic moc. Zeptej stavitelů lodí.

	Log_CreateTopic (TOPIC_Addon_WhoStolePeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_WhoStolePeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_WhoStolePeople,"Halvorovi není moc do âeči, proto mę poslal k rybáâům."); 
};
func void DIA_Addon_Halvor_MissingPeople_schiff ()
{
	AI_Output			(other, self, "DIA_Addon_Halvor_MissingPeople_schiff_15_00"); //Jaká loë to byla?
	AI_Output			(self, other, "DIA_Addon_Halvor_MissingPeople_schiff_06_01"); //Dobrá otázka. Nedávno tu nebylo moc lodí.
};
func void DIA_Addon_Halvor_MissingPeople_you ()
{
	AI_Output			(other, self, "DIA_Addon_Halvor_MissingPeople_you_15_00"); //A TY postrádáš nękoho?
...
INSTANCE DIA_Halvor_Hehlerei   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "(Prodat staré tallíâe a kalichy.)";
};
...
FUNC VOID DIA_Halvor_Hehlerei_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Halvor_Zeichen_06_04");//Promiŕ, dneska už žádné obchody. Vraă se zítra, dobrá?
	};
