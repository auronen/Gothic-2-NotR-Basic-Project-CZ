...
func void DIA_Rega_HALLO_Info ()
{
 ...
 if ((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL))
  {
   AI_Output   (self, other, "DIA_Rega_HALLO_17_01"); //Ty jsi z męsta, co?
  }
 else if ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
  {
   AI_Output   (self, other, "DIA_Rega_HALLO_17_02"); //Jsi jeden z tęch Onarových žoldáků, co?
  }
 ...
 if (Kapitel < 3)
  {
   AI_Output   (self, other, "DIA_Rega_HALLO_17_09"); //Banditi jsou úplnę všude, polní škůdci ničí veškerou úrodu a z velkostatkáâe se stal pęknej kruăas.
  };
};
...
func void DIA_Rega_ONAR_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Rega_ONAR_17_01"); //Se vsaë. Když se mu nelíbí nęčí ksicht, pošle na nęj svý žoldáky. To je taky poslední chvíle, kdy toho nebožáka nękdo uvidí.
 AI_Output   (self, other, "DIA_Rega_ONAR_17_02"); //Takže radęj držíme zobák.
...
func void DIA_Rega_SLD_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Rega_SLD_17_01"); //Nevím, za co jsou placení, ale určitę ne za pomoc nám, obyčejným lidem.
 AI_Output   (self, other, "DIA_Rega_SLD_17_02"); //Problém s polními škůdci je teë na malých farmáâích, co si pronajali od Onara půdu.
...
func void DIA_Rega_BANDITEN_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Rega_BANDITEN_17_01"); //Nijak. Prostę utečeme. Ještę nęco?
...
func void DIA_Rega_BRONKO_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Rega_BRONKO_17_01"); //Nepâeber si to špatnę, ale nechci se dostat do potíží. Zeptej se nękoho jinýho.
...
func void DIA_Rega_PERMKAP1_Info ()
{
 AI_Output   (other, self, "DIA_Rega_PERMKAP1_15_00"); //No tak, trochu kuráže.
  ...
  if ((hero.guild == GIL_MIL) || (hero.guild == GIL_PAL))
  {
   AI_Output   (self, other, "DIA_Rega_PERMKAP1_17_01"); //Tobę se to mluví. Ty pâece bydlíš ve męstę.
  }
  else if ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
  {
  ...
  {
   AI_Output   (self, other, "DIA_Rega_PERMKAP1_17_03"); //Mágů je tu poâád míŕ a míŕ. Doufám, že ty nejsi poslední. Potâebujeme vás - víc než kdykoli jindy.
  }
  else
  {
