...
FUNC VOID DIA_Addon_Telbor_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_01");//Hej, můj zachránce! Ale teë se musím dát zase dohromady.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_02");//Hlavnę když teë dęlám s tęmito dvęma šílenými bratry. Chlape, myslíš, že to bylo opravdu tak špatné u tęch banditů?
	};
};
