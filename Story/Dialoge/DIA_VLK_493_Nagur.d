...
///////////////////////////////////////////////////////////////////////
	...
	func void B_Nagur_Abfertigen()
	{
		...
		AI_Output (self ,other,"DIA_Nagur_Add_08_03"); //(spiklenecky) Ty rád strkáš nos co vęcí, do kterých ti nic není, co?!
...
FUNC VOID DIA_Nagur_Job_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Nagur_Job_08_01");//(zkoumavę) Dobrá, dobrá, tak ty se poohlížíš po nęjaké speciální pâácičce. Ale hraje se podle mejch pravidel, jasný?
...
INSTANCE DIA_Nagur_Auftraggeber   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kdo jsou tví zamęstnanci?";
};
