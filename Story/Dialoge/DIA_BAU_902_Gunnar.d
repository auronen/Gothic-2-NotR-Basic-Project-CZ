...
FUNC VOID DIA_Gunnar_Hallo_Info()
{
 ...
 {
  AI_Output (self, other, "DIA_Gunnar_Hallo_10_01"); //Od té doby, co Onar vyhlásil, že si najal žoldnéâe, poflakuje se na dvoâe akorát tak banda ničemných darebáků.
  AI_Output (self, other, "DIA_Gunnar_Hallo_10_02"); //Všechna ta chátra, co nemęla co do huby, se vyrojila z lesa ještę pâed tím, než jsme sem pâišli my.
  AI_Output (self, other, "DIA_Gunnar_Hallo_10_03"); //Ty bastardi vážnę vylejzaj snad odevšad.
 };
 ...
 || (other.guild == GIL_PAL)
 {
  AI_Output (self, other, "DIA_Gunnar_Hallo_10_06"); //Tady nejsou lidi z męsta vítáni.
 };
...
INSTANCE DIA_Gunnar_Everywhere   (C_INFO)
{
 ...
 permanent   = TRUE;
 description = "Kde se tu vzalo tolik žoldnéâů?";
};
...
{
 AI_Output (other, self, "DIA_Gunnar_Everywhere_15_00"); //Kde se tu vzalo tolik žoldnéâů?
 AI_Output (self, other, "DIA_Gunnar_Everywhere_10_01"); //Vętšina z nich je z trestanecké kolonie.
 AI_Output (self, other, "DIA_Gunnar_Everywhere_10_02"); //Další skupina žoldnéâů pochází odnękud z jihu, kde nejspíš lovili skâety.
 AI_Output (self, other, "DIA_Gunnar_Everywhere_10_03"); //A vsadím se, že se tu teë taky objevilo nękolik banditů z hor, aby se mohli zadarmo najíst!
};
...
FUNC VOID DIA_Gunnar_South_Info()
{
 ...
 AI_Output (self, other, "DIA_Gunnar_South_10_02"); //Sylvio je jejich šéf. Bullco, Sentenza, Raoul a nękolik dalších pro nęj pracuje.
};
...
INSTANCE DIA_Gunnar_Colony (C_INFO)
{
 ...
 permanent   = TRUE;
 description = "Kdo všechno pâišel z kolonie?";
};
...
FUNC VOID DIA_Gunnar_Colony_Info()
{
 ...
 AI_Output (self, other, "DIA_Gunnar_Colony_10_01"); //Lee a jeho lidé. Torlof, Cord, Jarvis, Wolf a buhvíkdo ještę.
};
...
FUNC VOID DIA_Gunnar_Bandits_Info()
{
 ...
 AI_Output (self, other, "DIA_Gunnar_Bandits_10_02"); //Na jihu údolí jsou hory s opuštęnými doly. Ukrývá se tam nękolik banditů.
 ...
 AI_Output (self, other, "DIA_Gunnar_Bandits_10_04"); //Jedinej rozdíl mezi nima je, že jsou ještę horší bahno. Zabijou každýho, kdo se k nim pâiblíží.
};
