...
FUNC VOID DIA_Addon_Patrick_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_01");//Skvęle. Mágové Vody nám pomohli dostat se bezpečnę z tohoto prokletého údolí.
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_02");//A co máš teë v plánu?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_03");//Opęt se pâidám k Leemu a jednoho dne opustíme tento ostrov ...
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_04");//A pak?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_05");//Uvidíme. Jestli bude stále zuâit válka, budu bojovat se skâety. Ale to bude až potom.
};
