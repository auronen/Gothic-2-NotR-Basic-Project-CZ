...
{
	AI_Output (self, other, "DIA_Salandril_PERM_13_00"); //Vítej, poutníku, hledáš nęjaký dobrý lektvar?
	AI_Output (self, other, "DIA_Salandril_PERM_13_01"); //U mę najdeš velký výbęr za pâijatelné ceny, a mé lektvary jsou mnohem lepší než ty patoky, které prodává Zuris.
...
{
	AI_Output (self, other, "DIA_Salandril_Trank_13_00"); //Slyšel jsem, že ses s paladiny vypravil do Hornického údolí. To na mę udęlalo dojem.
	AI_Output (self, other, "DIA_Salandril_Trank_13_01"); //Męl by sis vyšetâit chvilku a prohlédnout si mé zboží - zrovna ti mohu nabídnout jeden velmi zvláštní lektvar.
...
func void DIA_Salandril_Trade_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Salandril_Trade_13_01"); //Je mi potęšením, ctihodný bratâe.
	...
	{
		AI_Output (self, other, "DIA_Salandril_Trade_13_02"); //Je mi potęšením, šlechetný válečníku.
	};
};
...
func void DIA_Salandril_KLOSTER_Info ()
{
	...
	AI_Output			(self, other, "DIA_Salandril_KLOSTER_13_01"); //Cože? To jako abych zvednul zadek? Houby s octem! Ti mizerní mágové proti mnę nemají jediný důkaz!
	...
	{
		AI_Output			(other, self, "DIA_Salandril_KLOSTER_15_03"); //Mám své pâíkazy a ty taky vyplním. Takže buë půjdeš po dobrém, nebo po zlém.
	};
	AI_Output			(self, other, "DIA_Salandril_KLOSTER_13_04"); //Cože? Klidnę tę pâes męsto potáhnu za límec jako kus špinavého hadru!
	AI_StopProcessInfos (self);
...
instance DIA_Salandril_GehinsKloster		(C_INFO)
{
	...
	description	 = 	"Tak půjdeš teë do toho kláštera, nebo chceš ještę jednu?";
};
...
{
	AI_Output			(other, self, "DIA_Salandril_GehinsKloster_15_00"); //Tak půjdeš teë do toho kláštera, nebo chceš ještę jednu?
	AI_Output			(self, other, "DIA_Salandril_GehinsKloster_13_01"); //Toho budeš litovat. Jo, ksakru, půjdu do toho pitomýho kláštera, ale nemysli si, že je to vyâízené.
	AI_StopProcessInfos (self);
