...
func void DIA_Pal_213_Schiffswache_FirstWarn_Info()
{
	...
	AI_Output (other, self,"DIA_Pal_213_Schiffswache_FirstWarn_15_01"); //Chtęl jsem...
	...
	{	
		AI_Output (self, other,"DIA_Pal_213_Schiffswache_FirstWarn_01_03"); //Tady není nic k vidęní. Pokračuj.
	};
...
func void DIA_Pal_213_Schiffswache_SecondWarn_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Pal_213_Schiffswache_SecondWarn_01_01"); //Nechceš mę snad NUTIT, abych ti ublížil, ne?
	};
	other.aivar[AIV_LastDistToWP] 			= Npc_GetDistToWP (other,Pal_213_Checkpoint);
...
FUNC VOID DIA_Pal_213_Schiffswache_GoOnBoard_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_GoOnBoard_01_03"); //Ve jménę Innosovę, budu loë chránit svým vlastním životem.
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmKDF   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Ty zpochybŕuješ pâání mágů ohnę?";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF_15_00"); //Ty zpochybŕuješ pâání mágů ohnę?
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_01"); //(nervóznę) Ne, to samozâejmę ne. Snad mi Innos odpustí.
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_02"); //(nervóznę) Ohniví mágové jsou strážci Innosovy moudrosti...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_03"); //(nervóznę)... a kdo pochybuje o jejich činech, pochybuje o Innosovi a nezaslouží si slitování.
};
...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF2_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF2_01_01"); //(nervóznę) Zabiju... tedy, zastavím tę.
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmKDF3   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Ty bys zaútočil na mága ohnę?";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF3_15_00"); //Ty bys zaútočil na mága ohnę?
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF3_01_01"); //(nervóznę) Nikdy bych nevztáhl ruku na mága.
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF3_15_02"); //Takže co by se stalo, kdybych šel na palubu?
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF3_01_03"); //(pokornę) Nic, pane.
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmKDF4   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Půjdu teë na palubu.";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF4_15_00"); //Půjdu teë na palubu.
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF4_01_01"); //(nervóznę) To nesmíš, rozkazy lorda Hagena byly v tomto smęru naprosto jasné.
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmKDF5   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Vztahují se rozkazy lorda Hagena i na mę?";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF5_15_00"); //Vztahují se rozkazy lorda Hagena i na mę?
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF5_01_01"); //(nervóznę) To nevím.
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF5_01_03"); //Tomu nevęâím.
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmKDF6   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Takže naposledy: Pusă mę na tu loë!";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF6_15_00"); //Takže naposledy: Pusă mę na tu loë!
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF6_01_01"); //(nervóznę) Rozumím. Můžeš na palubu.
...
INSTANCE DIA_Pal_213_Schiffswache_IAmPAL   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Copak mi nevęâíš, rytíâi?";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmPAL_15_00"); //Copak mi nevęâíš, rytíâi?
...
INSTANCE DIA_Pal_213_Schiffswache_IAmPAL2   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Pak bys asi męl vędęt, kdo z nás má vyšší hodnost.";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmPAL2_15_00"); //Pak bys asi męl vędęt, kdo z nás má vyšší hodnost.
...
INSTANCE DIA_Pal_213_Schiffswache_IAmPAL3   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Tímto ti pâikazují, abys mi umožnil vstup na loë.";
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmDJG   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "A nešlo by s tím nęco udęlat?";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmDJG_15_00"); //A nešlo by s tím nęco udęlat?
...
INSTANCE DIA_Pal_213_Schiffswache_IAmDJG2   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Mohl bych ti dát nęjaké peníze. Za to, že se budeš zrovna dívat na druhou stranu.";
};
...
{
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmDJG2_15_00"); //Mohl bych ti dát nęjaké peníze. Za to, že se budeš zrovna dívat na druhou stranu.
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmDJG2_01_01"); //Není možné mę uplatit, a jestli okamžitę nezmizíš, budu to brát jako urážku.
};
