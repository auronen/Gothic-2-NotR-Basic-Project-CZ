...
func void DIA_Hodges_HALLO_Info ()
{
 ...
 AI_Output (other, self, "DIA_Hodges_HALLO_15_02"); //Jsi strašnę zamęstnaný, co?
...
func void DIA_Hodges_BennetsCrime_Info ()
{
 ...
 AI_Output (self ,other,"DIA_Hodges_BennetsCrime_03_05"); //Však víš, Onar a męsto. To by dopadlo špatnę.
...
instance DIA_Hodges_BennetAndSLD   (C_INFO)
{
 ...
 permanent   =  FALSE;
 description  =  "Co na to žolnéâi tady na farmę?";
};
...
{
 AI_Output (other,self ,"DIA_Hodges_BennetAndSLD_15_00"); //Co na to žolnéâi tady na farmę?
 AI_Output (self ,other,"DIA_Hodges_BennetAndSLD_03_01"); //Jasnę, že nevím, co maj za lubem, ale nękterý z nich jsou fakt vytočený.
 AI_Output (other,self ,"DIA_Hodges_BennetAndSLD_15_02"); //To je pochopitelné.
 AI_Output (self ,other,"DIA_Hodges_BennetAndSLD_03_03"); //Kdyby to bylo jen na nich, radęji by hned napadli męsto, aby dostali Benneta ven.
