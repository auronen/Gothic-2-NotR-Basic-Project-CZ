...
{	
	...
	Info_AddChoice (DIA_Fester_Together, "Rád bych vidęl nęjaké prašule!", DIA_Fester_Together_Gold);
...
{	
	...
	{
		AI_Output (self, other, "DIA_Fester_TogetherNOW_08_01"); //Potmę? Ne ne, radši bychom to męli udęlat ve dne.
	}
	else
	{
...
{	
	...
	{
		AI_Output (self, other, "DIA_Fester_WasMitAbmachung_08_02"); //No, můžu ti pomoct, abychom tę vzali mezi sebe, ale neudęlám to.
	...
	{
		AI_Output (self, other, "DIA_Fester_WasMitAbmachung_08_07"); //Hej, tys chtęl tęžit z mé situace. Takže teë zase trochu já zneužiju té tvé.
		AI_Output (self, other, "DIA_Fester_WasMitAbmachung_08_08"); //Ber to ale z té lepší stránky: získals cennou zkušenost, a to za to pâece stojí, ne?
	};
