...
FUNC VOID DIA_Jesper_Hallo_Willkommen()
{
	...
	AI_Output (self, other,"DIA_Jesper_Hallo_Willkommen_09_02");//Bęž se podívat na Cassiu. Jsi očekáván.
...
FUNC VOID DIA_Jesper_Hallo_Anfuehrer()
{
	...
	AI_Output (self, other,"DIA_Jesper_Hallo_Anfuehrer_09_01");//(oplzlý smích) HA - můj vůdce? Jsem si jist, že s tebou Cassia bude chtít mluvit.
...
INSTANCE DIA_Jesper_Schleichen   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Nauč mę umęní plížení.";
};
//--------------------------------------
...
{
	AI_Output (other, self, "DIA_Jesper_Bogen_15_00");//Hele, co víš o Bosperovę luku?
	AI_Output (self, other, "DIA_Jesper_Bogen_09_01");//Myslíš ten luk od šípaâe? Jo, mám ho nękde zahrabanej nahoâe v truhle.
	AI_Output (self, other, "DIA_Jesper_Bogen_09_02");//Ale pobíhá tam kolem spousta krys. Můžeš si pro nęj dojít, jestli ti ty potvory nevadęj.
	AI_Output (self, other, "DIA_Jesper_Bogen_09_03");//Ó, samozâejmę je ta truhla zamčená. Musíš se do ní vloupat. (chechtá se) S trochou štęstí ti budou tvoje šperháky stačit.
