...
{
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_00");//Proč jsi mę vzbudil? Vsadím se, že ani nevíš proč ...
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_01");//Ne, neodpovídej. Je pozdę na prominutí.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_02");//Máš dvę možnosti. Bojuj proti mnę a mé Betty, nebo se pokus o útęk.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_03");//Na tvém místę bych se pokusil o útęk ...
...
FUNC VOID DIA_Addon_Skinner_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Skinner_Attentat_08_01");//Co ode mnę chceš?
