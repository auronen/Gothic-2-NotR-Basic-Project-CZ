...
func void DIA_Sagitta_HALLO_was ()
{
 ...
 AI_Output   (self, other, "DIA_Sagitta_HALLO_was_17_02"); //Les je mým pâítelem. Poskytujeme mi vše, co potâebuju.
...
func void DIA_Sagitta_HALLO_Heil ()
{
 ...
 AI_Output   (self, other, "DIA_Sagitta_HALLO_Heil_17_01"); //To je to, proč jsi tady, že? Tak povídej, co je v nepoâádku.
...
func void DIA_Sagitta_TeachAlchemyRequest_was ()
{
 ...
 AI_Output   (self, other, "DIA_Sagitta_TeachAlchemyRequest_was_17_01"); //Je to nesmírnę vzácná rostlina - âíká se jí sluneční aloe. Poznáš ji podle pronikavé mandlové vůnę.
...
func void DIA_Sagitta_TeachAlchemyRequest_wo ()
{
 ...
 AI_Output   (self, other, "DIA_Sagitta_TeachAlchemyRequest_wo_17_03"); //To je ten důvod, proč je pro mę tak obtížné tu kytku získat.
...
func void DIA_Sagitta_HEAL_Info ()
{
 ...
 {
  AI_Output   (self, other, "DIA_Sagitta_HEAL_17_02"); //V týhle chvíli nepotâebuješ žádné léčení.
 };
};
...
func void DIA_Sagitta_HEALRANDOLPH_Info ()
{
 ...
 if(DIA_Sagitta_HEALRANDOLPH_GotOne == TRUE)
  {
   AI_Output   (self, other, "DIA_Sagitta_HEALRANDOLPH_17_02"); //Už jsem ti pro nęj pâichystala dávku. Tak se s tím nikde moc nepoflakuj.
  }
 else
  {
