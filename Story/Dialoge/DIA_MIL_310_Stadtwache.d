...
{
	AI_Output (other, self,"DIA_Mil_310_Stadtwache_ZumSchmied_15_00"); //Potâebuji jít za kováâem. Opravit nęjaké nástroje.
...
FUNC VOID DIA_Addon_Mil_310_Stadtwache_Constantino_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_01"); //(úskočnę) Aha? Pokud je to tak, ukaž mi co neseš.
		...
		{
			AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_02"); //(souhlasnę) Hmm. Vše v poâádku. Stačí. Můžeš jít dovnitâ. Ale nedęlej žádné problémy, jasné?
		...
		else 
		{
			...
			{
				AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_04"); //Co by alchymista dęlal s touhle âepou? Dęláš ze mę blbce? Odprejskni!
			}
			else 
			{
				AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_05"); //Já toho sice o alchymii moc nevím, ale na tenhle trapný, zašnęrovaný balík zeleniny můžeš zapomenout. Táhni!
			};	
		};
	}
	else
	{
		AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_06"); //Jaké byliny? Ty nemáš žádné byliny! Vodpal!
	};
...
INSTANCE DIA_Mil_310_Stadtwache_Paladine (C_INFO)
{
	...
	permanent 	= FALSE;
	description	= "Potâebuji mluvit s vůdcem paladinů!";
};
...
FUNC VOID DIA_Mil_310_Stadtwache_Paladine_Info()
{
	...
	Info_AddChoice    (DIA_Mil_310_Stadtwache_Paladine,"V khorinisském údolí se shromažëují síly zla!",DIA_Mil_310_Stadtwache_Paladine_EvilArmy);
...
{
	AI_Output (other, self,"DIA_Mil_310_Stadtwache_Paladine_EvilArmy_15_00"); //V khorinisském údolí se shromažëují síly zla!
	...
	Info_AddChoice    (DIA_Mil_310_Stadtwache_Paladine,"Ano. Byl jsem v khorinisském údolí. Vidęl jsem nękolik obâích draků!",DIA_Mil_310_Stadtwache_Paladine_YesDragons);
};
...
{
	AI_Output (other, self,"DIA_Mil_310_Stadtwache_Paladine_YesDragons_15_00"); //Ano. Byl jsem v khorinisském údolí. Vidęl jsem nękolik obâích draků!
