...
{
 AI_Output (self, other, "DIA_Wasili_HALLO_01_00"); //Neodvažuj se ani pomyslet na to, že bys tu mohl nęco ukrást. Jinak slízneš ránu do hlavy, jasný?
};
...
func void DIA_Wasili_Job_Info ()
{
 ...
 AI_Output (self, other, "DIA_Wasili_Job_01_01"); //Onar po mnę chce, abych celý den dohlížel na jeho vęci.
 AI_Output (self, other, "DIA_Wasili_Job_01_02"); //Dęlá si starosti, že se nęco pokazí. A já taky - na tomhle místę...
 AI_Output (self, other, "DIA_Wasili_Job_01_03"); //Vętšina z tęch žoldáků, co najal, jsou bývalí vęzni z trestanecké kolonie.
 AI_Output (self, other, "DIA_Wasili_Job_01_04"); //Když se nikdo z nás nekouká, odnesou všechno, co není pâišroubovaný.
};
...
func void DIA_Wasili_Sammler_Info ()
{
 ...
 AI_Output (self, other, "DIA_Wasili_Sammler_01_01"); //Jo, a spousta z nęj je hodnę drahá. Onar sbírá cennosti.
 AI_Output (self, other, "DIA_Wasili_Sammler_01_02"); //Obyčejný človęk jako já si takový luxus nemůže dovolit. Záleží mi na jiných vęcech.
...
func void DIA_Wasili_FirstOldCoin_Info ()
{
 ...
 {
  AI_Output   (self, other, "DIA_Wasili_FirstOldCoin_01_03"); //Dám ti za nę zlaăák. Pâesnę tolik, jaká je jejich hodnota.
 }
 else
 {
  AI_Output   (self, other, "DIA_Wasili_FirstOldCoin_01_04"); //Ty moc dobâe víš, kolik jsem za nę ochoten zaplatit, ty pse. Jeden zlatý. Nic víc.
 };
...
func void DIA_Wasili_FirstOldCoin_ok ()
{
 ...
 {
  AI_Output   (self, other, "DIA_Wasili_FirstOldCoin_ok_01_03"); //Kdybys jich męl takových víc, víš, kde mę najdeš.
...
func void DIA_Wasili_FirstOldCoin_mehr ()
{
 ...
 {
  AI_Output   (self, other, "DIA_Wasili_FirstOldCoin_mehr_01_02"); //Arrh. Sakra. Dobrá. 2 zlaté za každou starou minci, kterou mi pâineseš. To je moje poslední nabídka.
  WasilisOldCoinOffer = 2;
  Info_AddChoice (DIA_Wasili_FirstOldCoin, "V tom pâípadę nejsou 3 tak špatné.", DIA_Wasili_FirstOldCoin_ZumTeufel );
 };
};
...
{
 AI_Output   (other, self, "DIA_Wasili_FirstOldCoin_ZumTeufel_15_00"); //V tom pâípadę nejsou 3 tak špatné.
...
func void DIA_Wasili_BringOldCoin_Info ()
{
 ...
 AI_Output   (self, other, "DIA_Wasili_BringOldCoin_01_01"); //Jasnę. Máš ještę nęjaké?
 ...
 AI_Output   (self, other, "DIA_Wasili_BringOldCoin_01_04"); //Díky. Tady jsou tvoje peníze. Pâines mi všechno, co najdeš.
...
instance DIA_Wasili_PERM (C_INFO)
{
 ...
 permanent = TRUE;
 description = "Už se nękdo pokusil nęco ukrást?";
};
...
{
 AI_Output (other, self, "DIA_Wasili_PERM_15_00"); //Už se nękdo pokusil nęco ukrást?

 if (Kapitel <= 2)
 {
  if (PETZCOUNTER_Farm_Theft > 0)
  {
   AI_Output (self, other, "DIA_Wasili_PERM_01_01"); //Myslíš kromę tebe?
  };
 ...
 if (Kapitel == 3)
 {
  AI_Output (self, other, "DIA_Wasili_PERM_01_03"); //Pâed pár dny se v noci jeden ze žoldnéâů plížil po domę.
  AI_Output (self, other, "DIA_Wasili_PERM_01_04"); //Męl na sobę černou róbu s kapucí, takže jsem ho nemohl poznat.
  AI_Output (self, other, "DIA_Wasili_PERM_01_05"); //Ale pâinutil jsem ho, aby utekl.
 };
 ...
 if (kapitel >= 5)
 {
  AI_Output (self, other, "DIA_Wasili_perm_01_07"); //Ti žoldnéâi vypadají, jako by byli pâipraveni rozbít tábor.
  AI_Output (self, other, "DIA_Wasili_perm_01_08"); //Je mi jedno, jestli Lee se svými hochy pâes noc opustí ostrov.
 };
};
