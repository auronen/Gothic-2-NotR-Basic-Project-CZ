...
func void DIA_Engrom_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_01"); //Mizernę!
	AI_Output			(other, self, "DIA_Engrom_HALLO_15_02"); //Mmh!
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_03"); //Co můžu âíct. Celé dny nemůžeš koukat na nic jiného než na tuhle zatracenou âeku.
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_04"); //Nalevo se flákají skâeti, napravo banditi a každý den jím akorát číhavčí maso. Víš, už mi to všecko leze krkem.
};
...
instance DIA_Engrom_WhatAboutLeaving		(C_INFO)
{
	...
	description	 = 	"Pâemýšlel jsi nękdy o tom, že odsud odejdeš?";
};
...
{
	AI_Output			(other, self, "DIA_Engrom_WhatAboutLeaving_15_00"); //Pâemýšlel jsi nękdy o tom, že odsud odejdeš?
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_01"); //No jasnę, to pâeci není problém!
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_02"); //Nejdâív se prosekám tlupami skâetů, pozdravím všecky ty ostatní pâíšery, co tu všude obcházejí, a pak prostę projdu průsmykem!
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_03"); //To je pâece sranda!
	AI_Output			(other, self, "DIA_Engrom_WhatAboutLeaving_15_04"); //Já se sem ale taky dostal.
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_05"); //Chceš mi nakukat, žes prostę prošel průsmykem?
	AI_Output			(other, self, "DIA_Engrom_WhatAboutLeaving_15_06"); //Víceménę ano!
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_07"); //Tak to jsi męl teda kliku. Dokud tu bude všechno vzhůru nohama, ani se odsud nehnu.
...
func void DIA_Engrom_Jagd_Info ()
{
	...
	AI_Output			(self, other, "DIA_Engrom_Jagd_12_01"); //Jedinou útęchu vidím v lovu, ale rád bych tu nękdy vidęl i nęco jiného než poâád ty nechutný číhavce.
};
...
instance DIA_Engrom_B_NpcObsessedByDMT		(C_INFO)
{
	...
	description	 = 	"Tak co, jde to dobâe?";
};
...
{
	AI_Output			(other, self, "DIA_Engrom_BESSEN_15_00"); //Posedlo tę zlo.

	AI_Output			(other, self, "DIA_Engrom_BESSEN_15_01"); //Dovol mi, abych ti pomohl.
	AI_Output			(self, other, "DIA_Engrom_BESSEN_12_02"); //(kâičí) Nesahej na mę!
