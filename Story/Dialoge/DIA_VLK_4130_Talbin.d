...
func void DIA_Talbin_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Talbin_HALLO_07_02"); //No to mę podrž! Další ztracená vovečka, co? Nejdâív jsem tę męl za jednoho z tęch zlejch šmejdů, co tu poâád vopruzujou.
...
func void DIA_Talbin_WASMACHTIHR_Info ()
{
	...
	Info_AddChoice	(DIA_Talbin_WASMACHTIHR, "Ty jsi bývalý vęzeŕ, který byl uvržen za bariéru?", DIA_Talbin_WASMACHTIHR_strf );
...
{
	AI_Output			(other, self, "DIA_Talbin_WASMACHTIHR_strf_15_00"); //Ty jsi bývalý vęzeŕ, který byl uvržen za bariéru?
...
func void DIA_Talbin_SORRYFORENGROM_Info ()
{
	...
	AI_Output			(self, other, "DIA_Talbin_SORRYFORENGROM_07_02"); //A teë jsme se dostali do tohohle srabu. Chamtivost se holt nevyplácí.
};
...
func void DIA_Talbin_FOUNDENGROM_Info ()
{
	...
	B_LogEntry (TOPIC_Talbin_Runs,"Talbin, lovec z Hornického údolí, probęhl pâes průsmyk, i když męl v patách celé roje krvavých much. Myslím, že míâí do Khorinisu."); 
