...
func void DIA_Lehmar_ENTSCHULDIGUNG_Info ()
{
	...
	AI_Output (self, other, "DIA_Lehmar_ENTSCHULDIGUNG_09_01"); //(otrávenę) Kolik chceš?
	AI_Output (other, self, "DIA_Lehmar_ENTSCHULDIGUNG_15_02"); //Co tím myslíš, 'kolik'?
	AI_Output (self, other, "DIA_Lehmar_ENTSCHULDIGUNG_09_03"); //Jsem lichváâ a ty jsi pâišel za mnou. Co bys tak ode mę mohl chtít? Peníze, samozâejmę.
};
...
instance DIA_Lehmar_GELDLEIHEN		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Půjč mi nęjaké peníze!";
};
//----------------------------------------
...
{
	AI_Output (other, self, "DIA_Lehmar_GELDLEIHEN_15_00"); //Půjč mi nęjaké peníze!
	AI_Output (self, other, "DIA_Lehmar_GELDLEIHEN_09_01"); //Jasnę! Kolik bys chtęl? Počítám si 20 procent!
...
func void DIA_Lehmar_GELDLEIHEN_200 ()
{
	...
	AI_Output (self, other, "DIA_Lehmar_GELDLEIHEN_200_09_01"); //To je spousta penęz. Uvidím tę zase zítra a ty prachy taky, rozumíme?
...
func void DIA_Lehmar_GELDLEIHEN_1000 ()
{
	...
	AI_Output (self, other, "DIA_Lehmar_GELDLEIHEN_1000_09_02"); //Dám ti 100. A nezapomeŕ, zejtra to chci zpátky!
...
func void DIA_Lehmar_WARUMGELD_Info ()
{
	...
	AI_Output (self, other, "DIA_Lehmar_WARUMGELD_09_01"); //(pobavenę) Nestarej se. Vrátíš se. Jinak si tę najdu a zabiju. Je to tak jednoduché.
	AI_Output (self, other, "DIA_Lehmar_WARUMGELD_09_02"); //Ty máš tak osobitej ksicht, že mi nezabere moc času, abych si tę našel.
	AI_Output (self, other, "DIA_Lehmar_WARUMGELD_09_03"); //Takže ani nepomysli na nęjakou boudu.
};
///////////////////////////////////////////////////////////////////////
//	Info geldeintreiben
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_09_00"); //Máš zpoždęní, ty bastarde! Dej sem moje prachy! A až ti budu muset zase pâipomínat, už to bude mnohem dražší.
	AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_09_01"); //Bude tę to stát 30 procent namísto tęch 20.
...
func void DIA_Lehmar_GELDEINTREIBEN_schuldenzahlen ()
{
	...
	if ((Npc_HasItems (other,ItMi_Gold)) >= Lehmar_GeldGeliehen_MitZinsen )
	{
		...
		AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_schuldenzahlen_09_01"); //To máš štęstí! A teë se zdejchni!
		Lehmar_GeldGeliehen = 0;
		AI_StopProcessInfos (self);		
	}
	else
	{
		AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_schuldenzahlen_09_02"); //Nemáš u sebe dost penęz! Dobrá, jak chceš. Vidím, že bych ti męl dát lekci.
		AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_schuldenzahlen_09_03"); //Neber si to nijak osobnę - musím si udržovat svou povęst.
		Lehmar_vorbei = TRUE;
...
func void DIA_Lehmar_GELDZURUECK_Info ()
{
	...
	&& (Lehmar_GeldGeliehen_Day<=(Wld_GetDay()-2))
	{
		...
		AI_Output (self, other, "DIA_Addon_Lehmar_GELDZURUECK_09_01"); //Ten blb je tvůj kámoš co?Ah ano, jeden z mých obchodů. Hezký den.
		Lehmar_GeldGeliehen = 0;
		AI_StopProcessInfos (self);		
	}
	else
	{
		...
		if ( (Npc_HasItems (other,ItMi_Gold)) >= Lehmar_GeldGeliehen_MitZinsen )
		{
			...
			AI_Output (self, other, "DIA_Lehmar_GELDZURUECK_09_01"); //Výbornę! S tebou se dęlaj obchody jedna radost.
		...
		{
			AI_Output (self, other, "DIA_Lehmar_GELDZURUECK_09_02"); //Nemáš dost penęz! Vraă se, až to budeš mít pohromadę. Ještę máš trochu času. Pamatuj, 20 procent!
			AI_StopProcessInfos (self);		
		};
	};
};
...
instance DIA_Lehmar_NOCHMALGELD		(C_INFO)
{
	...
	description	 = 	"Můžu si od tebe půjčit nęjaké další peníze?";
};
...
{
	AI_Output (other, self, "DIA_Lehmar_NOCHMALGELD_15_00"); //Můžu si od tebe půjčit nęjaké další peníze?
	...
	{
		AI_Output (self, other, "DIA_Lehmar_NOCHMALGELD_09_02"); //Teë už ne! Męl jsem velké výdaje a potâebuju každou minci.
		AI_Output (self, other, "DIA_Lehmar_NOCHMALGELD_09_03"); //Vraă se za pár dní!
	};
};
...
INSTANCE DIA_Lehmar_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Tuhle knížečku by ukradlo i mentálnę retardované dítę s umęlou rukou.))";
};                       
...
{	
	AI_Output (self, other, "DIA_Lehmar_Add_09_00"); //(zkroušenę) Nęjakej mizernej kapsáâ mi šlohnul moji účetní knihu.
	...
	AI_Output (self, other, "DIA_Lehmar_Add_09_03"); //Ano, ano, dobrá. Tak už bęž.
	AI_StopProcessInfos (self);
};
