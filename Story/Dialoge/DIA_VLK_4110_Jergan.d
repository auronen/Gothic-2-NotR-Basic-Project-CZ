...
FUNC VOID DIA_Jergan_Burg_Info()
{
	...
	B_LogEntry (Topic_OricBruder,"Až se dostanu do hradu, musím Oricovi vyâídit, že jeho bratr se zâítil z průsmyku.");
};
///////////////////////////////////////////////////////////////////////
//	Info Gegend
///////////////////////////////////////////////////////////////////////
...
INSTANCE DIA_Jergan_Claw   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Naučíš mę, jak na to?";
};
...
INSTANCE DIA_Jergan_Diego   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Víš, kam se podęl Diego?";
};
...
{
	AI_Output (self, other,"DIA_Jergan_Leader_13_00");//Tak ty jsi zabil vůdce bandy. A získal jsi z té bestie drápy?
