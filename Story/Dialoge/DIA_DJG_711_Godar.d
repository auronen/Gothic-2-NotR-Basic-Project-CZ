...
{
	AI_Output (other,self ,"DIA_Godar_ComeFrom_15_00"); //Odkud jsi pâišel?
	...
	Info_AddChoice (DIA_Godar_ComeFrom,"Vážnę.",DIA_Godar_ComeFrom_Understand);
};
...
FUNC VOID DIA_Godar_Prison_Info()
{
	...
	if (hero.guild == GIL_KDF)
		...
		{		
			AI_Output (self ,other,"DIA_Godar_Prison_13_03"); //Ty svinę mę zabásli za pytlačení. Kvůli dvęma zavšivenejm zajícům!
...
FUNC VOID DIA_Godar_Teach_Info()
{
	...
	if 	(
		...
		)
		{
			...
			{ 
				Info_AddChoice	(DIA_Godar_Teach, B_BuildLearnString ("Kâídla krvavé mouchy",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWing)),  DIA_Godar_Teach_TROPHYS_BFWing);
			};
...
FUNC VOID DIA_Godar_Teach_TROPHYS_DragonBlood()
{
	if (B_TeachPlayerTalentTakeAnimalTrophy (self, other, TROPHY_DragonBlood))
		{
			AI_Output			(self, other, "DIA_Godar_TEACHHUNTING_DragonBlood_13_00"); //Najdi si na dračím bâichu mękké místečko. Tam rozâízni a vyextrahuj krev.
		};
	Info_ClearChoices 	(DIA_Godar_Teach);
};
