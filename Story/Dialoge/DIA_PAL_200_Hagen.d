...
func void DIA_Lord_Hagen_Pass_Info ()
{
	...
	B_LogEntry (Topic_MISOLDWORLD,"Lord Hagen si žádá důkaz, že armáda zla skutečnę existuje. Musím se vydat do Hornického údolí a promluvit si s velitelem Garondem.");
...
instance DIA_Addon_Lord_Hagen_Ornament		(C_INFO)
{
	...
	description	= "Hledám kovovou ozdobu. Męla by být u kamenného kruhu blízko Lobartovy farmy.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lord_Hagen_GiveOrnament_15_00"); //Hledám kovovou ozdobu. Męla by být u kamenného kruhu blízko Lobartovy farmy.
	AI_Output	(self, other, "DIA_Addon_Lord_Hagen_GiveOrnament_04_01"); //Pokud myslíš tenhle kus tady ... mysleli jsme si, že by to mohla být magicka runa, ale ta vęc je úplnę bezcenná.
...
INSTANCE DIA_Lord_Hagen_Khorinis (C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 =  "Proč jste pâišli do Khorinisu?";
};
...
{
	AI_Output (other, self, "DIA_Lord_Hagen_Khorinis_15_00"); //Proč jste pâišli do Khorinisu?
...
func void DIA_Lord_Hagen_Minental_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Lord_Hagen_Minental_04_01"); //Nevidím důvod, proč bych ti męl âíkat nęco takového!
	}
	else
	{
...
FUNC VOID DIA_Hagen_Teach_Back ()
{
	if (other.HitChance[NPC_TALENT_2H] >= 100)
	{
		...
		AI_Output (self,other,"DIA_Hagen_Teach_04_01"); //Nechă tvé další skutky provádí moudrost mistra meče.
...
FUNC VOID DIA_Lord_Hagen_Knight_Yes()
{
	...
	{
		AI_Output (self ,other,"DIA_Lord_Hagen_Knight_Yes_04_09"); //Albrecht tę naučí naší magii, stačí, když za ním půjdeš a promluvíš si s ním.
	};
...
INSTANCE DIA_Lord_Hagen_EyeBroken(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Našel jsem Innosovo oko, je ale rozbité.";
};                       
...
{	
	AI_Output (other, self, "DIA_Lord_Hagen_Add_15_07"); //Našel jsem Innosovo oko, je ale rozbité.
...
instance DIA_Lord_Hagen_BACKINTOWN		(C_INFO)
{
	...
	permanent	 = 	FALSE; 
	description	 = 	"Pâináším novinky od Garonda. Dal mi pro tebe tenhle dopis.";
};
...
{
	AI_Output			(other, self, "DIA_Lord_Hagen_RescueBennet_Innoscent_15_00"); //Vęâím, že je Bennet nevinný.
...
func void DIA_Lord_Hagen_RINGEBRINGEN_Info ()
{
	...
	AI_Output			(self, other, "DIA_Lord_Hagen_RINGEBRINGEN_04_09"); //Vezmi si. Tady máš nęjaké zlato na své vybavení.
