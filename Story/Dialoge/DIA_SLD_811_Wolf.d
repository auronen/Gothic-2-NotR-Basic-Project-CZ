...
func void DIA_Wolf_WannaJoin_Info ()
{
	...
	AI_Output (self, other, "DIA_Wolf_WannaJoin_08_03"); //Od té doby sem pâišla spousta nových lidí a nękteâí staâí žoldáci už se na tebe asi ani nebudou pamatovat.
	AI_Output (self, other, "DIA_Wolf_WannaJoin_08_04"); //Já tę taky skoro nepoznal, jsi nęjaký zruchaný.
	...
	B_LogEntry (TOPIC_SLDRespekt,"Wolfovi nebude vadit, když se pâipojím k žoldnéâům.");
};
...
func void DIA_Wolf_WannaBuy_Info ()
{
	...
	AI_Output (self, other, "DIA_Wolf_WannaBuy_08_04"); //Zoufale potâebuju novou práci, i když tu nedęlám nic jiného, než hlídám polnosti.
...
func void DIA_Wolf_WannaLearn_Info ()
{
	...
	B_LogEntry (Topic_SoldierTeacher,"Wolf mę naučí zacházet s luky.");
};
...
FUNC VOID DIA_Wolf_Teach_Back ()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_Teach_BACK_08_00"); //A je to. Už máš zase o nęco pâesnęjší ruku.
	};
...
func void DIA_Wolf_Stadt_Info ()
{
	...
	AI_Output (self, other, "DIA_Wolf_Stadt_08_02"); //Nebo si myslíš, že bych tam męl dęlat nęjakého vojáka z domobrany? Nedovedu si pâedstavit, že bych nosil uniformu jak nęjaký dvoâan.
...
{	
	...
	B_LogEntry (TOPIC_Wolf_BringCrawlerPlates,"Wolf mi z 10 červích krunýâů vyková zbroj.");
};
...
INSTANCE DIA_Wolf_TeachCrawlerPlates(C_INFO)
{
	...
	permanent	= TRUE;
	description = B_BuildLearnString ("Můžeš mę naučit, jak červí krunýâe oddęlit?", B_GetLearnCostTalent(other, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CrawlerPlate));
};                       
...
{	
	...
	{
		AI_Output (self, other, "DIA_Wolf_TeachCrawlerPlates_08_01"); //To je jednoduché. Zadní krunýâe jsou totiž na tęle pevnę pâichyceny pouze na okrajích. Stačí je ostrým nožem odâíznout a je to.
...
func void DIA_Wolf_SHIP_Info ()
{
	...
	B_LogEntry (TOPIC_Crew,"Wolf už má tohoto ostrova plné zuby a udęlal by cokoliv, jen aby se odsud dostal. Je to dobrý bojovník."); 
	};
};
