...
{	
	...
	AI_Output (self ,other,"DIA_DiegoNW_Perm_11_01"); //Mizernę. Nękdo mi męl âíct, že to s Khorinisem šlo k šípku.
...
{	
	...
	{
		AI_Output (self ,other,"DIA_Addon_DiegoNW_NeedHelp_11_01"); //Netvaâ se tak pâekvapenę.
		AI_Output (self ,other,"DIA_Addon_DiegoNW_NeedHelp_11_02"); //(smęje se) Ty jsi si opravdu myslel, že jsem se zabil?
		AI_Output (self ,other,"DIA_Addon_DiegoNW_NeedHelp_11_03"); //Byl jsem chvíli v bezvędomí. Nicménę žiji, jak sis mohl všimnout.
		AI_Output (self ,other,"DIA_Addon_DiegoNW_NeedHelp_11_04"); //A nyní jsme spolu. A to se počítá.
		AI_Output (self ,other,"DIA_Addon_DiegoNW_NeedHelp_11_05"); //Potâebuji tvou pomoc.
	}
	else
	{
		AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_11_00"); //Dobâe že jsi tady. Budeš mi muset pomoci.
	};
...
FUNC VOID DIA_DiegoNW_NeedHelp_Plan()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Plan_11_02"); //Âekl bych, že proklouznout mezi nimi nebude nijak snadné.
};

FUNC VOID DIA_DiegoNW_NeedHelp_WhoAreYou()
{
	AI_Output (other,self ,"DIA_DiegoNW_NeedHelp_WhoAreYou_15_00"); //Kdo jsi?
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_WhoAreYou_11_01"); //Asi to bude mými šaty. Stráže mę nechtęjí pustit do męsta.
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_WhoAreYou_11_02"); //Proto jsem pâed męstem koupil od jednoho obchodníka tyhle hadry. Doufám, že si na mę už vzpomínáš. Jsem Diego.
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_WhoAreYou_11_06"); //No to mę omyj, ty si vážnę nic nepamatuješ.
...
FUNC VOID DIA_DiegoNW_NeedHelp_Clothes()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Clothes_11_01"); //Koupil jsem je pâed męstem od jednoho obchodníka. Stráže mę poprvé nechtęli pustit dovnitâ.
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Clothes_11_02"); //Také není nutné, aby celý svęt vędęl, odkud jsem.
	AI_Output (other,self ,"DIA_DiegoNW_NeedHelp_Clothes_15_03"); //To je fakt.
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Clothes_11_04"); //Také to tak vidím. Ale i když jsem zahodil svůj hábit Stínu, jsem poâád tím, kým jsem byl vždycky.
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Clothes_11_05"); //A s tímhle męstem mám velké plány.
};
...
FUNC VOID DIA_DiegoNW_NeedHelp_Problem_NoTime()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Problem_NoTime_11_01"); //Hele, já myslel, že jsme kámoši! Byl jsem to konec konců já, kdo ti zachránil kejhák, když tę hodili do kolonie.
...
FUNC VOID DIA_DiegoNW_NeedHelp_Problem_WillHelpYou()
{
	...
	AI_Output (self ,other,"DIA_Addon_DiegoNW_WillHelpYou_11_01"); //Okay, poslouchej: Když ještę stála bariéra, schoval jsem si malý poklad.
	AI_Output (self ,other,"DIA_Addon_DiegoNW_WillHelpYou_11_02"); //Počkej chvíli. To je to, co jsem si zapomnęl vzít s sebou.
...
FUNC VOID DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_YourPlan()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_YourPlan_11_01"); //V horní části męsta je obchodník, kterému musím zaplatit dluh. Potâebuju to dát konečnę do poâádku.
...
FUNC VOID DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_HowGold()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_HowGold_11_01"); //Jsem snad jediný, kdo si v Hornickém údolí šetâil pro strýčka Pâíhodu?
	AI_Output (self ,other,"DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_HowGold_11_02"); //Štípnout pár nugetů byla hračka. Dęlal jsem to prostę pro pâípad, že bychom se nakonec dostali ven.
...
FUNC VOID DIA_DiegoNW_NeedHelp_Problem_WillHelpYou_WhereGold()
{
	...
	if (Diego_angekommen == TRUE)
	{
		...
		AI_Output (self ,other,"DIA_Addon_DiegoNW_WillHelpYou_WhereGold_11_02"); //Prostę vezmi váček a dones mi ho.
	};
...
FUNC VOID DIA_DiegoNW_DeliveredLetter_Info()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_DeliveredLetter_11_04"); //Obávám se, že ze všeho nejdâív budu muset dohlédnout na vybavení svého nového domu. Pokud si dobâe pamatuju, tak Gerbrandt męl strašný vkus, co se nábytku týče.
...
FUNC VOID DIA_DiegoNW_DeliveredLetter_Gerbrandt ()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_Gerbrandt_11_01"); //Už si užíval toho pohodlného života pâíliš dlouho.
	...
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_Gerbrandt_11_03"); //Netuším, kam męl namíâeno, ale do Khorinisu už nikdy nevkročí - na to dohlédnu.
...
FUNC VOID DIA_DiegoNW_DeliveredLetter_YourHouse()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_YourHouse_11_02"); //Po nękolika letech strávených v krajnę nevyhovujících podmínkách se tęším, až se vyspím v posteli s nebesy.
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_YourHouse_11_03"); //A k snídani si pak dám dobré víno a šăavnatou šunčičku.
...
FUNC VOID DIA_DiegoNW_DeliveredLetter_YourTrick ()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_YourTrick_11_03"); //Samozâejmę, že jsem tu a tam nęco pochytil. Gerbrandt se mę nakonec zbavil. Nejspíš se bál, že toho vím pâíliš.
...
FUNC VOID DIA_DiegoNW_DeliveredLetter_YourTrick_REWARD()
{
	...
	AI_Output (self ,other,"DIA_DiegoNW_TalkedToJudge_YourTrick_REWARD_11_01"); //Zdá se, že jsi nakonec pâece jenom nezapomnęl na všechno, co jsem tę naučil.
...
{	
	...
	{
		AI_Output (self ,other,"DIA_DiegoNW_CanYouTeach_11_01"); //Ale jistę. Jen mi âekni, až budeš pâipraven.
...
func void DIA_DiegoNW_KnowWhereEnemy_Info ()
{
	...
	AI_Output			(self, other, "DIA_DiegoNW_KnowWhereEnemy_11_01"); //Moudré rozhodnutí. Pâál bych si jít s tebou. Tohle męsto se pâíliš rychle zmęnilo - časy, kdy jsi mohl rychle zbohatnout, už jsou pryč.
	AI_Output			(self, other, "DIA_DiegoNW_KnowWhereEnemy_11_02"); //Mohl bych tę učit v lučištnictví, páčení zámků a navyšování obratnosti.
...
FUNC VOID DIA_DiegoNW_KnowWhereEnemy_Yes ()
{
    ...
    {
		AI_Output (self ,other,"DIA_DiegoNW_KnowWhereEnemy_Yes_11_02"); //Počkej, za okamžik budu pâipraven.
	...
	AI_Output (self ,other,"DIA_DiegoNW_KnowWhereEnemy_Yes_11_03"); //Tak, jsem pâipraven. Uvidíme se u lodi.
...
func void DIA_DiegoNW_LeaveMyShip_Info ()
{
	...
	AI_Output			(self, other, "DIA_DiegoNW_LeaveMyShip_11_03"); //Nikdy nezapomenu na ten výraz, který jsi męl ve tváâi, když ses válel po zemi po té ránę od Bullita a my se poprvé setkali.
...
func void DIA_DiegoNW_StillNeedYou_Info ()
{
	...
	AI_Output	(self, other, "DIA_DiegoNW_StillNeedYou_11_01"); //Kam se podęlo tvé odhodlání, pâíteli? Jasnę, že s tebou půjdu - ale už se sakra rozhodni.
	...
	if (Hlp_StrCmp(Npc_GetNearestWP(self), "NW_CITY_UPTOWN_PATH_23" )== 1)
    {
		AI_Output (self ,other,"DIA_DiegoNW_StillNeedYou_11_02"); //Počkej, za okamžik budu pâipraven.
		AI_GotoWP (self,"NW_CITY_UPTOWN_HUT_01_01");
		CreateInvItems (self,ItAR_Diego,1);
		AI_EquipArmor (self,ItAr_Diego);
		AI_GotoWP (self,self.wp);
