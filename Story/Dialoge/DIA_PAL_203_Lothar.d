...
func void DIA_Lothar_Hallo_Info ()
{
	...
	//ADDON>
	AI_Output (self, other, "DIA_Addon_Lothar_Hallo_01_00"); //Už nęjakou dobu lidę ve męstę mizí. Dávej si bacha, aă tak taky neskončíš.
	//ADDON<
...
func void DIA_Lothar_MESSAGE_Info ()
{
	...
	AI_Output (self, other, "DIA_Lothar_MESSAGE_01_02"); //Za všechny vęci týkající se bęžných občanů je zodpovędný lord Andre, velitel męstské stráže.
};	
...
instance DIA_Addon_Lothar_Ornament		(C_INFO)
{
	...
	description	 = 	"Víš nęco o kamenech, které jsou v kamenném kruhu za Lobartovou farmou?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lothar_Ornament_15_00"); //Víš nęco o kamenech, které jsou v kamenném kruhu za Lobartovou farmou?
	AI_Output	(self, other, "DIA_Addon_Lothar_Ornament_01_01"); //Jistę, že ano. Zničili jsme je. Znepokojovaly blízké farmáâe.
...
func void DIA_Addon_Lothar_Ornament_normal ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Lothar_Ornament_normal_01_03"); //Nechci o tom vędęt víc. My se zajímáme zde o męsto a o Hornické údolí.
...
func void DIA_Addon_Lothar_Ornament_suche ()
{
	...
	AI_Output			(other, self, "DIA_Addon_Lothar_Ornament_suche_15_01"); //Męlo by to být nękde u kamenného kruhu blízko Lobartovy farmy.
	AI_Output			(self, other, "DIA_Addon_Lothar_Ornament_suche_01_02"); //Ano, nęco tam bylo. Kámen blízko nęj. Vzal jsem ho na magické runy.
	AI_Output			(self, other, "DIA_Addon_Lothar_Ornament_suche_01_03"); //Dal jsem ho lordu Hagenovi. A nevím, co s ním udęlal on.
};
...
instance DIA_Lothar_Regeln (C_INFO)
{
	...
	permanent    =  FALSE;
	description	 = 	"Dobrá - vysvętli mi zákony męsta!";
};
...
func void DIA_Lothar_Regeln_Info ()
{
	...
	AI_Output (self, other, "DIA_Lothar_Regeln_01_01"); //Za prvé: Ctihodný paladin lord Hagen bydlí se svými jednotkami v horní části męsta.
	...
	AI_Output (self ,other, "DIA_Lothar_Add_01_05"); //A za tâetí: Každý, kdo je obvinęný z nęjakého zločinu, se musí ospravedlnit pâed velitelem domobrany.
...
instance DIA_Addon_Lothar_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Obyvatelé męsta mizí?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Lothar_MissingPeople_15_00"); //Obyvatelé męsta mizí?
	AI_Output	(self, other, "DIA_Addon_Lothar_MissingPeople_01_01"); //Ano, a zdá se, že čím dál častęji.
	AI_Output	(self, other, "DIA_Addon_Lothar_MissingPeople_01_02"); //Je Mrzuté, že domobrana nebyla schopna tuto záhadu vyâešit.
	AI_Output	(self, other, "DIA_Addon_Lothar_MissingPeople_01_03"); //Je pochopitelné, že obyvatelé męsta jsou velmi nedůvęâiví k cizincům.
	AI_Output	(self, other, "DIA_Addon_Lothar_MissingPeople_01_04"); //Tak ve męstę zbytečnę neupoutávej pozornost sám na sebe, OK?
...
func void DIA_Lothar_WoArbeit_Info ()
{
	...
	AI_Output (self ,other, "DIA_Lothar_Add_01_17"); //Musí s tím ale souhlasit i ostatní mistâi, tak velí zvyk tady v Khorinisu.
...
instance DIA_Lothar_ToOV (C_INFO)
{
	...
	permanent    =  FALSE;
	description	 = 	"Jak se dostanu do horní části męsta?";
};
