...
func void DIA_Randolph_SchwereLuft_Info ()
{
	...
	B_LogEntry (TOPIC_AkilsSLDStillthere,"Akilův statek ohrožují žoldnéâi."); 
	B_NpcClearObsessionByDMT (self);
};
///////////////////////////////////////////////////////////////////////
//	Info Hallo
...
instance DIA_Randolph_Baltram		(C_INFO)
{
	...
	permanent  	 =  FALSE;
	description	 = 	"Poslal mę Baltram. Mám tu pro nęj vyzvednou nęjaký balík.";
};
...
{
	AI_Output (other, self, "DIA_Randolph_Baltram_15_00"); //Poslal mę Baltram. Mám tu pro nęj vyzvednou nęjaký balík.
...
func void DIA_Randolph_TAVERNE_Info ()
{
	...
	AI_Output			(self, other, "DIA_Randolph_TAVERNE_06_01"); //Jo, pâesnę tak. Ale teë už ne.
...
func void DIA_Randolph_WETTKAMPFZUENDE_Info ()
{
	...
	if (Rukhar_Won_Wettkampf == TRUE)
		{
			AI_Output			(self, other, "DIA_Randolph_WETTKAMPFZUENDE_06_01"); //Pâímo matka všech kocovin. A já jí nemůžu zbavit. Už nebudu chlastat, pâísahám.
	...
	else
		{
			...
			AI_Output			(self, other, "DIA_Randolph_WETTKAMPFZUENDE_06_05"); //Vypadá to, že Rukhar nevstane zrovna brzo.
		};
...
instance DIA_Randolph_SAGITTAHEAL		(C_INFO)
{
	...
	description	 = 	"Tady. To by męlo zmírnit abstinenční pâíznaky.";
};
