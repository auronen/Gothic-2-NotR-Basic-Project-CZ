...
{	
	AI_Output (self, other,"DIA_Addon_Abuyin_Hallo_13_00");//(pâemítá) ... Zvláštní. Pâipadáš mi povędomý, cizinče ...
	AI_Output (self, other,"DIA_Addon_Abuyin_Hallo_13_01");//No ... nesmírné jsou tajemství času a vesmíru ... ah, omluv mou nezdvoâilost, synu trpęlivosti. Ještę jsemtę ani nepâivítal ...
	AI_Output (self, other,"DIA_Addon_Abuyin_Hallo_13_02");//Vítej, pâíteli. Sedni si na koberec a vychutnej si vodní dýmku.
};
// ************************************************************
// 			  		Wer bist du?
// ************************************************************
...
FUNC VOID DIA_Abuyin_Mischung_Super ()
{
	...
	CreateInvItems (self, ItMi_Joint,1);
	B_UseItem (self, ItMi_Joint);
	AI_Output (self, other,"DIA_Abuyin_Mischung_Super_13_01");//Chutná to pâímo neuvęâitelnę! Nikdy jsem v celém svém životę nic lepšího nekouâil!
...
INSTANCE DIA_Abuyin_Herb(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Zajímal by tę tenhle balíček drog?";
};                       
...
INSTANCE DIA_Abuyin_Weissagung(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Dokážeš mi pâedpovędęt budoucnost?";
};                       
...
{	
	AI_Output (other, self,"DIA_Abuyin_Zukunft_15_00");//Pâedpovęz mi budoucnost.
...
FUNC VOID DIA_Abuyin_Zukunft_Trance()
{
		...
		AI_Output (self, other,"DIA_Addon_Abuyin_Zukunft_Trance_13_00");//( v tranzu) ... co je to ... ? Męsto ... ruiny ... Quarhodron v Jharkendaru ...
		AI_Output (self, other,"DIA_Addon_Abuyin_Zukunft_Trance_13_01");//(v tranzu) ... nazývá se ... Quarhodron v Jharknedru!
...
INSTANCE DIA_Abuyin_Nochmal(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Můžeš mi udęlat ještę další proroctví?";
};                       
...
{	
	...
	AI_Output (self, other,"DIA_Abuyin_Nochmal_13_02");//Pouze pokud mi čas sešle další znamení, budu schopen se do nęj podívat znovu.
...
INSTANCE DIA_Abuyin_Weissagung2(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Můžeš vęštit mou budoucnost?";
};                       
...
{	
	AI_Output (other, self,"DIA_Abuyin_Zukunft2_15_00");//Pâedpovęz mi budoucnost.
...
FUNC VOID  DIA_Abuyin_Zukunft3_Trance()
{
	...
	AI_Output (self, other,"DIA_Abuyin_Zukunft3_Trance_13_02");//(V transu)... Muži v podivné zbroji... bažiny... ještęrani... čekají na tebe...
...
{	
	AI_Output (other, self,"DIA_Abuyin_Zukunft4_15_00");//Pâedpovęz mi budoucnost.
...
{	
	AI_Output (other, self,"DIA_Abuyin_Zukunft5_15_00");//Pâedpovęz mi budoucnost.
