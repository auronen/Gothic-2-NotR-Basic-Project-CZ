...
func void DIA_Borka_PISSOFF_Info ()
{
	...
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_01");  //Stojíš pâímo pâed perlou Khorinisu - ČERVENOU LUCERNOU. Je to ten nejkrásnęjší nevęstinec v celé Myrtanę, to si piš!
...
instance DIA_Borka_Smoke		(C_INFO)
{
	...
	permanent	 =  TRUE;
	description	 =  "Nevíš, kde bych si mohl koupit nęjaké kuâivo - trávu nebo nęco takového?";
};
...
func void DIA_Borka_BUYHERB_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Borka_BUYHERB_11_01"); //Omlouvám se, pane strážník. To musí být nęjaká mýlka, o žádných drogách nic nevím.
	}
	else
	{
		...
		Info_AddChoice		(DIA_Borka_BUYHERB,"To sem nepatâí.",DIA_Borka_BUYHERB_Egal);
...
FUNC VOID DIA_Borka_BUYHERB_Deal ()
{
	...
	AI_Output (self, other, "DIA_Borka_BUYHERB_Deal_11_01"); //...no dobâe... tak tedy budeme obchodovat. Dej mi 50 zlaăáků a já ti je vymęním za drogu. A žádné smlouvání.
	Info_ClearChoices 	(DIA_Borka_BUYHERB);
	Borka_Deal = TRUE;
};	
///////////////////////////////////////////////////////////////////////
