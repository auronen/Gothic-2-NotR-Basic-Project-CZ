...
func void DIA_Buster_Hello_GoingToFarm()
{
	...
	Info_AddChoice		(DIA_Buster_Hello, "Chceš se pâesvędčit"								,DIA_Buster_Hello_WannaTestIt);
...
func void DIA_Buster_Hello_ImNoDanger()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_ImNoDanger_13_02"); //V jednom kuse tady bojujeme se skâety. Nebo strážemi z męsta. Teda, jsou to pęknę neodbytní prevíti, to teda jo. (zasmęje se)
...
func void DIA_Buster_Hello_SoWhat()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_SoWhat_13_02"); //(rozzlobenę) Možná je na čase, aby ti nękdo uštędâil lekci!
...
{	
	...
	|| (self.aivar[AIV_LastFightAgainstPlayer] == FIGHT_LOST)
	{
		...
		B_LogEntry (TOPIC_SLDRespekt,"Když jsem Bustera porazil, nebude mi už bránit v cestę žoldnéâských âad.");
	}
