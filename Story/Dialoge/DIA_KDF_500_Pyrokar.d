...
func void DIA_Pyrokar_Auge_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Pyrokar_ALL_11_05"); //Dobrá, už tę nebudeme dál zdržovat od tvé práce - můžeš jít.
		AI_StopProcessInfos (self);
	};
};
...
instance DIA_Addon_Pyrokar_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Nękteâí občané Khorinisu zmizeli za podivných okolností.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Pyrokar_MissingPeople_15_00"); //Nękteâí občané Khorinisu zmizeli za podivných okolností.
	AI_Output	(self, other, "DIA_Addon_Pyrokar_MissingPeople_11_01"); //Jsem si toho vędom a je to politováníhodné. Nicménę jsme souhlasili s mágy Vody, že na tu vęc dohlídnou.
	AI_Output	(self, other, "DIA_Addon_Pyrokar_MissingPeople_11_02"); //To samé se týka té záležistosti s tęmi podivnými zemętâesenímy v severovýchodní oblasti Khorinosu.
	AI_Output	(self, other, "DIA_Addon_Pyrokar_MissingPeople_11_03"); //To samé se týka té záležistosti s tęmi podivnými zemętâesenímy v severovýchodní oblasti Khorinosu.
	AI_Output	(other, self, "DIA_Addon_Pyrokar_MissingPeople_15_04"); //Ano, ale ...
	AI_Output	(self, other, "DIA_Addon_Pyrokar_MissingPeople_11_05"); //Žádné ALE! Budeme pokračovat jak uznáme za vhodné a doufám, že i TY budeš respektovat toto usnesení.

	Log_CreateTopic (TOPIC_Addon_WhoStolePeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_WhoStolePeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_WhoStolePeople,"Mágové Ohnę litují zmizelých občanů Khorinosu . Nicménę âíkají, že by to byl úkol pro mágy Vody. Neočekávejte tedy pomoc od kláštera ohnivých mágů."); 
...
func void DIA_Pyrokar_FIRE_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_FIRE_11_07"); //V tom pâípadę - aă je po tvém. Až budeš pâipraven, dostaneš od každého mága Rady úkol, jejž musíš splnit.
...
func void DIA_Pyrokar_Todo_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Pyrokar_Todo_11_03"); //... ještę musíš dokončit Serpentesův test.
	};
	AI_StopProcessInfos (self); 
};
///////////////////////////////////////////////////////////////////////
...
instance DIA_Pyrokar_OATH		(C_INFO)
{
	...
	permanent 	 =  FALSE;
	description	 = 	"Jsem pâipraven vstoupit to Kruhu ohnę.";
};
...
{
	AI_Output (other, self, "DIA_Pyrokar_OATH_15_00"); //Jsem pâipraven vstoupit to Kruhu ohnę.
	AI_Output (self, other, "DIA_Pyrokar_OATH_11_01"); //Dobrá, tak slož svatou Pâísahu ohnę.
	...
	AI_Output (self, other, "DIA_Pyrokar_OATH_11_09"); //Taky bychom velmi rádi vędęli, jak on hodnotí situaci. Takže je ti dovoleno odejít do Khorinisu.
...
instance DIA_Pyrokar_Lernen		(C_INFO)
{
	...
	PERMANENT	 =  FALSE;
	description	 = 	"Co všechno se teë můžu naučit?";
};
...
func void DIA_Pyrokar_Lernen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Pyrokar_Lernen_11_03"); //Od bratrů v klášteâe se můžeš naučit magickým formulím. Každý z nich se zamęâuje na určitou oblast, o které tę mohou hodnę naučit.
	...
	B_LogEntry (Topic_KlosterTeacher,"Bratr Parlan mę uvede do prvních magických kruhů.");
...
instance DIA_Pyrokar_Wunsch		(C_INFO)
{
	...
	PERMANENT	 =  FALSE;
	description	 = 	"Chtęl bych vyslovit jedno pâání.";
};
...
func void DIA_Pyrokar_TEACH_Info ()
{
	...
	if (MIS_SCKnowsWayToIrdorath == TRUE)
	{
		if B_TeachMagicCircle (self,other, 6)  
		{
			...
			AI_Output (self, other, "DIA_Pyrokar_TEACH_11_04"); //Teë se ode mę můžeš naučit magické formule posledního kruhu. Pokud po tom tedy toužíš.
			...
			AI_Output (other, self, "DIA_Pyrokar_TEACH_15_07"); //Ano, ušetâil jsi mi tak spoustu tęch soudních keců.
...
func void DIA_Pyrokar_SPELLS_Info ()
{
	var int abletolearn;
	abletolearn = 0;
	AI_Output (other, self, "DIA_Pyrokar_SPELLS_15_00"); //Instruuj mę
...
func void DIA_Pyrokar_PERM_Info ()
{
	if (hero.guild == GIL_KDF)
			{
				AI_Output			(other, self, "DIA_Pyrokar_PERM_15_00"); //Požehnej mi, Mistâe.
			}
		else
			{
...
func void DIA_Pyrokar_BACKFROMOW_Info ()
{
	...
	B_LogEntry (TOPIC_DEMENTOREN,"Pyrokar mi vyprávęl o Pátračích, mužích v černých hábitech, kteâí jsou Beliarovými nohsledy. Varoval mę, že dokáží ovládat a posednout druhé. Mám se vrátit pâímo do kláštera, aby se mi to náhodou nestalo také."); 
	};
...
func void DIA_Pyrokar_FOUNDINNOSEYE_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_FOUNDINNOSEYE_11_05"); //Ani ve svých nejhorších nočních můrách jsem si nikdy nepâedstavoval, že se zmocní takového druhu moci.
...
{
	AI_Output			(other, self, "DIA_Pyrokar_FOUNDINNOSEYE_was_vatras_15_00"); //Proč Vatras?
	AI_Output			(self, other, "DIA_Pyrokar_FOUNDINNOSEYE_was_vatras_11_01"); //Privilegium nosit róbu ti ještę neopravŕuje k tomu, aby ses vyptával na důvody mých instrukcí, bratâe.
	AI_Output			(self, other, "DIA_Pyrokar_FOUNDINNOSEYE_was_vatras_11_02"); //Vatras je Adanosův služebník. Vędomosti toho vodního mága nám pâinesou trochu svętla do tohoto temného času.
...
func void DIA_Pyrokar_FOUNDINNOSEYE_sonnenkreis ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_FOUNDINNOSEYE_sonnenkreis_11_01"); //Každoročnę se v čase slunovratu všichni mágové a novicové kláštera vydávají na cestu na toto místo, aby tak pâivítali počátek nového cyklu.
...
instance DIA_Pyrokar_XARDASVERTRAUEN		(C_INFO)
{
	...
	description	 = 	"Bez tebe to nepůjde. Vatras není schopen ten rituál jinak pâipravit.";
};
...
instance DIA_Pyrokar_PRERITUAL		(C_INFO)
{
	...
	description	 = 	"Myslíš, že můžeš Innosovo oko opravit?";
};
...
{
	AI_Output			(other, self, "DIA_Pyrokar_PRERITUAL_15_00"); //Myslíš, že můžeš Innosovo oko opravit?
...
instance DIA_Pyrokar_AUGEGEHEILT		(C_INFO)
{
	...
	description	 = 	"Dokázal jsi to. Innosovo oko je zase v poâádku.";
};
...
{
	AI_Output			(other, self, "DIA_Pyrokar_AUGEGEHEILT_15_00"); //Dokázal jsi to. Innosovo oko je zase v poâádku.
	...
	if (hero.guild == GIL_KDF)
		{
			...
			AI_Output			(self, other, "DIA_Pyrokar_AUGEGEHEILT_11_04"); //Od tohoto dne jsi členem Rady a budeš nás âád reprezentovat po celém svęte. Teë jsi jedním z vyšších ohnivých mágů.
...
instance DIA_Pyrokar_KAP3_READY		(C_INFO)
{
	...
	description	 = 	"Co tu ještę musím učinit?";
};
...
func void DIA_Pyrokar_KAP3_READY_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_KAP3_READY_11_06"); //Budeš k tomu potâebovat esenci z dračího srdce, kterou můžeš s Okem spojit za pomoci alchymistické kolony.
...
func void DIA_Pyrokar_BUCHDERBESSENEN_Info ()
{
	...
	if (hero.guild == GIL_KDF)
	{
		...
		AI_Output			(self, other, "DIA_Pyrokar_BUCHDERBESSENEN_11_09"); //Najdi ty obęti a pâines mi jejich knihy. Męl bych je zprovodit ze svęta.
...
func void DIA_Pyrokar_DERMEISTER_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_DERMEISTER_11_03"); //Innos s námi. Temný chrám znovu nabyl svou sílu a teë vysílá své posluhovače do našeho svęta.
...
func void DIA_Pyrokar_WASISTIRDORATH_Info ()
{
	...
	B_LogEntry (TOPIC_BuchHallenVonIrdorath,"Podle Pyrokara jsou Irdoratské sínę ztraceným chrámem, kde uctívači vzývali boha Beliara. Musím jej najít."); 
...
func void DIA_Pyrokar_BUCHIRDORATH_Info ()
{
	...
	B_LogEntry (TOPIC_BuchHallenVonIrdorath,"Xardasova kniha Irdoratské sínę je ukryta ve sklepeních kláštera, kde ji stâeží Talamon. Mágové ji ale nedokáží otevâít - její magickou pečeă prý má na svędomí sám Xardas."); 
...
func void DIA_Pyrokar_IRDORATHBOOKOPEN_glueck ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_IRDORATHBOOKOPEN_glueck_11_02"); //Mnę se to vůbec nezdaâilo a pak je to pro nękoho jako ty úplná hračka...
...
instance DIA_Pyrokar_SCWILLJORGEN		(C_INFO)
{
	...
	description	 = 	"Jorgen je zkušeným námoâníkem. Mohl by mi pomoci dostat se na ostrov Irdorath.";
};
...
func void DIA_Pyrokar_MACHDTFREI_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_MACHDTFREI_11_01"); //Mmh. Jasnę, že je tu jedna vęc, kterou bys mohl udęlat. Mohly by ti s tím pomoct tvoje dobré vztahy s Xardasem.
...
func void DIA_Pyrokar_AmulettofDeath_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_AmulettofDeath_11_01"); //Innosova aura je amulet, který je povoleno nosit jen nejvętším mágům své doby.
...
FUNC VOID DIA_Pyrokar_PotionofDeath_Potion ()
{
	...
	Info_AddChoice 	(DIA_Pyrokar_PotionofDeath,"Co myslíš tím 'zbraŕ'?",DIA_Pyrokar_PotionofDeath_Weapon);
};
...
{
	AI_Output 	(other,self ,"DIA_Pyrokar_PotionofDeath_Weapon_15_00"); //Co myslíš tím "zbraŕ"?
