...
{	
	...
	&& (EVT_ORKOBERST_SWITCH_FOUND == FALSE)
	{
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_RAT_11_03"); //Ale nezapomeŕ, že aby takovéto tajné spínače fungovaly, musíš je často používat v pâesnę určeném poâadí.
		 
	}
	else if	(Npc_IsDead(FireDragonIsland))
	&& (EVT_DIBRIDGE_OPENED == FALSE)
	{
		AI_Output (other,self ,"DIA_PC_Thief_DI_RAT_15_04"); //Bojoval jsem s drakem a teë mám pâed sebou propast s padacím mostem. Ten most je ale zvednutý a já se nemohu dostat na druhou stranu.
	...
	else
	{
		AI_Output (self ,other,"DIA_PC_Thief_DI_RAT_11_08"); //Vraă se ke mnę, až budeš mít problém, na jehož âešení budou moje zkušenosti stačit.
		 ...
		 && (DIA_PC_Thief_DI_RAT_OneTime2 == FALSE)
			{
				AI_Output (self ,other,"DIA_PC_Thief_DI_RAT_11_09"); //Ještę jedna vęc. Byl bych rád, kdybys k lodi nepâivedl všechny pâíšery, jež se tu po okolí potulují. Doufám, že tenhle skâetí nájezd byl poslední, který jsem musel odrážet!
...
{	
	...
	{
		AI_Output (self ,other,"DIA_PC_Thief_DI_UndeadDragonDead_11_01"); //Jen se na to podívej. Za celý svůj život jsem podobnou stavbu nevidęl.
	...
	if (DIA_PC_Thief_DI_UndeadDragonDead_OneTime == FALSE )
	{
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_UndeadDragonDead_11_07"); //To je dobrá otázka. Ze všeho nejdâíve se asi vrátím do Khorinisu.
		...
		{
			AI_Output (self ,other,"DIA_DiegoDI_Add_11_00"); //Zlodęjský cech tam už není. Tím pádem se nabízí nękolik zajímavých pâíležitostí.
		};
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_UndeadDragonDead_11_09"); //Hmm. Nebo možná prostę pâevezmu Bromorovu živnost. V tom jsou vždycky peníze. Poctivé peníze.
