...
INSTANCE DIA_Addon_Tonak_NW_Hi   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Vracíš se zpátky na pole, že?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Tonak_NW_Hi_15_00");//Vracíš se zpátky na pole, že?
	AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_01");//Hej, můj zachránče! Ano, teë jsem zpátky abych si upracoval prsty až na kost.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_02");//Hlavnę s tęmihle bratry. Chlape, bylo to opravdu tak špatné u TĘCH banditů ...
	};
};
// ************************************************************
// 			  				PICK POCKET
