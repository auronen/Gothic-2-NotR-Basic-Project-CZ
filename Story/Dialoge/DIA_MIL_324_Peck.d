...
instance DIA_Peck_WEAPON		(C_INFO)
{
	...
	permanent 	 =  TRUE;
	description	 = 	"Musím si pro zbraŕ.";
};
//------------------------------------
...
{
	AI_Output (other, self, "DIA_Peck_WEAPON_15_00"); //Musím si pro zbraŕ.
	
	if (MIS_Andre_Peck == LOG_RUNNING)
	{
		AI_Output (self, other, "DIA_Peck_WEAPON_12_01"); //Nejdâív jdi za Andrem a podej mu hlášení.
	}
	else	
	{
	...
	AI_Output (self, other, "DIA_Peck_WEAPON_12_06"); //Jestli chceš lepší zbraŕ, jdi na trh ke kupcům.
	};
	AI_StopProcessInfos (self);
};
...
{
	AI_Output			(other, self, "DIA_Peck_PERM_15_00"); //Jsi v poâádku?
