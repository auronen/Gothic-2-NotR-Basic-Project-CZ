...
instance DIA_Pedro_DI_YOU		(C_INFO)
{
	...
	description	 = 	"Zrádce! Tak jsem tę konečnę našel.";
...
func void DIA_Pedro_DI_YOU_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pedro_DI_YOU_09_07"); //Skâetí plukovník mne celé dny vyslýchal. Poâád mne bil. Ušetâi mne. Jsem nevinný. Musíš mi vęâit.
...
func void DIA_Pedro_DI_ArrivedAtShip_Info ()
{
	...
	Info_AddChoice	(DIA_Pedro_DI_ArrivedAtShip, "Už jsem slyšel dost. Bęž si najít místo na mé lodi. Ještę poâád mám dost práce.", DIA_Pedro_DI_ArrivedAtShip_Back );
	Info_AddChoice	(DIA_Pedro_DI_ArrivedAtShip, "Jak je možné dostat se dovnitâ ostrova?", DIA_Pedro_DI_ArrivedAtShip_Innere );
...
func void DIA_Pedro_DI_ArrivedAtShip_OrkOberst ()
{
	...
	AI_Output			(self, other, "DIA_Pedro_DI_ArrivedAtShip_OrkOberst_09_02"); //Od chvíle, co jsem sem pâišel, mę vyslýchal ohlednę strategického rozmístęní paladinů v Khorinisu.
...
func void DIA_Pedro_DI_ArrivedAtShip_Monster ()
{
	...
	AI_Output			(self, other, "DIA_Pedro_DI_ArrivedAtShip_Monster_09_01"); //Bęhem dne můžeš často vidęt, jak k pobâeží míâí ještęrani. Obvykle nesou nęjaká ohromná vejce.
...
func void DIA_Pedro_DI_ArrivedAtShip_Innere ()
{
	...
	AI_Output			(self, other, "DIA_Pedro_DI_ArrivedAtShip_Innere_09_03"); //Jeden ze šamanů spustil mechanismus tak, že zatáhnul za jednu z pochodní visících na zdi v chodbę.
