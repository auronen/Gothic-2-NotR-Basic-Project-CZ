...
instance SVM_1 (C_SVM)
{
	...
	Weather						= 	"SVM_1_Weather"						;//Zatracený nečas!
	// ------ B_Say_AttackReason -----------------------------------------------------------------------------------------
	...
	SheepKiller					=	"SVM_1_SheepKiller"					;//Takhle vraždit naše ovce! Vypadni, vole!
	...
	ShitNoGold					=	"SVM_1_ShitNoGold"					;//Ten mizera u sebe nemá žádné zlato.
	...
	YouLearnedSomething			= "SVM_1_YouLearnedSomething"		;//Není nic, co bych tę ještę mohl naučit. Žák pâekonal svého učitele.
	// ----------------------------------------------------------------------------------------------------------------------
	...
	ADDON_WRONGARMOR			= "SVM_1_Addon_WrongArmor";				//Toto nejsou tvoje šaty. Nebudu s tebou mluvit.
	ADDON_WRONGARMOR_SLD		= "SVM_1_ADDON_WRONGARMOR_SLD";			//Jak tu chodíš? Nasaë nęjaké správné šaty, jo?
	ADDON_WRONGARMOR_MIL		= "SVM_1_ADDON_WRONGARMOR_MIL";			//Jsi voják! Oblékni se podle toho!
	ADDON_WRONGARMOR_KDF		= "SVM_1_ADDON_WRONGARMOR_KDF";			//Tvoje zbroj se nehodí k našemu âádu. Zmęŕ si ji!
	ADDON_NOARMOR_BDT			= "SVM_1_ADDON_ADDON_NOARMOR_BDT";		//Ty nemáš dokonce brnęní. Tak si pro nę bęž!

	ADDON_DIEBANDIT				= "SVM_1_ADDON_DIEBANDIT";				//Zemâi, banditskej neâáde!
	ADDON_DIRTYPIRATE			= "SVM_1_ADDON_DIRTYPIRATE";			//Pirátskej neâáde!
};
...
instance SVM_3 (C_SVM)
{
	...
	Weather						= 	"SVM_3_Weather"					;//Zatracený nečas!
	// ------ B_Say_AttackReason -----------------------------------------------------------------------------------------
	...
	SheepKiller					=	"SVM_3_SheepKiller"				;//Takhle vraždit naše ovce!
	...
	ITakeYourWeapon				=	"SVM_3_ITakeYourWeapon"		;//Ty mizernej všiváku, nemáš u sebe žádný zlato!
	// ------ ZS_ReactToDamage ---------------------------------------------------------------------------------------------
