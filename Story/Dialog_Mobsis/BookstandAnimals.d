...
FUNC VOID Use_BookstandAnimals2_S1()		//Tierbücher
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLines	( nDocID,  0, "Z každého zvíâete či nestvůry může schopný lovec získat nęjakou trofej, která mu pâinese slávu i bohatství."						);
					Doc_PrintLine	( nDocID,  0, ""						);
					...
					Doc_PrintLines	( nDocID,  1, "červů jsou cenné, neboă obsahují výmęšek zvyšující magickou moc. Lze jej však"						);
