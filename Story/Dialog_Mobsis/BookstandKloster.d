...
FUNC VOID Use_Bookstand_Kreise_01_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "Léčba lehkých zranęní");
...
FUNC VOID Use_Bookstand_Kreise_02_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "Ledový kâemen");
					Doc_PrintLine	( nDocID,  0, "");
					...
					Doc_PrintLine	( nDocID,  0, "Vętrná pęst");
...
FUNC VOID Use_Bookstand_Kreise_03_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLines	( nDocID,  0, "Runy 3. kruhu a pâísady potâebné k jejich vytvoâení. ");
					Doc_PrintLine	( nDocID,  0, ""	);
					
					
					Doc_PrintLine	( nDocID,  0, "Léčba stâednę tęžkých zranęní");
					...
					Doc_PrintLine	( nDocID,  0, "Vytvoâení kostlivce");
...
FUNC VOID Use_Bookstand_Kreise_04_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "Svęcená voda");
					Doc_PrintLine	( nDocID,  0, "");
...
FUNC VOID Use_Bookstand_Kreise_05_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "Síra");
					Doc_PrintLine	( nDocID,  0, "Jazyk ohnivého ještęra");
					Doc_PrintLine	( nDocID,  0, "");
					...
					Doc_PrintLine	( nDocID,  0, "Léčba tęžkých zranęní");
...
FUNC VOID Use_Bookstand_Kreise_06_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "Ohnivý déšă");
					Doc_PrintLine	( nDocID,  0, "Pryskyâice");
					Doc_PrintLine	( nDocID,  0, "Síra");
					Doc_PrintLine	( nDocID,  0, "Jazyk ohnivého ještęra");
					Doc_PrintLine	( nDocID,  0, "");
