...
FUNC VOID Use_BookstandALCHEMY3_S1()		//Alchemiebücher
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, "a jejich pâísady"						);
					Doc_PrintLine	( nDocID,  0, ""						);
					...
					Doc_SetMargins	( nDocID, -1, 30, 20, 275, 20, 1   		);
					Doc_PrintLine	( nDocID,  1, ""						);
					Doc_PrintLines	( nDocID,  1, "Aplikace tęchto receptů je nejvyšším alchymistickým umęním, které vyžaduje jistou praxi. Když to pojmu všeobecnę, ne každý kdo ví, jak namíchat léčivý lektvar z léčivého koâene, má dost zkušeností, aby se pokusil i o pâípravu tęchto elixírů, u nichž jednu z pâísad vždy tvoâí královský šăovík."); 
					Doc_PrintLine	( nDocID,  1, ""						);
					Doc_PrintLines	( nDocID,  1, "Namíchat lektvar rychlosti je mnohem snazší, částečnę i proto, že k jeho pâípravę nepotâebuješ královský šăovík. Pro pâípravu tohoto receptu ti postačí základní znalosti alchymie. "						);
					Doc_PrintLine	( nDocID,  1, ""						);
