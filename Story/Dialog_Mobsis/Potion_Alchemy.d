...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Louovo 'Kladivo' s dvojitým množstvím rumu "; 
};
...
INSTANCE PC_Booze_SchnellerHering (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Namixuj 'Rychlého slanečka'"; 
};
...
INSTANCE PC_ItPo_Mana_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Esence many (2 ohnivé kopâivy, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Extrakt many (2 ohnivé býlí, 1 luční pohanka) "; 
};
...
INSTANCE PC_ItPo_Mana_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír many (2 ohnivé koâeny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "lektvar many (3 esence many, 1 luční pohanka)"; 
};
...
INSTANCE PC_Health_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Namíchat lečívé lektvary"; 
};
...
INSTANCE PC_ItPo_Health_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Esence hojivé síly (2 léčivé rostliny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Extrakt hojivé síly (2 léčivé byliny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír hojivé síly (2 léčivé koâeny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Léčivý lektvar (3 esence života, 1 luční pohanka)"; 
};
...
INSTANCE PC_Special_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Namíchat speciální lektvary"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír života (1 léčivý koâen, 1 královský šăovík)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír ducha (1 ohnivý koâen, 1 královský šăovík)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar obratnosti (1 gobliní bobule, 1 královský šăovík)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar síly (1 dračí koâen, 1 královský šăovík)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar rychlosti (1 chŕapavčí býlí, 1 luční pohanka)"; 
};
...
INSTANCE PC_Tabak_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Michání tabáku a zpracování trávy z bažin"; 
};
...
INSTANCE PC_ItMi_Joint (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Úprava trávy z bažin (1 stéblo)"; 
};
...
INSTANCE PC_ItMi_Addon_Joint_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Udęlat zelného novice (2 stébla trávy z bažin, 1 luční pohanka)"; 
};
...
FUNC VOID PC_ItMi_Tabak_Info ()
{
	...
	if (Npc_HasItems (hero, ItPl_SwampHerb) >=1)
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...s trávou z bažin",PC_ItMi_Tabak_Swampherb);
	};
	if (Npc_HasItems (hero, ItPl_Mushroom_01) >=1)
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...s tmavými houbami",PC_ItMi_Tabak_Mushroom_01);
	};
...
INSTANCE PC_ItPo_MegaDrink (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar z dračích vajec (10 dračích vajec, 1 černá perla, 1 síra)"; 
};
