...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Na vnitâní stranę je vyvedeno jméno Talbin.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	description				=	name;
	TEXT[0]					=	"Vejce je nezvykle teplé";
	TEXT[1]					=	"a zevnitâ se ozývá podezâelé škrábání.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
INSTANCE ItRi_OrcEliteRing(C_Item)
{
	...
	TEXT[0]					=	"Neumęle vyrobený prsten,";
	TEXT[1]					=	"na dotyk podivnę chladný.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"U skâetího důstojníka jsem našel podivnou mapu, která se podezâele podobá strategickému válečnému plánu."); 
