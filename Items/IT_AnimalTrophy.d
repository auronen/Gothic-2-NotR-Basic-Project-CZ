...
INSTANCE ItAt_CrawlerMandibles (C_Item)
{
	...
	TEXT[0]				= 	"Kusadla lze rozevâít ";
	TEXT[1]				= 	"a vypít výmęšek, který se v nich skrývá.";
	TEXT[2]				= 	"Regeneruje manu.";
	TEXT[3]				= 	"Účinky časem pominou.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
INSTANCE itat_LurkerSkin (C_Item) //REPTILE Skin
{
	...
	description			= 	"Kůže stažená z plaza.";
	TEXT[0]				= 	"";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
