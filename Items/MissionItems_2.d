...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Expedice do Hornického údolí selhala. Utrpęli jsme tęžké ztráty a ti, kteâí pâežili, jsou nyní lapeni na hradę a obklíčeni skâety. ");
					Doc_PrintLines	( nDocID,  0, "Také na nás mnohokrát zaútočili draci. Zničili všechny zemę v okolí hradu. S Innosovou pomocí snad vytrváme, dokud nedorazí posily. Stejnę nám nic jiného nezbývá, neboă žádný výpad podniknout nemůžeme. ");					
					Doc_PrintLine	( nDocID,  0, ""					);
...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Takže jestli máš nękde ulitý nęjaký zlato, bylo by načase se s tím vytasit. ");
					Doc_PrintLine	( nDocID,  0, " "					);
					Doc_PrintLine	( nDocID,  0, " "					);
...
{   
	...
	nDocID = 	Doc_Create		()			  ;							// DocManager 
				...
				Doc_PrintLines	( nDocID,  0, "Trápí mę ale jakési neblahé tušení, takže si radši všechnu rudu nękam schovám.");
...
INSTANCE ItSe_Olav	(C_Item)
{
	...
	TEXT[0]				= 	"";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"Uvnitâ cinká nękolik mincí.";
	TEXT[3]				= 	"";
	TEXT[4]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, "");
					Doc_PrintLines	( nDocID,  0, "Opustili jsme tábor. Teë, když bariéra padla, pátráme po stâedu celé zkázy. Možná tam najdeme odpovędi, po kterých se pídíme už po dlouhá léta. Jen Adanos ví, kam nás cesta zavede."					);
