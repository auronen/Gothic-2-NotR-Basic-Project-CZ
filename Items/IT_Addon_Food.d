...
INSTANCE ItFo_Addon_Shellflesh (C_Item)
{
	...
	TEXT[2]				= 	"Nevaâené chutná výtečnę.";
	TEXT[3]				= 	"";
...
INSTANCE ItFo_Addon_Grog(C_Item)
{
	...
	description		= 	"Pravý námoânický grog";
...
INSTANCE ItFo_Addon_SchlafHammer (C_Item)
{
	...
	TEXT[1]			= 	"Dęlá i z nejvętších opilců 'unavené' ...";				
...
INSTANCE ItFo_Addon_SchnellerHering(C_Item)
{
	...
	description		= 	"Rychlý sleë";
	
	TEXT[1]			= 	"Vypadá nebezpečnę!";				
